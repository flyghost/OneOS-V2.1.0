                       ...
                       void        (*task_exit)(void))
{
    ...
    stack_frame_pointer = (struct stack_frame *)stack_top;

    /* Initialize all registers */
    for (index = 0; index < sizeof(struct stack_frame) / sizeof(os_uint32_t); index++)
    {
        ((os_uint32_t *)stack_frame_pointer)[index] = 0xDEADBEEF;
    }

    stack_frame_pointer->cpu_frame.r0  = (os_uint32_t)arg;            /* r0 : argument */
    stack_frame_pointer->cpu_frame.r1  = 0;                           /* r1 */
    stack_frame_pointer->cpu_frame.r2  = 0;                           /* r2 */
    stack_frame_pointer->cpu_frame.r3  = 0;                           /* r3 */
    stack_frame_pointer->cpu_frame.r12 = 0;                           /* r12 */
    stack_frame_pointer->cpu_frame.lr  = (os_uint32_t)task_exit;      /* lr */
    stack_frame_pointer->cpu_frame.pc  = (os_uint32_t)task_entry;     /* entry point, pc */
    stack_frame_pointer->cpu_frame.psr = 0x01000000UL;                /* PSR */
     ...
     */
    stack_frame_pointer->manual_frame.exc_return = 0xFFFFFFFDUL;
