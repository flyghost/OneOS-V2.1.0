...
static void _os_arch_bus_fault_track(void)
{
    ...
    {
        os_kprintf("BFARVALID\r\n");
        os_kprintf("SCB->BFAR:0x%08x\r\n", SCB_BFAR);
    }
...
static void _os_arch_mem_manage_fault_track(void)
{
    ...
    {
        os_kprintf("MMARVALID\r\n");
        os_kprintf("SCB->MMAR: 0x%08x\r\n", SCB_MMAR);
    }
 ...
 ***********************************************************************************************************************
 */
void os_arch_fault_exception(void *stack_frame, os_size_t *msp, os_size_t *psp)
{
