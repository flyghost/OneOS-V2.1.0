...
#if defined(MQTT_COMM_ENABLED) && defined(NET_USING_PAHO_MQTT)
#error "Disabled Components->Network->Protocols->Paho MQTT while enable FEATURE_MQTT_COMM_ENABLED in Ali-iotkit"
#endif
