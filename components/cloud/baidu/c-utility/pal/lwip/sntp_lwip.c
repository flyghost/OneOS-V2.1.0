...
/*Codes_SRS_SNTP_LWIP_30_003: [ The SNTP_SetServerName shall set the NTP server to be used by ntp_lwip and return 0 to
 * indicate success.]*/
//
...
/*Codes_SRS_SNTP_LWIP_30_004: [ SNTP_Init shall initialize the SNTP client, contact the NTP server to set system time,
 * then return 0 to indicate success (lwIP has no failure path). ]*/
int SNTP_Init()
{
