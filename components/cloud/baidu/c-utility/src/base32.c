...
static char *base32_encode_impl(const unsigned char *source, size_t src_size)
{
    ...
    else
    {
        ...
        /* Codes_SRS_BASE32_07_010: [ base32_encode_impl shall look through source and separate each block into 5 bit
         * chunks ] */
        while (src_size >= 1 && result != NULL)
        {
            ...
            /* Codes_SRS_BASE32_07_012: [ If the src_size is not divisible by 8, base32_encode_impl shall pad the
             * remaining places with =. ] */
            switch (block_len)
            {
            case 1:
                pos3 = pos4 = 32;
            ...
            /* Codes_SRS_BASE32_07_011: [ base32_encode_impl shall then map the 5 bit chunks into one of the BASE32
             * values (a-z,2,3,4,5,6,7) values. ] */
...
static BUFFER_HANDLE base32_decode_impl(const char *source)
{
    ...
    {
        /* Codes_SRS_BASE32_07_021: [ If the source length is not evenly divisible by 8, base32_decode_impl shall return
         * NULL. ] */
    ...
    else
    {
        ...
        else
        {
            ...
            {
                size_t index = 0;
                /* Codes_SRS_BASE32_07_024: [ base32_decode_impl shall loop through and collect 8 characters from the
                 * source variable. ] */
            ...
            {
                /* Codes_SRS_BASE32_07_026: [ Once base32_decode_impl is complete it shall create a BUFFER with the temp
                 * buffer. ] */
...
BUFFER_HANDLE Base32_Decode(STRING_HANDLE handle)
{
    ...
    /* Codes_SRS_BASE32_07_017: [ On success Base32_Decoder shall return a BUFFER_HANDLE that contains the decoded bytes
     * for source. ] */
    return result;
}
...
BUFFER_HANDLE Base32_Decode_String(const char *source)
{
    ...
    /* Codes_SRS_BASE32_07_019: [ On success Base32_Decoder_String shall return a BUFFER_HANDLE that contains the
     * decoded bytes for source. ] */
    return result;
}
...
STRING_HANDLE Base32_Encode(BUFFER_HANDLE source)
{
    ...
    else
    {
        ...
        else
        {
            ...
            {
                /* Codes_SRS_BASE32_07_012: [ base32_Encode shall wrap the base32_Encode_impl result into a
                 * STRING_HANDLE. ] */
