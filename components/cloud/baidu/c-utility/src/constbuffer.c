...
static CONSTBUFFER_HANDLE CONSTBUFFER_Create_Internal(const unsigned char *source, size_t size)
{
    ...
    /*Codes_SRS_CONSTBUFFER_02_005: [The non-NULL handle returned by CONSTBUFFER_Create shall have its ref count set to
     * "1".]*/
    /*Codes_SRS_CONSTBUFFER_02_010: [The non-NULL handle returned by CONSTBUFFER_CreateFromBuffer shall have its ref
     * count set to "1".]*/
    ...
    if (result == NULL)
    {
        ...
        /*Codes_SRS_CONSTBUFFER_02_008: [If copying the content fails, then CONSTBUFFER_CreateFromBuffer shall fail and
         * return NULL.] */
    ...
    {
        /*Codes_SRS_CONSTBUFFER_02_002: [Otherwise, CONSTBUFFER_Create shall create a copy of the memory area pointed to
         * by source having size bytes.]*/
        ...
        else
        {
            ...
            if (temp == NULL)
            {
                /*Codes_SRS_CONSTBUFFER_02_003: [If creating the copy fails then CONSTBUFFER_Create shall return
                 * NULL.]*/
                /*Codes_SRS_CONSTBUFFER_02_008: [If copying the content fails, then CONSTBUFFER_CreateFromBuffer shall
            ...
            else
            {
                ...
                /*Codes_SRS_CONSTBUFFER_02_007: [Otherwise, CONSTBUFFER_CreateFromBuffer shall copy the content of
                 * buffer.]*/
                /*Codes_SRS_CONSTBUFFER_02_009: [Otherwise, CONSTBUFFER_CreateFromBuffer shall return a non-NULL
                 * handle.]*/
...
{
    CONSTBUFFER_HANDLE_DATA *result;
    /*Codes_SRS_CONSTBUFFER_02_001: [If source is NULL and size is different than 0 then CONSTBUFFER_Create shall fail
     * and return NULL.]*/
...
CONSTBUFFER_HANDLE CONSTBUFFER_Clone(CONSTBUFFER_HANDLE constbufferHandle)
{
    ...
    {
        /*Codes_SRS_CONSTBUFFER_02_013: [If constbufferHandle is NULL then CONSTBUFFER_Clone shall fail and return
         * NULL.]*/
        LogError("invalid arg");
    }
    else
    {
        /*Codes_SRS_CONSTBUFFER_02_014: [Otherwise, CONSTBUFFER_Clone shall increment the reference count and return
         * constbufferHandle.]*/
...
const CONSTBUFFER *CONSTBUFFER_GetContent(CONSTBUFFER_HANDLE constbufferHandle)
{
    ...
    {
        /*Codes_SRS_CONSTBUFFER_02_012: [Otherwise, CONSTBUFFER_GetContent shall return a const CONSTBUFFER* that
         * matches byte by byte the original bytes used to created the const buffer and has the same length.]*/
...
void CONSTBUFFER_Destroy(CONSTBUFFER_HANDLE constbufferHandle)
{
    ...
    if (constbufferHandle != NULL)
    {
        /*Codes_SRS_CONSTBUFFER_02_016: [Otherwise, CONSTBUFFER_Destroy shall decrement the refcount on the
         * constbufferHandle handle.]*/
        if (DEC_REF(CONSTBUFFER_HANDLE_DATA, constbufferHandle) == DEC_RETURN_ZERO)
        {
            /*Codes_SRS_CONSTBUFFER_02_017: [If the refcount reaches zero, then CONSTBUFFER_Destroy shall deallocate all
             * resources used by the CONSTBUFFER_HANDLE.]*/
