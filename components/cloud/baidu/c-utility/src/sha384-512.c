...
#define SHA512_ADD(word1, word2, ret)                                                                                  \
    ((ret)[1] = (word1)[1], (ret)[1] += (word2)[1], (ret)[0] = (word1)[0] + (word2)[0] + ((ret)[1] < (word1)[1]))
...
#define SHA512_ADDTO2(word1, word2)                                                                                    \
    (ADDTO2_temp = (word1)[1], (word1)[1] += (word2)[1], (word1)[0] += (word2)[0] + ((word1)[1] < ADDTO2_temp))
 ...
 */
#define SHA_Ch(x, y, z, ret)                                                                                           \
    ((ret)[0] = (((x)[0] & ((y)[0] ^ (z)[0])) ^ (z)[0]), (ret)[1] = (((x)[1] & ((y)[1] ^ (z)[1])) ^ (z)[1]))
...
#define SHA384_512AddLength(context, length)                                                                           \
    (addTemp[3] = (length),                                                                                            \
     ...
     (context)->Corrupted = (((context)->Length[3] == 0) && ((context)->Length[2] == 0) &&                             \
                             ((context)->Length[1] == 0) && ((context)->Length[0] < 8))                                \
                                ? 1                                                                                    \
                                : 0)
...
static uint32_t SHA384_H0[SHA512HashSize / 4] = {0xCBBB9D5D,
                                                 0xC1059ED8,
                                                 0x629A292A,
                                                 0x367CD507,
                                                 0x9159015A,
...
static uint32_t SHA512_H0[SHA512HashSize / 4] = {0x6A09E667,
                                                 0xF3BCC908,
                                                 0xBB67AE85,
                                                 0x84CAA73B,
                                                 0x3C6EF372,
...
#define SHA384_512AddLength(context, length)                                                                           \
    (addTemp            = context->Length_Low,                                                                         \
     context->Corrupted = ((context->Length_Low += length) < addTemp) && (++context->Length_High == 0) ? 1 : 0)
...
/* Initial Hash Values: FIPS-180-2 sections 5.3.3 and 5.3.4 */
static uint64_t SHA384_H0[] = {0xCBBB9D5DC1059ED8ull,
...
static uint64_t SHA512_H0[] = {0x6A09E667F3BCC908ull,
 ...
 *
 */
int SHA384FinalBits(SHA384Context *context, const uint8_t message_bits, unsigned int length)
{
...
{
    uint64_t addTemp;
    uint8_t  masks[8]   = {/* 0 0b00000000 */ 0x00,
                        /* 1 0b10000000 */ 0x80,
                        /* 2 0b11000000 */ 0xC0,
                        /* 3 0b11100000 */ 0xE0,
                        /* 4 0b11110000 */ 0xF0,
                        ...
                        /* 6 0b11111100 */ 0xFC,
                        /* 7 0b11111110 */ 0xFE};
    uint8_t  markbit[8] = {/* 0 0b10000000 */ 0x80,
                          /* 1 0b01000000 */ 0x40,
                          /* 2 0b00100000 */ 0x20,
                          /* 3 0b00010000 */ 0x10,
                          /* 4 0b00001000 */ 0x08,
