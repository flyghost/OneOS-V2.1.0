...
STRING_HANDLE STRING_new(void)
{
    ...
    if ((result = (STRING *)malloc(sizeof(STRING))) != NULL)
    {
        ...
        {
            /* Codes_SRS_STRING_07_002: [STRING_new shall return an NULL STRING_HANDLE on any error that is
             * encountered.] */
...
#endif
STRING_HANDLE
STRING_construct_sprintf(const char *format, ...)
{
    STRING *result;
    ...
    if (format != NULL)
    {
        ...
        /* Codes_SRS_STRING_07_041: [STRING_construct_sprintf shall determine the size of the resulting string and
        ...
        if (length > 0)
        {
            ...
            if (result != NULL)
            {
                ...
                if (result->s != NULL)
                {
                    ...
                    {
                        /* Codes_SRS_STRING_07_040: [If any error is encountered STRING_construct_sprintf shall return
                         * NULL.] */
                        free(result->s);
                        free(result);
                        result = NULL;
        ...
        {
            /* Codes_SRS_STRING_07_039: [If the parameter format is NULL then STRING_construct_sprintf shall return
             * NULL.] */
            result = NULL;
    ...
    /* Codes_SRS_STRING_07_045: [STRING_construct_sprintf shall allocate a new string with the value of the specified
     * printf formated const char. ] */
    return (STRING_HANDLE)result;
}
...
STRING_HANDLE STRING_new_with_memory(const char *memory)
{
    ...
    if (memory == NULL)
    {
        /* Codes_SRS_STRING_07_007: [STRING_new_with_memory shall return a NULL STRING_HANDLE if the supplied char* is
         * NULL.] */
        result = NULL;
    }
    else
...
/* Codes_SRS_STRING_07_008: [STRING_new_quoted shall return a valid STRING_HANDLE Copying the supplied const char* value
...
STRING_HANDLE STRING_new_quoted(const char *source)
{
    ...
    if (source == NULL)
    {
        /* Codes_SRS_STRING_07_009: [STRING_new_quoted shall return a NULL STRING_HANDLE if the supplied const char* is
         * NULL.] */
        result = NULL;
    }
    else if ((result = (STRING *)malloc(sizeof(STRING))) != NULL)
    {
        ...
        {
            /* Codes_SRS_STRING_07_031: [STRING_new_quoted shall return a NULL STRING_HANDLE if any error is
             * encountered.] */
...
/*this function takes a regular const char* and turns in into "this is a\"JSON\" strings\u0008" (starting and ending
 * quote included)*/
...
STRING_HANDLE STRING_new_JSON(const char *source)
{
    ...
    else
    {
        ...
        for (i = 0; i < vlen; i++)
        {
            /*Codes_SRS_STRING_02_014: [If any character has the value outside [1...127] then STRING_new_JSON shall fail
             * and return NULL.] */
        ...
        else
        {
            if ((result = (STRING *)malloc(sizeof(STRING))) == NULL)
            {
                /*Codes_SRS_STRING_02_021: [If the complete JSON representation cannot be produced, then STRING_new_JSON
            ...
            else
            {
                ...
                for (i = 0; i < vlen; i++)
                {
                    if (source[i] <= 0x1F)
                    {
                        /*Codes_SRS_STRING_02_019: [If the character code is less than 0x20 then it shall be represented
                         * as \u00xx, where xx is the hex representation of the character code.]*/
                        result->s[pos++] = '\\';
                        result->s[pos++] = 'u';
                        result->s[pos++] = '0';
                        result->s[pos++] = '0';
                    ...
                    {
                        /*Codes_SRS_STRING_02_013: [The string shall copy the characters of source "as they are" (until
                         * the '\0' character) with the following exceptions:] */
...
/* Codes_SRS_STRING_07_012: [STRING_concat shall concatenate the given STRING_HANDLE and the const char* value and place
 * the value in the handle.] */
...
/*returns 0 if success*/
/*any other error code is failure*/
/* Codes_SRS_STRING_07_034: [String_Concat_with_STRING shall concatenate a given STRING_HANDLE variable with a source
 * STRING_HANDLE.] */
int STRING_concat_with_STRING(STRING_HANDLE s1, STRING_HANDLE s2)
{
    ...
    if ((s1 == NULL) || (s2 == NULL))
    {
        /* Codes_SRS_STRING_07_035: [String_Concat_with_STRING shall return a nonzero number if an error is
         * encountered.] */
    ...
    else
    {
        ...
        {
            dest->s = temp;
            /* Codes_SRS_STRING_07_034: [String_Concat_with_STRING shall concatenate a given STRING_HANDLE variable with
             * a source STRING_HANDLE.] */
...
int STRING_copy(STRING_HANDLE handle, const char *s2)
{
    ...
    if ((handle == NULL) || (s2 == NULL))
    {
        /* Codes_SRS_STRING_07_017: [STRING_copy shall return a nonzero value if any of the supplied parameters are
         * NULL.] */
        result = __FAILURE__;
    }
    else
    {
        STRING *s1 = (STRING *)handle;
        /* Codes_SRS_STRING_07_026: [If the underlying char* refered to by s1 handle is equal to char* s2 than
         * STRING_copy shall be a noop and return 0.] */
        if (s1->s != s2)
        {
            size_t s2Length = strlen(s2);
        ...
        {
            /* Codes_SRS_STRING_07_033: [If overlapping pointer address is given to STRING_copy the behavior is
             * undefined.] */
            result = 0;
        }
    }
...
/*returns 0 if success*/
/*any other error code is failure*/
/* Codes_SRS_STRING_07_018: [STRING_copy_n shall copy the number of characters in const char* or the size_t whichever is
 * lesser.] */
int STRING_copy_n(STRING_HANDLE handle, const char *s2, size_t n)
{
    ...
    if ((handle == NULL) || (s2 == NULL))
    {
        /* Codes_SRS_STRING_07_019: [STRING_copy_n shall return a nonzero value if STRING_HANDLE or const char* is
         * NULL.] */
        result = __FAILURE__;
    }
    else
...
int STRING_sprintf(STRING_HANDLE handle, const char* format, ...)
{
    ...
    {
        /* Codes_SRS_STRING_07_042: [if the parameters s1 or format are NULL then STRING_sprintf shall return non zero
         * value.] */
        LogError("Invalid arg (NULL)");
        result = __FAILURE__;
    }
    else
    {
        ...
        else
        {
            ...
            if (temp != NULL)
            {
                ...
                {
                    /* Codes_SRS_STRING_07_043: [If any error is encountered STRING_sprintf shall return a non zero
                     * value.] */
...
int STRING_quote(STRING_HANDLE handle)
{
    ...
    if (handle == NULL)
    {
        /* Codes_SRS_STRING_07_015: [STRING_quote shall return a nonzero value if any of the supplied parameters are
         * NULL.] */
        result = __FAILURE__;
    }
    else
...
/*Codes_SRS_STRING_02_007: [STRING_construct_n shall construct a STRING_HANDLE from first "n" characters of the string
 * pointed to by psz parameter.]*/
STRING_HANDLE STRING_construct_n(const char *psz, size_t n)
{
    ...
    else
    {
        ...
        /*Codes_SRS_STRING_02_009: [If n is bigger than the size of the string psz, then STRING_construct_n shall return
         * NULL.] */
        if (n > len)
        {
            result = NULL;
...
/* Codes_SRS_STRING_07_034: [STRING_compare returns an integer greater than, equal to, or less than zero, accordingly as
 * the string pointed to by s1 is greater than, equal to, or less than the string s2.] */
...
STRING_HANDLE STRING_from_byte_array(const unsigned char *source, size_t size)
{
    ...
    {
        /*Codes_SRS_STRING_02_023: [ Otherwise, STRING_from_BUFFER shall build a string that has the same content
         * (byte-by-byte) as source and return a non-NULL handle. ]*/
        result = (STRING *)malloc(sizeof(STRING));
        if (result == NULL)
        {
...
int STRING_replace(STRING_HANDLE handle, char target, char replace)
{
    ...
    {
        /* Codes_SRS_STRING_07_048: [ If target and replace are equal STRING_replace, shall do nothing shall return
         * zero. ] */
        result = 0;
    }
    else
