...
#define IS_IN_ASCII_RANGE(c) ((c >= '0') && (c <= '7'))
#define IS_IN_EXTENDED_ASCII_RANGE(c)                                                                                  \
    (((c >= '8') && (c <= '9')) || ((c >= 'A') && (c <= 'F')) || ((c >= 'a') && (c <= 'f')))
#define IS_IN_CONTINUATION_BYTE_RANGE(c)                                                                               \
    ((c == '8') || (c == '9') || (c == 'A') || (c == 'B') || (c == 'a') || (c == 'b'))
#define IS_IN_LEADING_BYTE_RANGE(c)             (((c >= 'C') && (c <= 'F')) || ((c >= 'c') && (c <= 'f')))
#define IS_IN_UNSUPPORTED_LEADING_BYTE_RANGE(c) (((c >= 'D') && (c <= 'F')) || ((c >= 'd') && (c <= 'f')))
...
STRING_HANDLE URL_Encode(STRING_HANDLE input)
{
    ...
    else
    {
        ...
        /*Codes_SRS_URL_ENCODE_06_003: [If input is a zero length string then URL_Encode will return a zero length
         * string.]*/
        do
        {
        ...
        {
            /*Codes_SRS_URL_ENCODE_06_002: [If an error occurs during the encoding of input then URL_Encode will return
             * NULL.]*/
            result = NULL;
