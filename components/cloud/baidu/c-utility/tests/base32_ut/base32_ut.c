...
static const TEST_BASE32_VALUE test_val_len[] = {
    ...
    {15,
     (const unsigned char *)"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f",
     "aebagbafaydqqcikbmga2dqp"},
    {16,
     (const unsigned char *)"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10",
     "aebagbafaydqqcikbmga2dqpca======"},
    {17,
     (const unsigned char *)"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11",
     "aebagbafaydqqcikbmga2dqpcaiq===="},
    {32,
     (const unsigned char *)"\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f\x10\x11\x12\x13\x14\x15\x16"
                            "\x17\x18\x19\x1a\x1b\x1c\x1d\x1e\x1f\x20",
     "aebagbafaydqqcikbmga2dqpcaireeyuculbogazdinryhi6d4qa===="},
};
 ...
 */
/* Tests_SRS_BASE32_07_011: [ base32_encode_impl shall then map the 5 bit chunks into one of the BASE32 values
 * (a-z,2,3,4,5,6,7) values. ] */
/* Tests_SRS_BASE32_07_012: [ If the src_size is not divisible by 8, base32_encode_impl shall pad the remaining places
 * with =. ] */
...
TEST_FUNCTION(Base32_Decode_String_success)
{
    ...
    for (index = 0; index < num_elements; index++)
    {
        ...
        ASSERT_ARE_EQUAL_WITH_MSG(int,
                                  0,
                                  memcmp(test_val_len[index].input_data, result, test_val_len[index].input_len),
                                  tmp_msg);
...
/* Codes_SRS_BASE32_07_019: [ On success Base32_Decode_String shall return a BUFFER_HANDLE that contains the decoded
 * bytes for source. ] */
...
/* Codes_SRS_BASE32_07_017: [ On success Base32_Decode shall return a BUFFER_HANDLE that contains the decoded bytes for
 * source. ] */
