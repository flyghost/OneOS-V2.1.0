...
// Tests_SRS_CONDITION_18_005: [ Condition_Wait shall return COND_INVALID_ARG if lock is NULL and timeout_milliseconds
// is 0 ]
...
// Tests_SRS_CONDITION_18_006: [ Condition_Wait shall return COND_INVALID_ARG if lock is NULL and timeout_milliseconds
// is not 0. ]
...
// Tests_SRS_CONDITION_18_010: [ Condition_Wait shall return COND_OK if the condition is triggered and
// timeout_milliseconds is 0 ]
...
// Tests_SRS_CONDITION_18_011: [Condition_wait shall return COND_TIMEOUT if the condition is NOT triggered and
// timeout_milliseconds is not 0]
...
// Tests_SRS_CONDITION_18_012: [ Condition_Wait shall return COND_OK if the condition is triggered and
// timeout_milliseconds is not 0 ] Tests_SRS_CONDITION_18_013: [ Condition_Wait shall accept relative timeouts ]
