...
/* Tests_SRS_DNS_ASYNC_30_022: [ If the DNS lookup process has completed, dns_async_is_create_complete shall return
 * true. ]*/
/* Tests_SRS_DNS_ASYNC_30_032: [ If dns_async_is_create_complete has returned true and the lookup process has succeeded,
 * dns_async_get_ipv4 shall return the discovered IPv4 address. ]*/
/* Tests_SRS_DNS_ASYNC_30_024: [ If dns_async_is_create_complete has previously returned true,
...
/* Tests_SRS_DNS_ASYNC_30_023: [ If the DNS lookup process is not yet complete, dns_async_is_create_complete shall
 * return false. ]*/
...
TEST_FUNCTION(dns_async__is_complete_yes_after_failure__fails)
{
    ...
    DNS_ASYNC_HANDLE dns = dns_async_create("fake.com", NULL);
    umock_c_reset_all_calls();
    STRICT_EXPECTED_CALL(getaddrinfo(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG,
IGNORED_PTR_ARG)).SetReturn(GETADDRINFO_FAIL);
...
*/
/* Tests_SRS_DNS_ASYNC_30_033: [ If dns_async_is_create_complete has returned true and the lookup process has failed,
 * dns_async_get_ipv4 shall return 0. ]*/
/*
TEST_FUNCTION(dns_async__async_get_ipv4__fails)
{
    ...
    umock_c_reset_all_calls();
    STRICT_EXPECTED_CALL(getaddrinfo(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG,
IGNORED_PTR_ARG)).SetReturn(GETADDRINFO_FAIL); result = dns_async_is_lookup_complete(dns);
    ASSERT_IS_TRUE_WITH_MSG(result, "Unexpected non-completion");
...
*/
/* Tests_SRS_DNS_ASYNC_30_020: [ If the dns parameter is NULL, dns_async_is_create_complete shall log an error and
 * return false. ]*/
...
/* Tests_SRS_DNS_ASYNC_30_031: [ If dns_async_is_create_complete has not yet returned true, dns_async_get_ipv4 shall log
