...
/*the following function, called "inert" - allegedly half happy and half unhappy is hared between the positive and
 * negative test cases*/
...
/*Tests_SRS_OPTIONHANDLER_02_002: [ OptionHandler_Create shall create an empty VECTOR that will hold pairs of const
 * char* and void*. ]*/
/*Tests_SRS_OPTIONHANDLER_02_003: [ If all the operations succeed then OptionHandler_Create shall succeed and return a
 * non-NULL handle. ]*/
 ...
 * ]*/
/* Tests_SRS_OPTIONHANDLER_01_005: [ `OptionHandler_Clone` shall iterate through all the options stored by the option
 * handler to be cloned by using VECTOR's iteration mechanism. ]*/
...
/* Tests_SRS_OPTIONHANDLER_01_007: [ For each option the value shall be cloned by using the cloning function associated
 * with the source option handler `handler`. ]*/
TEST_FUNCTION(OptionHandler_Clone_clones_an_instance_with_one_option)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "TrustedCerts")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(aCloneOption("TrustedCerts", IGNORED_PTR_ARG)).IgnoreArgument_value();
...
TEST_FUNCTION(OptionHandler_Clone_clones_an_instance_with_2_options)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "option_2")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(aCloneOption("option_2", IGNORED_PTR_ARG)).IgnoreArgument_value();
    STRICT_EXPECTED_CALL(VECTOR_push_back(IGNORED_PTR_ARG, IGNORED_PTR_ARG, 1))
        .IgnoreArgument_handle()
        .IgnoreArgument_elements();
...
TEST_FUNCTION(when_creating_the_vector_fails_OptionHandler_Clone_fails)
{
    ...
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG)).IgnoreArgument_size();
    STRICT_EXPECTED_CALL(VECTOR_create(IGNORED_NUM_ARG)).IgnoreArgument_elementSize().SetReturn(NULL);
...
TEST_FUNCTION(when_cloning_the_first_option_name_fails_OptionHandler_Clone_fails)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 0)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "TrustedCerts")).IgnoreArgument_destination().SetReturn(1);
...
TEST_FUNCTION(when_cloning_the_first_option_value_fails_OptionHandler_Clone_fails)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 0)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "TrustedCerts")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(aCloneOption("TrustedCerts", IGNORED_PTR_ARG)).IgnoreArgument_value().SetReturn(NULL);
...
/* Tests_SRS_OPTIONHANDLER_01_011: [ When adding one of the newly cloned options to the option handler storage vector
 * fails, `OptionHandler_Clone` shall return NULL. ]*/
...
TEST_FUNCTION(when_cloning_the_2nd_option_name_fails_OptionHandler_Clone_fails)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 1)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "option_2")).IgnoreArgument_destination().SetReturn(1);
...
TEST_FUNCTION(when_cloning_the_2nd_option_value_fails_OptionHandler_Clone_fails)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 1)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "option_2")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(aCloneOption("option_2", IGNORED_PTR_ARG)).IgnoreArgument_value().SetReturn(NULL);
...
/*Tests_SRS_OPTIONHANDLER_02_005: [ OptionHandler_AddOption shall fail and return OPTIONHANDLER_INVALIDARG if any
 * parameter is NULL. ]*/
...
{
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "name")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(aCloneOption("name", value)).IgnoreAllArguments();
    STRICT_EXPECTED_CALL(VECTOR_push_back(IGNORED_PTR_ARG, IGNORED_PTR_ARG, 1))
        .IgnoreArgument_handle()
        .IgnoreArgument_elements();
}
...
/*Tests_SRS_OPTIONHANDLER_02_007: [ OptionHandler_AddOption shall use VECTOR APIs to save the name and the newly created
 * clone of value. ]*/
/*Tests_SRS_OPTIONHANDLER_02_008: [ If all the operations succed then OptionHandler_AddOption shall succeed and return
 * OPTIONHANDLER_OK. ]*/
...
/*Tests_SRS_OPTIONHANDLER_02_010: [ OptionHandler_FeedOptions shall fail and return OPTIONHANDLER_INVALIDARG if any
 * argument is NULL. ]*/
...
/*Tests_SRS_OPTIONHANDLER_02_011: [ Otherwise, OptionHandler_FeedOptions shall use VECTOR's iteration mechanisms to
 * retrieve pairs of name, value (const char* and void*). ]*/
/*Tests_SRS_OPTIONHANDLER_02_012: [ OptionHandler_FeedOptions shall call for every pair of name,value setOption passing
 * destinationHandle, name and value. ]*/
/*Tests_SRS_OPTIONHANDLER_02_013: [ If all the operations succeed then OptionHandler_FeedOptions shall succeed and
...
static void OptionHandler_FeedOptions_with_1_saved_options_feeds_1_inert_path(void)
{
    STRICT_EXPECTED_CALL(VECTOR_size(IGNORED_PTR_ARG)) /*will return 0, so nothing else happens*/
        .IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 0)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(aSetOption((void *)42, "a", IGNORED_PTR_ARG)).IgnoreArgument_value();
}
...
static void OptionHandler_FeedOptions_with_2_saved_options_feeds_2_inert_path(void)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 1)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(aSetOption((void *)42, "c", IGNORED_PTR_ARG)).IgnoreArgument_value();
}
...
TEST_FUNCTION(OptionHandler_Destroy_with_non_NULL_handle_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_size(IGNORED_PTR_ARG)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 0)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(aDestroyOption("a", IGNORED_PTR_ARG)).IgnoreArgument_value();
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG)).IgnoreArgument_ptr();

    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 1)).IgnoreArgument_handle();
    STRICT_EXPECTED_CALL(aDestroyOption("c", IGNORED_PTR_ARG)).IgnoreArgument_value();
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG)).IgnoreArgument_ptr();

    STRICT_EXPECTED_CALL(VECTOR_destroy(IGNORED_PTR_ARG)).IgnoreArgument_handle();
