...
TEST_FUNCTION(when_underlying_malloc_fails_singlylinkedlist_create_fails)
{
    // arrange
    SINGLYLINKEDLIST_HANDLE result;
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG)).SetReturn((void *)NULL);
...
/* Tests_SRS_LIST_01_003: [singlylinkedlist_destroy shall free all resources associated with the list identified by the
 * handle argument.] */
...
/* Tests_SRS_LIST_01_006: [If any of the arguments is NULL, singlylinkedlist_add shall not add the item to the list and
 * return NULL.] */
...
/* Tests_SRS_LIST_01_005: [singlylinkedlist_add shall add one item to the tail of the list and on success it shall
...
/* Tests_SRS_LIST_01_018: [singlylinkedlist_get_next_item shall return the next item in the list following the item
 * item_handle.] */
...
/* Tests_SRS_LIST_01_022: [If no more items exist in the list after the item_handle item, singlylinkedlist_get_next_item
 * shall return NULL.] */
...
/* Tests_SRS_LIST_01_020: [singlylinkedlist_item_get_value shall return the value associated with the list item
...
/* Tests_SRS_LIST_01_011: [singlylinkedlist_find shall iterate through all items in a list and return the first one that
 * satisfies a certain match function.] */
/* Tests_SRS_LIST_01_014: [list find shall determine whether an item satisfies the match criteria by invoking the match
 * function for each item in the list until a matching item is found.] */
/* Tests_SRS_LIST_01_013: [The match_function shall get as arguments the list item being attempted to be matched and the
 * match_context as is.] */
/* Tests_SRS_LIST_01_017: [If the match function returns true, singlylinkedlist_find shall consider that item as
 * matching.] */
TEST_FUNCTION(singlylinkedlist_find_on_a_list_with_1_matching_item_yields_that_item)
{
    ...
    STRICT_EXPECTED_CALL(test_match_function(IGNORED_PTR_ARG, TEST_CONTEXT)).IgnoreArgument(1);
...
/* Tests_SRS_LIST_01_016: [If the match function returns false, singlylinkedlist_find shall consider that item as not
 * matching.] */
TEST_FUNCTION(singlylinkedlist_find_on_a_list_with_1_items_that_does_not_match_returns_NULL)
{
    ...
    STRICT_EXPECTED_CALL(test_match_function(IGNORED_PTR_ARG, TEST_CONTEXT)).IgnoreArgument(1).SetReturn(false);
...
/* Tests_SRS_LIST_01_023: [singlylinkedlist_remove shall remove a list item from the list and on success it shall return
 * 0.] */
...
/* Tests_SRS_LIST_01_024: [If any of the arguments list or item_handle is NULL, singlylinkedlist_remove shall fail and
...
/* Tests_SRS_LIST_01_025: [If the item item_handle is not found in the list, then singlylinkedlist_remove shall fail and
 * return a non-zero value.] */
...
/* Tests_SRS_LIST_09_008: [ If the list or the action_function argument is NULL, singlylinkedlist_foreach shall return
 * non-zero value. ] */
...
/* Tests_SRS_LIST_09_009: [ singlylinkedlist_foreach shall iterate through all items in a list and invoke
...
/* Tests_SRS_LIST_09_010: [ If the condition function returns continue_processing as false, singlylinkedlist_foreach
 * shall stop iterating through the list and return. ] */
...
/* Tests_SRS_LIST_09_001: [ If the list or the condition_function argument is NULL, singlylinkedlist_remove_if shall
...
/* Tests_SRS_LIST_09_002: [ singlylinkedlist_remove_if shall iterate through all items in a list and remove all that
 * satisfies a certain condition function. ] */
/* Tests_SRS_LIST_09_003: [ singlylinkedlist_remove_if shall determine whether an item satisfies the condition criteria
 * by invoking the condition function for that item. ] */
/* Tests_SRS_LIST_09_004: [ If the condition function  remove_item as true, singlylinkedlist_find shall consider that
 * item as to be removed. ] */
/* Tests_SRS_LIST_09_005: [ If the condition function returns remove_item as false or unchanged, singlylinkedlist_find
 * shall consider that item as not to be removed. ] */
...
/* Tests_SRS_LIST_09_006: [ If the condition function returns continue_processing as false, singlylinkedlist_remove_if
 * shall stop iterating through the list and return. ] */
