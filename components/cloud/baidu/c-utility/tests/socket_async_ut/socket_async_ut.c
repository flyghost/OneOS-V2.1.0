...
/* Tests_SRS_SOCKET_ASYNC_30_052: [ If the buffer parameter is NULL, socket_async_receive shall log the error and return
 * FAILURE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_053: [ If the received_count parameter is NULL, socket_async_receive shall log the error
 * and return FAILURE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_072: [ If the size parameter is 0, socket_async_receive shall log an error and return
 * FAILURE. ]*/
TEST_FUNCTION(socket_async_receive__parameter_validation__fails)
{
    ...
    populate_s_r_parameters(parameters + 0,
                            NULL,
                            sizeof(test_msg),
                            &received_count_receptor,
                            "Unexpected receive_result success when buffer is NULL");
    populate_s_r_parameters(parameters + 1,
                            test_msg,
                            sizeof(test_msg),
                            NULL,
                            "Unexpected receive_result success when received_count is NULL");
    populate_s_r_parameters(parameters + 2,
                            test_msg,
                            0,
                            &received_count_receptor,
                            "Unexpected receive_result success when size parameter is 0");
    ...
    for (i = 0; i < sizeof(parameters) / sizeof(send_receive_parameters_t); i++)
    {
        /// act
        int receive_result =
            socket_async_receive(test_socket, parameters[i].buffer, parameters[i].size, parameters[i].returned_count);

        /// assert
        ASSERT_ARE_EQUAL_WITH_MSG(size_t,
                                  received_count_receptor,
                                  BAD_BUFFER_COUNT,
                                  "Unexpected received_count_receptor");
...
/* Codes_SRS_SOCKET_ASYNC_30_056: [ If the underlying socket fails unexpectedly, socket_async_receive shall log the
...
/* Tests_SRS_SOCKET_ASYNC_30_055: [ If the underlying socket has no received bytes available, socket_async_receive shall
 * return 0 and the received_count parameter shall receive the value 0. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_054: [ On success, the underlying socket shall set one or more received bytes into buffer,
 * socket_async_receive shall return 0, and the received_count parameter shall receive the number of bytes received into
 * buffer. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_033: [ If the buffer parameter is NULL, socket_async_send shall log the error return
 * FAILURE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_034: [ If the sent_count parameter is NULL, socket_async_send shall log the error return
 * FAILURE. ]*/
TEST_FUNCTION(socket_async_send__parameter_validation__fails)
{
    ...
    for (i = 0; i < sizeof(parameters) / sizeof(send_receive_parameters_t); i++)
    {
        /// act
        int send_result =
            socket_async_send(test_socket, parameters[i].buffer, parameters[i].size, parameters[i].returned_count);
...
/* Tests_SRS_SOCKET_ASYNC_30_037: [ If socket_async_send fails unexpectedly, socket_async_send shall log the error
 * return FAILURE. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_036: [ If the underlying socket is unable to accept any bytes for transmission because its
 * buffer is full, socket_async_send shall return 0 and the sent_count parameter shall receive the value 0. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_073: [ If the size parameter is 0, socket_async_send shall set sent_count to 0 and return
 * 0. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_035: [ If the underlying socket accepts one or more bytes for transmission,
 * socket_async_send shall return 0 and the sent_count parameter shall receive the number of bytes accepted for
 * transmission. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_026: [ If the is_complete parameter is NULL, socket_async_is_create_complete shall log an
 * error and return FAILURE. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_028: [ On failure, the is_complete value shall be set to false and socket_async_create
...
/* Codes_SRS_SOCKET_ASYNC_30_027: [ On success, the is_complete value shall be set to the completion state and
 * socket_async_create shall return 0. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_010: [ If socket option creation fails, socket_async_create shall log an error and return
 * SOCKET_ASYNC_INVALID_SOCKET. ]*/
TEST_FUNCTION(socket_async_create__create_fail__fails)
{
    ...
    STRICT_EXPECTED_CALL(socket(AF_INET, SOCK_STREAM /* the TCP value, doesn't matter */, 0))
        .SetReturn(SOCKET_FAIL_RETURN);
...
/* Tests_SRS_SOCKET_ASYNC_30_020: [ If socket option setting fails, the sock value shall be set to
 * SOCKET_ASYNC_INVALID_SOCKET and socket_async_create shall log an error and return FAILURE. ]*/
TEST_FUNCTION(socket_async_create__opt_default_fail__fails)
{
    ...
    STRICT_EXPECTED_CALL(setsockopt(test_socket, IGNORED_NUM_ARG, IGNORED_NUM_ARG, IGNORED_PTR_ARG, IGNORED_NUM_ARG))
        .SetReturn(SETSOCKOPT_FAIL_RETURN);
...
/* Tests_SRS_SOCKET_ASYNC_30_021: [ If socket binding fails, socket_async_create shall log an error and return
 * SOCKET_ASYNC_INVALID_SOCKET. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_022: [ If socket connection fails, socket_async_create shall log an error and return
 * SOCKET_ASYNC_INVALID_SOCKET. ]*/
...
/* Tests_SRS_SOCKET_ASYNC_30_018: [ On success, socket_async_create shall return the created and configured
 * SOCKET_ASYNC_HANDLE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_013: [ The is_UDP parameter shall be true for a UDP connection, and false for TCP. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_014: [ If the optional options parameter is non-NULL and is_UDP is false,
 * socket_async_create shall set the socket options to the provided values. ]*/
 ...
 * SOCKET_ASYNC_HANDLE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_013: [ The is_UDP parameter shall be true for a UDP connection, and false for TCP. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_015: [ If the optional options parameter is non-NULL and is_UDP is false, and
 * options->keep_alive is negative, socket_async_create not set the socket keep-alive options. ]*/
TEST_FUNCTION(socket_async_create__tcp_default_sys_keep_alive__succeeds)
{
    /// arrange
    SOCKET_ASYNC_OPTIONS  options_value = {test_keep_alive_sys_default,
                                          test_keep_idle,
                                          test_keep_interval,
                                          test_keep_count};
    SOCKET_ASYNC_OPTIONS *options       = &options_value;
 ...
 * SOCKET_ASYNC_HANDLE. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_013: [ The is_UDP parameter shall be true for a UDP connection, and false for TCP. ]*/
/* Tests_SRS_SOCKET_ASYNC_30_017: [ If the optional options parameter is NULL and is_UDP is false, socket_async_create
 * shall disable TCP keep-alive. ]*/
