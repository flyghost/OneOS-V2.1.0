...
TARGET_RESULT target_create(size_t size)
{
    ...
    if (s_handle == NULL)
    {
        ...
        if (s_handle == NULL)
        {
            /* Codes_SRS_TEMPLATE_21_002: [ If callee_open return error, the target_create shall return
             * TARGET_RESULT_FAIL. ]*/
        ...
        else
        {
            ...
            if (a == NULL)
            {
                /* Codes_SRS_TEMPLATE_21_003: [ If there is no memory to control the target_create information, it shall
                 * return TARGET_RESULT_OUT_OF_MEMORY. ]*/
    ...
    {
        /* Codes_SRS_TEMPLATE_21_009: [ If callee_open is called but the connection is already created, it shall return
         * TARGET_RESULT_OK. ]*/
        result = TARGET_RESULT_OK;
    }
...
void target_destroy(void)
{
    if (s_handle == NULL)
    {
        /* Codes_SRS_TEMPLATE_21_007: [ If target_destroy is called but the connection is not created, the
         * target_destroy shall not do anything. ]*/
...
TARGET_RESULT target_foo(void)
{
    ...
    if (s_handle == NULL)
    {
        /* Codes_SRS_TEMPLATE_21_005: [ If target_foo is called but the connection is not created, the target_foo shall
         * return TARGET_RESULT_FAIL. ]*/
    ...
    else
    {
        ...
        {
            /* Codes_SRS_TEMPLATE_21_010: [ If target_foo cannot execute foo, the target_foo shall return
             * TARGET_RESULT_FAIL. ]*/
            result = TARGET_RESULT_FAIL;
        }
    }
