...
/* Tests_SRS_TEMPLATE_21_001: [ The target_create shall call callee_open to do stuffs and allocate the memory. ]*/
/* Tests_SRS_TEMPLATE_21_002: [ If callee_open return error, the target_create shall return TARGET_RESULT_FAIL. ]*/
/* Tests_SRS_TEMPLATE_21_003: [ If there is no memory to control the target_create information, it shall return
...
/* Tests_SRS_TEMPLATE_21_005: [ If target_foo is called but the connection is not created, the target_foo shall return
 * TARGET_RESULT_FAIL. ]*/
