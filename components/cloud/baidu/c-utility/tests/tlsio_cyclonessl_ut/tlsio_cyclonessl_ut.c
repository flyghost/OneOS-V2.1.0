...
#define TlsConnectionEnd_VALUES TLS_CONNECTION_END_CLIENT, TLS_CONNECTION_END_SERVER
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_001: [ tlsio_cyclonessl_create shall create a new instance of the tlsio for Cyclone
 * SSL. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_005: [ tlsio_cyclonessl_create shall copy the hostname and port values for later use
 * when the openof the underlying socket is needed. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_006: [ hostname shall be copied by calling mallocAndStrcpy_s. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_008: [ tlsio_cyclonessl_create shall initialize the yarrow context by calling
 * yarrowInit. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_010: [ The yarrow context shall be seeded with 32 bytes of randomly chosen data by
 * calling yarrowSeed. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_012: [ tlsio_cyclonessl_create shall create a TLS context by calling tlsInit. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_014: [ The TLS context shall be setup to operate as a client by calling
 * tlsSetConnectionEnd with TLS_CONNECTION_END_CLIENT. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_016: [ The pseudo random number generator to be used shall be set by calling tlsSetPrng
 * with the yarrow instance as argument. ]*/
...
TEST_FUNCTION(tlsio_cyclonessl_create_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "test")).IgnoreArgument_destination();
    ...
    STRICT_EXPECTED_CALL(tlsSetPrng(TEST_TLS_CONTEXT, YARROW_PRNG_ALGO, IGNORED_PTR_ARG)).IgnoreArgument_prngContext();
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_002: [ If io_create_parameters is NULL, tlsio_cyclonessl_create shall fail and return
 * NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_003: [ io_create_parameters shall be used as a TLSIO_CONFIG\*. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_004: [ If the hostname member is NULL, then tlsio_cyclonessl_create shall fail and
 * return NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_076: [ If allocating memory for the TLS IO instance fails then tlsio_cyclonessl_create
 * shall fail and return NULL. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_007: [ If mallocAndStrcpy_s fails then tlsio_cyclonessl_create shall fail and return
 * NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_018: [ When tlsio_cyclonessl_create fails, all allocated resources up to that point
 * shall be freed. ]*/
TEST_FUNCTION(when_a_failure_occurs_for_tlsio_cyclonessl_create_then_create_fails)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "test")).IgnoreArgument_destination().SetFailReturn(1);
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        ...
        CONCRETE_IO_HANDLE tlsio_handle =
            tlsio_cyclonessl_get_interface_description()->concrete_io_create(&tlsio_config);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_021: [ tlsio_cyclonessl_destroy shall deinitialize the yarrow context by calling
 * yarrowRelease. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_081: [ tlsio_cyclonessl_destroy should close the IO if it was open before freeing all
 * the resources. ]*/
TEST_FUNCTION(when_IO_is_open_tlsio_cyclonessl_destroy_also_closes_it)
{
    ...
    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_open(tlsio_handle,
 ...
 * ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_025: [ tlsio_cyclonessl_open shall create a socket by calling
 * tlsio_cyclonessl_socket_create, while passing to it the hostname and port that were saved in the
 * tlsio_cyclonessl_create. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_027: [ The socket created by tlsio_cyclonessl_socket_create shall be assigned to the
 * TLS context by calling tlsSetSocket. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_031: [ tlsio_cyclonessl_open shall start the TLS handshake by calling tlsConnect. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_033: [ If tlsConnect succeeds, the callback on_io_open_complete shall be called, while
 * passing on_io_open_complete_context and IO_OPEN_OK as arguments. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_078: [ If certificates have been set by using tlsio_cyclonessl_set_option then a call
 * to tlsSetTrustedCaList shall be made to pass the certificates to CycloneSSL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_024: [ If any of the arguments tls_io, on_io_open_complete, on_bytes_received or
 * on_io_error are NULL then tlsio_cyclonessl_open shall return a non-zero value. ]*/
TEST_FUNCTION(tlsio_cyclonessl_open_with_NULL_handle_fails)
{
    /// arrange

    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_open(NULL,
                                                                                test_on_io_open_complete,
                                                                                (void *)0x4242,
                                                                                test_on_bytes_received,
                                                                                (void *)0x4243,
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_026: [ If tlsio_cyclonessl_socket_create fails, then tlsio_cyclonessl_open shall return
 * a non-zero value. ]*/
 ...
 * ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_079: [ If tlsSetTrustedCaList fails then tlsio_cyclonessl_open shall return a non-zero
 * value. ]*/
TEST_FUNCTION(when_a_failure_occurs_for_tlsio_cyclonessl_open_then_create_fails)
{
    ...
    STRICT_EXPECTED_CALL(tlsio_cyclonessl_socket_create("test", 4242, IGNORED_PTR_ARG))
        .CopyOutArgumentBuffer_new_socket(&tls_socket, sizeof(tls_socket))
        .SetFailReturn(1);
    STRICT_EXPECTED_CALL(tlsSetSocket(TEST_TLS_CONTEXT, TEST_TLS_SOCKET)).SetFailReturn(ERROR_INVALID_PARAMETER);
    STRICT_EXPECTED_CALL(tlsSetTrustedCaList(TEST_TLS_CONTEXT, "certs", 5))
        .ValidateArgumentBuffer(2, "certs", 5)
        .SetFailReturn(ERROR_INVALID_PARAMETER);
    STRICT_EXPECTED_CALL(tlsConnect(TEST_TLS_CONTEXT)).SetFailReturn(ERROR_INVALID_PARAMETER);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_034: [ If tlsio_cyclonessl_open is called while the IO is open, tlsio_cyclonessl_open
 * shall fail and return a non-zero value without performing any work to open the IO. ]*/
TEST_FUNCTION(tlsio_cyclonessl_open_after_open_fails)
{
    ...
    CONCRETE_IO_HANDLE tlsio_handle = tlsio_cyclonessl_get_interface_description()->concrete_io_create(&tlsio_config);
    (void)tlsio_cyclonessl_get_interface_description()->concrete_io_open(tlsio_handle,
                                                                         test_on_io_open_complete,
                                                                         (void *)0x4242,
                                                                         test_on_bytes_received,
                                                                         (void *)0x4243,
 ...
 * ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_039: [ tlsio_cyclonessl_destroy shall destroy the underlying socket by calling
 * tlsio_cyclonessl_socket_destroy. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_040: [ On success, on_io_close_complete shall be called while passing as argument
 * on_io_close_complete_context. ]*/
TEST_FUNCTION(tlsio_cyclonessl_close_succeeds)
{
    ...
    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_close(tlsio_handle,
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_036: [ If the argument tls_io is NULL, tlsio_cyclonessl_close shall fail and return a
 * non-zero value. ]*/
TEST_FUNCTION(tlsio_cyclonessl_close_with_NULL_tls_io_fails)
{
    ...
    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_close(NULL,
                                                                                 test_on_io_close_complete,
                                                                                 (void *)0x4242);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_038: [ If tlsShutdown fails, tlsio_cyclonessl_close shall fail and return a non-zero
 * value. ]*/
TEST_FUNCTION(when_tlsShutdown_fails_tlsio_cyclonessl_close_fails)
{
    ...
    STRICT_EXPECTED_CALL(tlsShutdown(TEST_TLS_CONTEXT)).SetReturn(ERROR_INVALID_PARAMETER);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_041: [ If tlsio_cyclonessl_close is called when not open, tlsio_cyclonessl_close shall
...
TEST_FUNCTION(tlsio_cyclonessl_close_after_close_fails)
{
    ...
    (void)tlsio_cyclonessl_get_interface_description()->concrete_io_open(tlsio_handle,
                                                                         ...
                                                                         test_on_io_error,
                                                                         (void *)0x4244);
    (void)tlsio_cyclonessl_get_interface_description()->concrete_io_close(tlsio_handle,
                                                                          test_on_io_close_complete,
                                                                          (void *)0x4242);
    umock_c_reset_all_calls();
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_042: [ tlsio_cyclonessl_send shall send the `size` bytes pointed to by `buffer` and on
 * success it shall return 0. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_046: [ On success, if a non-NULL value was passed for on_send_complete, then
 * on_send_complete shall be called while passing to it the on_send_complete_context value. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_047: [ tlsio_cyclonessl_send shall send the bytes by calling tlsWrite and passing
 * buffer and size as arguments. 0 shall be passed for the flags argument. ]*/
TEST_FUNCTION(tlsio_cyclonessl_send_succeeds)
{
    ...
    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_send(tlsio_handle,
                                                                                test_buffer,
                                                                                sizeof(test_buffer),
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_043: [ If any of the arguments tls_io or buffer is NULL, tlsio_cyclonessl_send shall
 * fail and return a non-zero value. ]*/
TEST_FUNCTION(tlsio_cyclonessl_send_with_NULL_tls_io_fails)
{
    ...
    /// act
    int result = tlsio_cyclonessl_get_interface_description()->concrete_io_send(NULL,
                                                                                test_buffer,
                                                                                sizeof(test_buffer),
                                                                                NULL,
                                                                                NULL);
...
TEST_FUNCTION(tlsio_cyclonessl_send_with_0_size_fails)
{
    ...
    /// act
    int result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_send(tlsio_handle, test_buffer, 0, NULL, NULL);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_048: [ If tlsio_cyclonessl_send is called when the IO is not open,
 * tlsio_cyclonessl_send shall fail and return a non-zero value. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_049: [ If the IO is in an error state (an error was reported through the on_io_error
 * callback), tlsio_cyclonessl_send shall fail and return a non-zero value. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_056: [ Also the IO shall be considered in error and any subsequent calls to
 * tlsio_cyclonessl_send shall fail. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_050: [ tlsio_cyclonessl_dowork shall check if any bytes are available to be read from
 * the CycloneSSL library and indicate those bytes as received. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_080: [ If any bytes are read from CycloneSSL they should be indicated via the
 * on_bytes_received callback passed to tlsio_cyclonessl_open. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_053: [ If the IO is open, tlsio_cyclonessl_dowork shall attempt to read 64 bytes from
 * the TLS library by calling tlsRead. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_052: [ If the IO is not open (no open has been called or the IO has been closed) then
 * tlsio_cyclonessl_dowork shall do nothing. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_055: [ If tlsRead fails, the error shall be indicated by calling the on_io_error
 * callback passed in tlsio_cyclonessl_open, while passing the on_io_error_context to the callback. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_057: [ If any of the arguments tls_io or option_name is NULL tlsio_cyclonessl_setoption
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_058: [ If the option_name argument indicates an option that is not handled by
 * tlsio_cyclonessl, then tlsio_cyclonessl_setoption shall return a non-zero value. ]*/
TEST_FUNCTION(tlsio_cyclonessl_setoption_with_an_unknown_option_name_fails)
{
    ...
    /// act
    int result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_setoption(tlsio_handle, "nothingIknow", "xx");
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_059: [ If the option was handled by tlsio_cyclonessl, then tlsio_cyclonessl_setoption
 * shall return 0. ]*/
/* Tests_SRS_TLSIO_CYCLONESSL_01_060: [ - "TrustedCerts" - a char\* that shall be saved by tlsio_cyclonessl as it shall
 * be given to the underlying CycloneSSL TLS context when the IO is open. ]*/
TEST_FUNCTION(tlsio_cyclonessl_setoption_with_trustedCerts_clones_the_certs)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "xx")).IgnoreArgument_destination();

    /// act
    int result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_setoption(tlsio_handle, "TrustedCerts", "xx");
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_061: [ If copying the char\* passed in value fails then tlsio_cyclonessl_setoption
 * shall return a non-zero value. ]*/
TEST_FUNCTION(when_copying_the_tustedCerts_fails_tlsio_cyclonessl_setoption_fails)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "xx")).IgnoreArgument_destination().SetReturn(1);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_062: [ If a previous TrustedCerts option was saved, then the previous value shall be
 * freed. ]*/
TEST_FUNCTION(when_copying_the_tustedCerts_the_previous_option_value_is_freed_and_new_cert_copy_fails)
{
    ...
    EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "yy")).IgnoreArgument_destination().SetReturn(1);

    /// act
    int result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_setoption(tlsio_handle, "TrustedCerts", "yy");
...
TEST_FUNCTION(when_copying_the_tustedCerts_the_previous_option_value_is_freed)
{
    ...
    EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "yy")).IgnoreArgument_destination();
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_063: [ A NULL value shall be allowed for TrustedCerts, in which case the previously
 * stored TrustedCerts option value shall be cleared. ]*/
TEST_FUNCTION(tlsio_cyclonessl_setoption_with_NULL_TrustedCerts_frees_the_previous_certs_value)
{
    ...
    /// act
    int result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_setoption(tlsio_handle, "TrustedCerts", NULL);
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_064: [ If parameter handle is `NULL` then `tlsio_cyclonessl_retrieve_options` shall
...
TEST_FUNCTION(tlsio_cyclonessl_retrieveoptions_when_no_option_was_set_gives_back_an_emptyoption_handles)
{
    ...
    OPTIONHANDLER_HANDLE result =
        tlsio_cyclonessl_get_interface_description()->concrete_io_retrieveoptions(tlsio_handle);
...
TEST_FUNCTION(
    tlsio_cyclonessl_retrieveoptions_when_TrustedCerts_is_set_populates_the_trustedcerts_in_the_option_handler)
{
    /// arrange
    TLSIO_CONFIG tlsio_config;
    tlsio_config.hostname = "test";
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_068: [ If producing the OPTIONHANDLER_HANDLE fails then
 * tlsio_cyclonessl_retrieve_options shall fail and return NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_069: [ tlsio_cyclonessl_get_interface_description shall return a pointer to an
 * IO_INTERFACE_DESCRIPTION structure that contains pointers to the functions: tlsio_cyclonessl_retrieve_options,
 * tlsio_cyclonessl_create, tlsio_cyclonessl_destroy, tlsio_cyclonessl_open, tlsio_cyclonessl_close,
 * tlsio_cyclonessl_send and tlsio_cyclonessl_dowork.  ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_070: [ If the name or value arguments are NULL, tlsio_cyclonessl_clone_option shall
 * return NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_071: [ tlsio_cyclonessl_clone_option shall clone the option named `TrustedCerts` by
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_073: [ If mallocAndStrcpy_s for `TrustedCerts` fails, tlsio_cyclonessl_clone_option
 * shall return NULL. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_074: [ If any of the arguments is NULL, tlsio_cyclonessl_destroy_option shall do
 * nothing. ]*/
...
/* Tests_SRS_TLSIO_CYCLONESSL_01_075: [ If the option name is `TrustedCerts`, tlsio_cyclonessl_destroy_option shall free
 * the char\* option indicated by value. ]*/
