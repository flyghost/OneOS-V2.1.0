            ...
            if (currentTestFunction->FunctionType == CTEST_TEST_FUNCTION)
            {
                if (is_test_runner_ok == 1)
                {
                    ...
                    else
                    {
                        ...
                        {
                            /*can only get here if there was a longjmp called while executing
                             * currentTestFunction->TestFunction();*/
                            /*we don't do anything*/
                        }
                        g_CurrentTestFunction = NULL; /*g_CurrentTestFunction is limited to actually executing a
                                                         TEST_FUNCTION, otherwise it should be NULL*/
