...
int umock_c_init(ON_UMOCK_C_ERROR on_umock_c_error)
{
    ...
    {
        /* Codes_SRS_UMOCK_C_01_007: [ umock_c_init when umock is already initialized shall fail and return a non-zero
         * value. ]*/
    ...
    {
        /* Codes_SRS_UMOCK_C_LIB_01_144: [ Out of the box umock_c shall support the following types through the header
         * umocktypes_c.h: ]*/
        ...
        if ((umocktypes_init() != 0) ||
            /* Codes_SRS_UMOCK_C_01_002: [ umock_c_init shall register the C naive types by calling
               umocktypes_c_register_types. ]*/
            (umocktypes_c_register_types() != 0))
        {
            /* Codes_SRS_UMOCK_C_01_005: [ If any of the calls fails, umock_c_init shall fail and return a non-zero
             * value. ]*/
        ...
        {
            /* Codes_SRS_UMOCK_C_01_003: [ umock_c_init shall create a call recorder by calling
            ...
            else
            {
                ...
                /* Codes_SRS_UMOCK_C_01_006: [ The on_umock_c_error callback shall be stored to be used for later error
                 * callbacks. ]*/
...
void umock_c_reset_all_calls(void)
{
    ...
    if (umock_c_state == UMOCK_C_STATE_INITIALIZED)
    {
        /* Codes_SRS_UMOCK_C_01_011: [ umock_c_reset_all_calls shall reset all calls by calling
        ...
        {
            /* Codes_SRS_UMOCK_C_01_025: [ If the underlying umockcallrecorder_reset_all_calls fails, the
             * on_umock_c_error callback shall be triggered with UMOCK_C_RESET_CALLS_ERROR. ]*/
...
int umock_c_add_expected_call(UMOCKCALL_HANDLE mock_call)
{
    ...
    if (umock_c_state != UMOCK_C_STATE_INITIALIZED)
    {
        /* Codes_SRS_UMOCK_C_01_020: [ If the module is not initialized, umock_c_add_expected_call shall return a
         * non-zero value. ]*/
    ...
    {
        /* Codes_SRS_UMOCK_C_01_019: [ umock_c_add_expected_call shall add an expected call by calling
...
int umock_c_add_actual_call(UMOCKCALL_HANDLE mock_call, UMOCKCALL_HANDLE *matched_call)
{
    ...
    if (umock_c_state != UMOCK_C_STATE_INITIALIZED)
    {
        /* Codes_SRS_UMOCK_C_01_022: [ If the module is not initialized, umock_c_add_actual_call shall return a non-zero
         * value. ]*/
    ...
    {
        /* Codes_SRS_UMOCK_C_01_021: [ umock_c_add_actual_call shall add an actual call by calling
...
const char *umock_c_get_expected_calls(void)
{
    ...
    {
        /* Codes_SRS_UMOCK_C_01_015: [ umock_c_get_expected_calls shall return the string for the recorded expected
         * calls by calling umockcallrecorder_get_expected_calls on the call recorder created in umock_c_init. ]*/
...
const char *umock_c_get_actual_calls(void)
{
    ...
    {
        /* Codes_SRS_UMOCK_C_01_013: [ umock_c_get_actual_calls shall return the string for the recorded actual calls by
         * calling umockcallrecorder_get_actual_calls on the call recorder created in umock_c_init. ]*/
...
UMOCKCALL_HANDLE umock_c_get_last_expected_call(void)
{
    ...
    if (umock_c_state != UMOCK_C_STATE_INITIALIZED)
    {
        /* Codes_SRS_UMOCK_C_01_018: [ If the module is not initialized, umock_c_get_last_expected_call shall return
         * NULL. ]*/
    ...
    {
        /* Codes_SRS_UMOCK_C_01_017: [ umock_c_get_last_expected_call shall return the last expected call by calling
...
UMOCKCALLRECORDER_HANDLE umock_c_get_call_recorder(void)
{
    ...
    {
        /* Codes_SRS_UMOCK_C_01_026: [ umock_c_get_call_recorder shall return the handle to the currently used call
         * recorder. ]*/
...
int umock_c_set_call_recorder(UMOCKCALLRECORDER_HANDLE call_recorder)
{
    ...
    if (umock_c_state != UMOCK_C_STATE_INITIALIZED)
    {
        /* Codes_SRS_UMOCK_C_01_033: [ If the module is not initialized, umock_c_set_call_recorder shall return a
         * non-zero value. ]*/
    ...
    {
        /* Codes_SRS_UMOCK_C_01_030: [ If call_recorder is NULL, umock_c_set_call_recorder shall return a non-zero
         * value. ]*/
    ...
    else
    {
        ...
        /* Codes_SRS_UMOCK_C_01_028: [ umock_c_set_call_recorder shall replace the currently used call recorder with the
         * one identified by the call_recorder argument. ]*/
        /* Codes_SRS_UMOCK_C_01_031: [ umock_c_set_call_recorder shall make a copy of call_recorder by calling
        ...
        {
            /* Codes_SRS_UMOCK_C_01_032: [ If umockcallrecorder_clone fails, umock_c_set_call_recorder shall return a
             * non-zero value. ]*/
        ...
        {
            /* Codes_SRS_UMOCK_C_01_034: [ The previously used call recorder shall be destroyed by calling
