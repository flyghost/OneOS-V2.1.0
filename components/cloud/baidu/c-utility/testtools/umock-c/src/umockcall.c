...
UMOCKCALL_HANDLE umockcall_create(const char                   *function_name,
                                  void                         *umockcall_data,
                                  UMOCKCALL_DATA_COPY_FUNC      umockcall_data_copy,
                                  UMOCKCALL_DATA_FREE_FUNC      umockcall_data_free,
                                  UMOCKCALL_DATA_STRINGIFY_FUNC umockcall_data_stringify,
                                  UMOCKCALL_DATA_ARE_EQUAL_FUNC umockcall_data_are_equal)
{
    ...
    if ((function_name == NULL) || (umockcall_data == NULL) || (umockcall_data_copy == NULL) ||
        (umockcall_data_free == NULL) || (umockcall_data_stringify == NULL) || (umockcall_data_are_equal == NULL))
    {
        /* Codes_SRS_UMOCKCALL_01_003: [ If any of the arguments are NULL, umockcall_create shall fail and return NULL.
         * ] */
        UMOCK_LOG("umockcall: Cannot create call, invalid arguments: function_name = %p, umockcall_data = %p, "
                  "umockcall_data_free = %p, umockcall_data_stringify = %p, umockcall_data_are_equal = %p.",
                  function_name,
                  umockcall_data,
                  umockcall_data_free,
                  umockcall_data_stringify,
                  umockcall_data_are_equal);
        result = NULL;
    }
    else
    {
        /* Codes_SRS_UMOCKCALL_01_001: [ umockcall_create shall create a new instance of a umock call and on success it
         * shall return a non-NULL handle to it. ] */
        result = (UMOCKCALL *)umockalloc_malloc(sizeof(UMOCKCALL));
        /* Codes_SRS_UMOCKCALL_01_002: [ If allocating memory for the umock call instance fails, umockcall_create shall
         * return NULL. ] */
        if (result != NULL)
        {
            ...
            {
                /* Codes_SRS_UMOCKCALL_01_002: [ If allocating memory for the umock call instance fails,
                 * umockcall_create shall return NULL. ] */
...
/* Codes_SRS_UMOCKCALL_01_006: [ umockcall_are_equal shall compare the two mock calls and return whether they are equal
 * or not. ] */
int umockcall_are_equal(UMOCKCALL_HANDLE left, UMOCKCALL_HANDLE right)
{
    ...
    {
        /* Codes_SRS_UMOCKCALL_01_015: [ If only one of the left or right arguments are NULL, umockcall_are_equal shall
         * return 0. ] */
        result = 0;
    }
    else
    {
        ...
        {
            /* Codes_SRS_UMOCKCALL_01_014: [ If the two calls have different are_equal functions that have been passed
             * to umockcall_create then the calls shall be considered different and 0 shall be returned. ] */
            result = 0;
        }
        else if (strcmp(left->function_name, right->function_name) != 0)
        {
            /* Codes_SRS_UMOCKCALL_01_025: [ If the function name does not match for the 2 calls, umockcall_are_equal
             * shall return 0. ]*/
            result = 0;
        }
        else
        {
            /* Codes_SRS_UMOCKCALL_01_026: [ The call data shall be evaluated by calling the umockcall_data_are_equal
             * function passed in umockcall_create while passing as arguments the umockcall_data associated with each
             * call handle. ]*/
            switch (left->umockcall_data_are_equal(left->umockcall_data, right->umockcall_data))
            {
            default:
                /* Codes_SRS_UMOCKCALL_01_029: [ If the underlying umockcall_data_are_equal fails (returns anything else
                 * than 0 or 1), then umockcall_are_equal shall fail and return -1. ] */
                UMOCK_LOG("umockcall: comparing call data failed.");
                result = -1;
                break;
            case 1:
                /* Codes_SRS_UMOCKCALL_01_027: [ If the underlying umockcall_data_are_equal returns 1, then
                 * umockcall_are_equal shall return 1. ]*/
                result = 1;
                break;
            case 0:
                /* Codes_SRS_UMOCKCALL_01_028: [ If the underlying umockcall_data_are_equal returns 0, then
                 * umockcall_are_equal shall return 0. ]*/
                result = 0;
                break;
            }
        }
...
char *umockcall_stringify(UMOCKCALL_HANDLE umockcall)
{
    ...
    if (umockcall == NULL)
    {
        /* Codes_SRS_UMOCKCALL_01_020: [ If the underlying umockcall_data_stringify call fails, umockcall_stringify
    ...
    {
        /* Codes_SRS_UMOCKCALL_01_019: [ To obtain the arguments string, umockcall_stringify shall call the
         * umockcall_data_stringify function passed to umockcall_create and pass to it the umockcall_data pointer (also
         * given in umockcall_create). ]*/
        ...
        {
            /* Codes_SRS_UMOCKCALL_01_016: [ umockcall_stringify shall return a string representation of the mock call
             * in the form \[function_name(arguments)\]. ] */
            ...
            /* Codes_SRS_UMOCKCALL_01_018: [ The returned string shall be a newly allocated string and it is to be freed
             * by the caller. ]*/
            result = (char *)umockalloc_malloc(call_length + 1);
            /* Codes_SRS_UMOCKCALL_01_021: [ If not enough memory can be allocated for the string to be returned,
            ...
            /* Codes_SRS_UMOCKCALL_01_030: [ umockcall_stringify shall free the string obtained from
             * umockcall_data_stringify. ]*/
...
/* Codes_SRS_UMOCKCALL_01_031: [ umockcall_clone shall clone a umock call and on success it shall return a handle to the
 * newly cloned call. ] */
UMOCKCALL_HANDLE umockcall_clone(UMOCKCALL_HANDLE umockcall)
{
    ...
    else
    {
        ...
        if (result == NULL)
        {
            /* Codes_SRS_UMOCKCALL_01_043: [ If allocating memory for the new umock call fails, umockcall_clone shall
             * return NULL. ]*/
        ...
        else
        {
            ...
            if (result->function_name == NULL)
            {
                /* Codes_SRS_UMOCKCALL_01_036: [ If allocating memory for the function name fails, umockcall_clone shall
                 * return NULL. ]*/
            ...
            else
            {
                ...
                /* Codes_SRS_UMOCKCALL_01_033: [ The call data shall be cloned by calling the umockcall_data_copy
                 * function passed in umockcall_create and passing as argument the umockcall_data value passed in
                 * umockcall_create. ]*/
                result->umockcall_data = umockcall->umockcall_data_copy(umockcall->umockcall_data);
                if (result->umockcall_data == NULL)
                {
                    /* Codes_SRS_UMOCKCALL_01_034: [ If umockcall_data_copy fails then umockcall_clone shall return
                     * NULL. ]*/
                ...
                {
                    /* Codes_SRS_UMOCKCALL_01_037: [ umockcall_clone shall also copy all the functions passed to
                     * umockcall_create (umockcall_data_copy, umockcall_data_free, umockcall_data_are_equal,
                     * umockcall_data_stringify). ]*/
...
int umockcall_set_fail_call(UMOCKCALL_HANDLE umockcall, int fail_call)
{
    ...
    else
    {
        ...
        default:
            ...
            break;
        case 0:
            /* Codes_SRS_UMOCKCALL_01_038: [ umockcall_set_fail_call shall store the fail_call value, associating it
...
int umockcall_get_fail_call(UMOCKCALL_HANDLE umockcall)
{
    ...
    {
        /* Codes_SRS_UMOCKCALL_01_041: [ umockcall_get_fail_call shall retrieve the fail_call value, associated with the
...
int umockcall_set_ignore_all_calls(UMOCKCALL_HANDLE umockcall, int ignore_all_calls)
{
    ...
    if (umockcall == NULL)
    {
        /* Codes_SRS_UMOCKCALL_01_047: [ If umockcall is NULL, umockcall_set_ignore_all_calls shall return a non-zero
         * value. ]*/
        UMOCK_LOG("umockcall_set_fail_call: NULL umockcall.");
        result = __LINE__;
    }
    else
    {
        ...
        {
        default:
            /* Codes_SRS_UMOCKCALL_01_048: [ If a value different than 0 and 1 is passed as ignore_all_calls,
            ...
            break;
        case 0:
            /* Codes_SRS_UMOCKCALL_01_045: [ umockcall_set_ignore_all_calls shall store the ignore_all_calls value,
             * associating it with the umockcall call instance. ]*/
...
int umockcall_get_ignore_all_calls(UMOCKCALL_HANDLE umockcall)
{
    ...
    {
        /* Codes_SRS_UMOCKCALL_01_049: [ umockcall_get_ignore_all_calls shall retrieve the ignore_all_calls value,
         * associated with the umockcall call instance. ]*/
