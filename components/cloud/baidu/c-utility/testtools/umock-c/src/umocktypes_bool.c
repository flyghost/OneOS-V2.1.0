...
char *umocktypes_stringify_bool(const bool *value)
{
    ...
    else
    {
        ...
        /* Codes_SRS_UMOCKTYPES_BOOL_01_004: [ If allocating a new string to hold the string representation fails,
         * umocktypes_stringify_bool shall return NULL. ]*/
...
int umocktypes_are_equal_bool(const bool *left, const bool *right)
{
    ...
    {
        /* Codes_SRS_UMOCKTYPES_BOOL_01_007: [ If any of the arguments is NULL, umocktypes_are_equal_bool shall return
         * -1. ]*/
    ...
    {
        /* Codes_SRS_UMOCKTYPES_BOOL_01_009: [ If the values pointed to by left and right are different,
         * umocktypes_are_equal_bool shall return 0. ]*/
        /* Codes_SRS_UMOCKTYPES_BOOL_01_008: [ If the values pointed to by left and right are equal,
         * umocktypes_are_equal_bool shall return 1. ]*/
...
int umocktypes_copy_bool(bool *destination, const bool *source)
{
    ...
    {
        /* Codes_SRS_UMOCKTYPES_BOOL_01_012: [ If source or destination are NULL, umocktypes_copy_bool shall return a
         * non-zero value. ]*/
...
int umocktypes_bool_register_types(void)
{
    ...
    /* Codes_SRS_UMOCKTYPES_BOOL_01_001: [ umocktypes_bool_register_types shall register support for all the types in
     * the module. ]*/
    if ((umocktypes_register_type("bool",
                                  (UMOCKTYPE_STRINGIFY_FUNC)umocktypes_stringify_bool,
                                  (UMOCKTYPE_ARE_EQUAL_FUNC)umocktypes_are_equal_bool,
                                  (UMOCKTYPE_COPY_FUNC)umocktypes_copy_bool,
                                  (UMOCKTYPE_FREE_FUNC)umocktypes_free_bool) != 0) ||
        (umocktypes_register_type("_Bool",
                                  (UMOCKTYPE_STRINGIFY_FUNC)umocktypes_stringify_bool,
                                  (UMOCKTYPE_ARE_EQUAL_FUNC)umocktypes_are_equal_bool,
                                  (UMOCKTYPE_COPY_FUNC)umocktypes_copy_bool,
                                  (UMOCKTYPE_FREE_FUNC)umocktypes_free_bool) != 0))
    {
        /* Codes_SRS_UMOCKTYPES_BOOL_01_015: [ If registering any of the types fails, umocktypes_bool_register_types
