...
{
    umockcallrecorder_get_expected_call_count_CALL *new_calls =
        (umockcallrecorder_get_expected_call_count_CALL *)realloc(
            umockcallrecorder_get_expected_call_count_calls,
            sizeof(umockcallrecorder_get_expected_call_count_CALL) *
                (umockcallrecorder_get_expected_call_count_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_get_expected_call_count_calls = new_calls;
        umockcallrecorder_get_expected_call_count_calls[umockcallrecorder_get_expected_call_count_call_count]
...
{
    umockcallrecorder_fail_call_CALL *new_calls = (umockcallrecorder_fail_call_CALL *)realloc(
        umockcallrecorder_fail_call_calls,
        sizeof(umockcallrecorder_fail_call_CALL)  *(umockcallrecorder_fail_call_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_fail_call_calls = new_calls;
        umockcallrecorder_fail_call_calls[umockcallrecorder_fail_call_call_count].umock_call_recorder =
            umock_call_recorder;
...
{
    umock_c_set_call_recorder_CALL *new_calls = (umock_c_set_call_recorder_CALL *)realloc(
        umock_c_set_call_recorder_calls,
        sizeof(umock_c_set_call_recorder_CALL)  *(umock_c_set_call_recorder_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umock_c_indicate_error_CALL *new_calls = (umock_c_indicate_error_CALL *)realloc(
        umock_c_indicate_error_calls,
        sizeof(umock_c_indicate_error_CALL)  *(umock_c_indicate_error_call_count + 1));
    if (new_calls != NULL)
    {
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_001: [ umock_c_negative_tests_init shall initialize the umock_c negative tests
 * library.] */
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_005: [ If the module has already been initialized, umock_c_negative_tests_init
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_002: [ umock_c_negative_tests_deinit shall free all resources associated with the
 * negative tests module. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_003: [ If the module was not previously initialized,
 * umock_c_negative_tests_deinit shall do nothing. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_006: [ umock_c_negative_tests_snapshot shall make a copy of the current call
 * recorder for umock_c with all its recorded calls. ]*/
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_007: [ The current call recorder shall be obtained by calling
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_009: [ If getting the call recorder fails, umock_c_negative_tests_snapshot shall
 * indicate the error via the umock error callback with error code UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_010: [ If copying the call recorder fails, umock_c_negative_tests_snapshot shall
 * indicate the error via the umock error callback with error code UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_015: [ If the module was not previously initialized,
 * umock_c_negative_tests_snapshot shall do nothing. ]*/
 ...
 * to the call recorder stored in umock_c_negative_tests_reset. ]*/
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_013: [ The reset shall be done by calling umock_c_set_call_recorder and passing
 * the call recorder stored in umock_c_negative_tests_reset as argument. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_012: [ If no call has been made to umock_c_negative_tests_snapshot,
 * umock_c_negative_tests_reset shall indicate a failure via the umock error callback with error code UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_014: [ If umock_c_set_call_recorder fails, umock_c_negative_tests_reset shall
 * indicate a failure via the umock error callback with error code UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_017: [ umock_c_negative_tests_fail_call shall call umockcallrecorder_fail_call on
 * the currently used call recorder used by umock_c. ]*/
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_018: [ The currently used recorder shall be obtained by calling
 * umock_c_get_call_recorder. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_019: [ If umock_c_get_call_recorder fails, umock_c_negative_tests_fail_call shall
 * indicate the error via the umock error callback with error code UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_025: [ If failing the call by calling umockcallrecorder_fail_call fails,
 * umock_c_negative_tests_fail_call shall indicate the error via the umock error callback with error code UMOCK_C_ERROR.
 * ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_020: [ If the module was not previously initialized,
 * umock_c_negative_tests_fail_call shall do nothing. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_021: [ umock_c_negative_tests_call_count shall return the count of expected calls
 * for the current snapshot call recorder by calling umockcallrecorder_get_expected_call_count. ]*/
TEST_FUNCTION(umock_c_negative_tests_call_count_gets_the_expected_call_count_from_the_current_recorder)
{
    ...
    ASSERT_ARE_EQUAL(void_ptr,
                     test_call_recorder,
                     umockcallrecorder_get_expected_call_count_calls[0].umock_call_recorder);
    ASSERT_ARE_EQUAL(size_t, 0, umock_c_indicate_error_call_count);
}

/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_022: [ If no call has been made to umock_c_negative_tests_snapshot,
 * umock_c_negative_tests_fail_call shall return 0 and indicate the error via the umock error callback with error code
 * UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_023: [ If umockcallrecorder_get_expected_call_count fails,
 * umock_c_negative_tests_fail_call shall return 0 and indicate the error via the umock error callback with error code
 * UMOCK_C_ERROR. ]*/
...
/* Tests_SRS_UMOCK_C_NEGATIVE_TESTS_01_024: [ If the module was not previously initialized,
 * umock_c_negative_tests_call_count shall return 0. ]*/
