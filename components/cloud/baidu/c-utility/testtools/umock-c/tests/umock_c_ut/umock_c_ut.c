...
{
    umockcallrecorder_destroy_CALL *new_calls = (umockcallrecorder_destroy_CALL *)realloc(
        umockcallrecorder_destroy_calls,
        sizeof(umockcallrecorder_destroy_CALL)  *(umockcallrecorder_destroy_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcallrecorder_reset_all_calls_CALL *new_calls = (umockcallrecorder_reset_all_calls_CALL *)realloc(
        umockcallrecorder_reset_all_calls_calls,
        sizeof(umockcallrecorder_reset_all_calls_CALL)  *(umockcallrecorder_reset_all_calls_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_reset_all_calls_calls = new_calls;
        umockcallrecorder_reset_all_calls_calls[umockcallrecorder_reset_all_calls_call_count].umock_call_recorder =
            umock_call_recorder;
...
{
    umockcallrecorder_add_expected_call_CALL *new_calls = (umockcallrecorder_add_expected_call_CALL *)realloc(
        umockcallrecorder_add_expected_call_calls,
        sizeof(umockcallrecorder_add_expected_call_CALL)  *(umockcallrecorder_add_expected_call_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_add_expected_call_calls = new_calls;
        umockcallrecorder_add_expected_call_calls[umockcallrecorder_add_expected_call_call_count].umock_call_recorder =
            umock_call_recorder;
        umockcallrecorder_add_expected_call_calls[umockcallrecorder_add_expected_call_call_count].mock_call = mock_call;
...
int umockcallrecorder_add_actual_call(UMOCKCALLRECORDER_HANDLE umock_call_recorder,
                                      ...
                                      UMOCKCALL_HANDLE        *matched_call)
{
    umockcallrecorder_add_actual_call_CALL *new_calls = (umockcallrecorder_add_actual_call_CALL *)realloc(
        umockcallrecorder_add_actual_call_calls,
        sizeof(umockcallrecorder_add_actual_call_CALL)  *(umockcallrecorder_add_actual_call_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_add_actual_call_calls = new_calls;
        umockcallrecorder_add_actual_call_calls[umockcallrecorder_add_actual_call_call_count].umock_call_recorder =
            umock_call_recorder;
        umockcallrecorder_add_actual_call_calls[umockcallrecorder_add_actual_call_call_count].mock_call = mock_call;
        umockcallrecorder_add_actual_call_calls[umockcallrecorder_add_actual_call_call_count].matched_call =
            matched_call;
...
{
    umockcallrecorder_clone_CALL *new_calls = (umockcallrecorder_clone_CALL *)realloc(
        umockcallrecorder_clone_calls,
        sizeof(umockcallrecorder_clone_CALL)  *(umockcallrecorder_clone_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcallrecorder_get_actual_calls_CALL *new_calls = (umockcallrecorder_get_actual_calls_CALL *)realloc(
        umockcallrecorder_get_actual_calls_calls,
        sizeof(umockcallrecorder_get_actual_calls_CALL)  *(umockcallrecorder_get_actual_calls_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_get_actual_calls_calls = new_calls;
        umockcallrecorder_get_actual_calls_calls[umockcallrecorder_get_actual_calls_call_count].umock_call_recorder =
            umock_call_recorder;
...
{
    umockcallrecorder_get_expected_calls_CALL *new_calls = (umockcallrecorder_get_expected_calls_CALL *)realloc(
        umockcallrecorder_get_expected_calls_calls,
        sizeof(umockcallrecorder_get_expected_calls_CALL)  *(umockcallrecorder_get_expected_calls_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_get_expected_calls_calls = new_calls;
        umockcallrecorder_get_expected_calls_calls[umockcallrecorder_get_expected_calls_call_count]
            .umock_call_recorder = umock_call_recorder;
...
{
    umockcallrecorder_get_last_expected_call_CALL *new_calls = (umockcallrecorder_get_last_expected_call_CALL *)realloc(
        umockcallrecorder_get_last_expected_call_calls,
        sizeof(umockcallrecorder_get_last_expected_call_CALL) *
            (umockcallrecorder_get_last_expected_call_call_count + 1));
    if (new_calls != NULL)
    {
        umockcallrecorder_get_last_expected_call_calls = new_calls;
        umockcallrecorder_get_last_expected_call_calls[umockcallrecorder_get_last_expected_call_call_count]
            .umock_call_recorder = umock_call_recorder;
...
/* Tests_SRS_UMOCK_C_01_011: [ umock_c_reset_all_calls shall reset all calls by calling
 * umockcallrecorder_reset_all_calls on the call recorder created in umock_c_init. ]*/
...
/* Tests_SRS_UMOCK_C_01_025: [ If the underlying umockcallrecorder_reset_all_calls fails, the on_umock_c_error callback
 * shall be triggered with UMOCK_C_RESET_CALLS_ERROR. ]*/
TEST_FUNCTION(
    when_the_underlying_call_recorder_reset_all_calls_fails_then_umock_c_reset_all_calls_triggers_the_on_error_callback)
{
    // arrange
...
/* Tests_SRS_UMOCK_C_01_013: [ umock_c_get_actual_calls shall return the string for the recorded actual calls by calling
 * umockcallrecorder_get_actual_calls on the call recorder created in umock_c_init. ]*/
...
/* Tests_SRS_UMOCK_C_01_015: [ umock_c_get_expected_calls shall return the string for the recorded expected calls by
 * calling umockcallrecorder_get_expected_calls on the call recorder created in umock_c_init. ]*/
...
/* Tests_SRS_UMOCK_C_01_017: [ umock_c_get_last_expected_call shall return the last expected call by calling
 * umockcallrecorder_get_last_expected_call on the call recorder created in umock_c_init. ]*/
TEST_FUNCTION(umock_c_get_last_expected_call_calls_the_underlying_call_recorder_get_last_expected_call)
{
    ...
    ASSERT_ARE_EQUAL(void_ptr,
                     test_call_recorder,
                     umockcallrecorder_get_last_expected_call_calls[0].umock_call_recorder);
}

/* Tests_SRS_UMOCK_C_01_017: [ umock_c_get_last_expected_call shall return the last expected call by calling
 * umockcallrecorder_get_last_expected_call on the call recorder created in umock_c_init. ]*/
TEST_FUNCTION(
    when_the_underlying_call_recorder_get_last_expected_call_fails_then_umock_c_get_last_expected_call_returns_NULL)
{
    // arrange
    UMOCKCALL_HANDLE result;
    (void)umock_c_init(test_on_umock_c_error);
...
/* Tests_SRS_UMOCK_C_01_019: [ umock_c_add_expected_call shall add an expected call by calling
 * umockcallrecorder_add_expected_call on the call recorder created in umock_c_init. ]*/
TEST_FUNCTION(umock_c_add_expected_call_calls_the_underlying_call_recorder_add_expected_call)
{
    ...
    ASSERT_ARE_EQUAL(void_ptr, test_expected_call, umockcallrecorder_add_expected_call_calls[0].mock_call);
}
...
/* Tests_SRS_UMOCK_C_01_020: [ If the module is not initialized, umock_c_add_expected_call shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCK_C_01_021: [ umock_c_add_actual_call shall add an actual call by calling
 * umockcallrecorder_add_actual_call on the call recorder created in umock_c_init. ]*/
TEST_FUNCTION(umock_c_add_actual_call_calls_the_underlying_call_recorder_add_actual_call)
{
    ...
    ASSERT_ARE_EQUAL(void_ptr, test_actual_call, umockcallrecorder_add_actual_call_calls[0].mock_call);
    ASSERT_ARE_EQUAL(void_ptr, &matched_call, umockcallrecorder_add_actual_call_calls[0].matched_call);
}
...
/* Tests_SRS_UMOCK_C_01_022: [** If the module is not initialized, umock_c_add_actual_call shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCK_C_01_028: [ umock_c_set_call_recorder shall replace the currently used call recorder with the one
 * identified by the call_recorder argument. ]*/
/* Tests_SRS_UMOCK_C_01_029: [ On success, umock_c_set_call_recorder shall return 0. ]*/
/* Tests_SRS_UMOCK_C_01_031: [ umock_c_set_call_recorder shall make a copy of call_recorder by calling
 * umockcallrecorder_clone and use the copy for future actions. ]*/
/* Tests_SRS_UMOCK_C_01_034: [ The previously used call recorder shall be destroyed by calling
...
/* Tests_SRS_UMOCK_C_01_032: [ If umockcallrecorder_clone fails, umock_c_set_call_recorder shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCK_C_01_033: [ If the module is not initialized, umock_c_set_call_recorder shall return a non-zero
 * value. ]*/
