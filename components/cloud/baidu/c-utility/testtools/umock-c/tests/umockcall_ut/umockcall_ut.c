...
{
    test_mock_call_data_copy_CALL *new_calls = (test_mock_call_data_copy_CALL *)realloc(
        test_mock_call_data_copy_calls,
        sizeof(test_mock_call_data_copy_CALL)  *(test_mock_call_data_copy_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_mock_call_data_free_CALL *new_calls = (test_mock_call_data_free_CALL *)realloc(
        test_mock_call_data_free_calls,
        sizeof(test_mock_call_data_free_CALL)  *(test_mock_call_data_free_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_mock_call_data_stringify_CALL *new_calls = (test_mock_call_data_stringify_CALL *)realloc(
        test_mock_call_data_stringify_calls,
        sizeof(test_mock_call_data_stringify_CALL)  *(test_mock_call_data_stringify_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_mock_call_data_are_equal_CALL *new_calls = (test_mock_call_data_are_equal_CALL *)realloc(
        test_mock_call_data_are_equal_calls,
        sizeof(test_mock_call_data_are_equal_CALL)  *(test_mock_call_data_are_equal_call_count + 1));
    if (new_calls != NULL)
    {
...
/* Tests_SRS_UMOCKCALL_01_001: [ umockcall_create shall create a new instance of a umock call and on success it shall
 * return a non-NULL handle to it. ] */
TEST_FUNCTION(umockcall_create_with_proper_args_succeeds)
{
    // arrange

    // act
    UMOCKCALL_HANDLE result = umockcall_create("test_function",
                                               (void *)0x4242,
                                               test_mock_call_data_copy,
                                               test_mock_call_data_free,
                                               test_mock_call_data_stringify,
                                               test_mock_call_data_are_equal);
...
TEST_FUNCTION(umockcall_create_with_NULL_function_name_fails)
{
    ...
    // act
    UMOCKCALL_HANDLE result = umockcall_create(NULL,
                                               (void *)0x4242,
                                               test_mock_call_data_copy,
                                               test_mock_call_data_free,
                                               test_mock_call_data_stringify,
...
/* Tests_SRS_UMOCKCALL_01_002: [ If allocating memory for the umock call instance fails, umockcall_create shall return
 * NULL. ]*/
TEST_FUNCTION(when_allocating_memory_for_the_call_fails_then_umockcall_create_fails)
{
    ...
    // act
    result = umockcall_create("test_function",
                              (void *)0x4242,
                              test_mock_call_data_copy,
                              test_mock_call_data_free,
                              test_mock_call_data_stringify,
...
{
    // arrange
    UMOCKCALL_HANDLE call = umockcall_create("test_function",
                                             (void *)0x4242,
                                             test_mock_call_data_copy,
                                             test_mock_call_data_free,
                                             test_mock_call_data_stringify,
...
/* Tests_SRS_UMOCKCALL_01_006: [ umockcall_are_equal shall compare the two mock calls and return whether they are equal
 * or not. ] */
...
/* Tests_SRS_UMOCKCALL_01_006: [ umockcall_are_equal shall compare the two mock calls and return whether they are equal
 * or not. ] */
/* Tests_SRS_UMOCKCALL_01_027: [ If the underlying umockcall_data_are_equal returns 1, then umockcall_are_equal shall
 * return 1. ]*/
TEST_FUNCTION(umockcall_are_equal_with_2_equal_calls_returns_1)
{
    // arrange
    UMOCKCALL_HANDLE call1 = umockcall_create("test_function",
                                              (void *)0x4242,
                                              test_mock_call_data_copy,
                                              test_mock_call_data_free,
                                              test_mock_call_data_stringify,
                                              test_mock_call_data_are_equal);
    UMOCKCALL_HANDLE call2 = umockcall_create("test_function",
                                              (void *)0x4243,
                                              test_mock_call_data_copy,
                                              test_mock_call_data_free,
                                              test_mock_call_data_stringify,
...
/* Tests_SRS_UMOCKCALL_01_015: [ If only one of the left or right arguments are NULL, umockcall_are_equal shall return
 * 0. ] */
...
/* Tests_SRS_UMOCKCALL_01_025: [ If the function name does not match for the 2 calls, umockcall_are_equal shall return
 * 0. ]*/
TEST_FUNCTION(when_the_function_name_does_not_match_then_umockcall_are_equal_returns_0)
{
    // arrange
    int              result;
    UMOCKCALL_HANDLE call1 = umockcall_create("test_function_1",
                                              (void *)0x4242,
                                              test_mock_call_data_copy,
                                              test_mock_call_data_free,
                                              test_mock_call_data_stringify,
                                              test_mock_call_data_are_equal);
    UMOCKCALL_HANDLE call2 = umockcall_create("test_function_2",
                                              (void *)0x4242,
                                              test_mock_call_data_copy,
                                              test_mock_call_data_free,
                                              test_mock_call_data_stringify,
    ...
    // act
    result = umockcall_are_equal(call1, call2);
...
/* Tests_SRS_UMOCKCALL_01_026: [ The call data shall be evaluated by calling the umockcall_data_are_equal function
 * passed in umockcall_create while passing as arguments the umockcall_data associated with each call handle. ]*/
/* Tests_SRS_UMOCKCALL_01_028: [ If the underlying umockcall_data_are_equal returns 0, then umockcall_are_equal shall
 * return 0. ]*/
...
/* Tests_SRS_UMOCKCALL_01_029: [ If the underlying umockcall_data_are_equal fails (returns anything else than 0 or 1),
 * then umockcall_are_equal shall fail and return -1. ] */
...
/* Tests_SRS_UMOCKCALL_01_014: [ If the two calls have different are_equal functions that have been passed to
 * umockcall_create then the calls shall be considered different and 0 shall be returned. ] */
TEST_FUNCTION(when_the_are_equal_function_pointers_are_different_umockcall_are_equal_returns_0)
{
    ...
    UMOCKCALL_HANDLE call2 = umockcall_create("test_function",
                                              ...
                                              test_mock_call_data_free,
                                              test_mock_call_data_stringify,
                                              another_test_mock_call_data_are_equal);
...
/* Tests_SRS_UMOCKCALL_01_016: [ umockcall_stringify shall return a string representation of the mock call in the form
 * \[function_name(arguments)\]. ] */
/* Tests_SRS_UMOCKCALL_01_018: [ The returned string shall be a newly allocated string and it is to be freed by the
 * caller. ]*/
/* Tests_SRS_UMOCKCALL_01_019: [ To obtain the arguments string, umockcall_stringify shall call the
 * umockcall_data_stringify function passed to umockcall_create and pass to it the umockcall_data pointer (also given in
 * umockcall_create). ]*/
TEST_FUNCTION(umockcall_stringify_calls_the_underlying_stringify_function_and_returns_the_strinfigied_call)
{
    ...
    // act
    result = umockcall_stringify(call);
...
/* Tests_SRS_UMOCKCALL_01_020: [ If the underlying umockcall_data_stringify call fails, umockcall_stringify shall fail
 * and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALL_01_021: [ If not enough memory can be allocated for the string to be returned,
 * umockcall_stringify shall fail and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALL_01_022: [ umockcall_get_call_data shall return the associated umock call data that was passed to
 * umockcall_create. ]*/
...
/* Tests_SRS_UMOCKCALL_01_031: [ umockcall_clone shall clone a umock call and on success it shall return a handle to the
 * newly cloned call. ] */
/* Tests_SRS_UMOCKCALL_01_033: [ The call data shall be cloned by calling the umockcall_data_copy function passed in
 * umockcall_create and passing as argument the umockcall_data value passed in umockcall_create. ]*/
/* Tests_SRS_UMOCKCALL_01_035: [ umockcall_clone shall copy also the function name. ]*/
/* Tests_SRS_UMOCKCALL_01_037: [ umockcall_clone shall also copy all the functions passed to umockcall_create
 * (umockcall_data_copy, umockcall_data_free, umockcall_data_are_equal, umockcall_data_stringify). ]*/
...
/* Tests_SRS_UMOCKCALL_01_038: [ umockcall_set_fail_call shall store the fail_call value, associating it with the
 * umockcall call instance. ]*/
...
TEST_FUNCTION(umockcall_set_fail_call_sets_the_fail_call_property)
{
    ...
    // act
    result = umockcall_set_fail_call(call, 1);
...
/* Tests_SRS_UMOCKCALL_01_040: [ If a value different than 0 and 1 is passed as fail_call, umockcall_set_fail_call shall
...
/* Tests_SRS_UMOCKCALL_01_041: [ umockcall_get_fail_call shall retrieve the fail_call value, associated with the
 * umockcall call instance. ]*/
TEST_FUNCTION(umockcall_get_fail_call_retrieves_0)
{
    ...
    // act
    result = umockcall_get_fail_call(call);
...
TEST_FUNCTION(umockcall_get_fail_call_on_a_cloned_call_retrieves_1)
{
    ...
    // act
    result = umockcall_get_fail_call(cloned_call);
...
/* Tests_SRS_UMOCKCALL_01_045: [ umockcall_set_ignore_all_calls shall store the ignore_all_calls value, associating it
 * with the umockcall call instance. ]*/
...
/* Tests_SRS_UMOCKCALL_01_048: [ If a value different than 0 and 1 is passed as ignore_all_calls,
 * umockcall_set_ignore_all_calls shall return a non-zero value. ]*/
...
/* Tests_SRS_UMOCKCALL_01_049: [ umockcall_get_ignore_all_calls shall retrieve the ignore_all_calls value, associated
 * with the umockcall call instance. ]*/
TEST_FUNCTION(umockcall_get_ignore_all_calls_retrieves_0)
{
    ...
    // act
    result = umockcall_get_ignore_all_calls(call);
...
TEST_FUNCTION(umockcall_get_ignore_all_calls_on_a_cloned_call_retrieves_1)
{
    ...
    // act
    result = umockcall_get_ignore_all_calls(cloned_call);
