...
{
    umockcall_get_ignore_all_calls_CALL *new_calls = (umockcall_get_ignore_all_calls_CALL *)realloc(
        umockcall_get_ignore_all_calls_calls,
        sizeof(umockcall_get_ignore_all_calls_CALL)  *(umockcall_get_ignore_all_calls_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcall_are_equal_CALL *new_calls =
        (umockcall_are_equal_CALL *)realloc(umockcall_are_equal_calls,
                                            sizeof(umockcall_are_equal_CALL)  *(umockcall_are_equal_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcall_destroy_CALL *new_calls =
        (umockcall_destroy_CALL *)realloc(umockcall_destroy_calls,
                                          sizeof(umockcall_destroy_CALL)  *(umockcall_destroy_call_count + 1));
    if (new_calls != NULL)
    {
...
UMOCKCALL_HANDLE umockcall_clone(UMOCKCALL_HANDLE umockcall)
{
    ...
    umockcall_clone_CALL *new_calls =
        (umockcall_clone_CALL *)realloc(umockcall_clone_calls,
                                        sizeof(umockcall_clone_CALL)  *(umockcall_clone_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcall_set_fail_call_CALL *new_calls = (umockcall_set_fail_call_CALL *)realloc(
        umockcall_set_fail_call_calls,
        sizeof(umockcall_set_fail_call_CALL)  *(umockcall_set_fail_call_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    umockcall_get_fail_call_CALL *new_calls = (umockcall_get_fail_call_CALL *)realloc(
        umockcall_get_fail_call_calls,
        sizeof(umockcall_get_fail_call_CALL)  *(umockcall_get_fail_call_call_count + 1));
    if (new_calls != NULL)
    {
...
char *umockcall_stringify(UMOCKCALL_HANDLE umockcall)
{
    ...
    umockcall_stringify_CALL *new_calls =
        (umockcall_stringify_CALL *)realloc(umockcall_stringify_calls,
                                            sizeof(umockcall_stringify_CALL)  *(umockcall_stringify_call_count + 1));
    if (new_calls != NULL)
    {
...
/* Tests_SRS_UMOCKCALLRECORDER_01_001: [ umockcallrecorder_create shall create a new instance of a call recorder and
...
/* Tests_SRS_UMOCKCALLRECORDER_01_002: [ If allocating memory for the call recorder fails, umockcallrecorder_create
 * shall return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_003: [ umockcallrecorder_destroy shall free the resources associated with a the call
 * recorder identified by the umock_call_recorder argument. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_005: [ umockcallrecorder_reset_all_calls shall free all the expected and actual calls
 * for the call recorder identified by umock_call_recorder. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_007: [ If umock_call_recorder is NULL, umockcallrecorder_reset_all_calls shall fail
...
/* Tests_SRS_UMOCKCALLRECORDER_01_008: [ umockcallrecorder_add_expected_call shall add the mock_call call to the
 * expected call list maintained by the call recorder identified by umock_call_recorder. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_012: [ If any of the arguments is NULL, umockcallrecorder_add_expected_call shall fail
 * and return a non-zero value. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_013: [ If allocating memory for the expected calls fails,
...
/* Tests_SRS_UMOCKCALLRECORDER_01_014: [ umockcallrecorder_add_actual_call shall check whether the call mock_call
 * matches any of the expected calls maintained by umock_call_recorder. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_019: [ If any of the arguments is NULL, umockcallrecorder_add_actual_call shall fail
 * and return a non-zero value. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_020: [ If allocating memory for the actual calls fails,
...
/* Tests_SRS_UMOCKCALLRECORDER_01_021: [ If umockcall_are_equal fails, umockcallrecorder_add_actual_call shall fail and
...
/* Tests_SRS_UMOCKCALLRECORDER_01_016: [ If the call matches one of the expected calls, a handle to the matched call
 * shall be filled into the matched_call argument. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_057: [ If any expected call has `ignore_all_calls` set and the actual call is equal to
 * it when comparing the 2 calls, then the call shall be considered matched and not added to the actual calls list. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_058: [ If getting `ignore_all_calls` by calling `umockcall_get_ignore_all_calls`
 * fails, `umockcallrecorder_add_actual_call` shall fail and return a non-zero value. ]*/
TEST_FUNCTION(
    if_expected_call_has_ignore_all_calls_and_umockcall_get_ignore_all_calls_fails_then_umockcallrecorder_get_actual_calls_fails)
{
    // arrange
    const char              *result;
    UMOCKCALLRECORDER_HANDLE call_recorder = umockcallrecorder_create();
...
/* Tests_SRS_UMOCKCALLRECORDER_01_022: [ umockcallrecorder_get_actual_calls shall return a pointer to the string
 * representation of all the actual calls. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_025: [ If umockcall_stringify fails, umockcallrecorder_get_actual_calls shall fail and
 * return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_024: [ If the umock_call_recorder is NULL, umockcallrecorder_get_actual_calls shall
...
/* Tests_SRS_UMOCKCALLRECORDER_01_026: [ If allocating memory for the resulting string fails,
 * umockcallrecorder_get_actual_calls shall fail and return NULL. ]*/
TEST_FUNCTION(
    when_allocating_memory_for_the_resulting_string_for_no_calls_fails_then_umockcallrecorder_get_actual_calls_fails)
{
    // arrange
    const char              *result;
    UMOCKCALLRECORDER_HANDLE call_recorder = umockcallrecorder_create();
...
/* Tests_SRS_UMOCKCALLRECORDER_01_027: [ umockcallrecorder_get_expected_calls shall return a pointer to the string
 * representation of all the expected calls. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_030: [ If umockcall_stringify fails, umockcallrecorder_get_expected_calls shall fail
 * and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_029: [ If the umock_call_recorder is NULL, umockcallrecorder_get_expected_calls shall
 * fail and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_031: [ If allocating memory for the resulting string fails,
 * umockcallrecorder_get_expected_calls shall fail and return NULL. ]*/
TEST_FUNCTION(
    when_allocating_memory_for_the_resulting_string__for_no_calls_fails_then_umockcallrecorder_get_expected_calls_fails)
{
    // arrange
    const char              *result;
    UMOCKCALLRECORDER_HANDLE call_recorder = umockcallrecorder_create();
...
/* Tests_SRS_UMOCKCALLRECORDER_01_054: [ Calls that have the `ignore_all_calls` property set shall not be reported in
 * the expected call list. ]*/
/* Tests_SRS_UMOCKCALLRECORDER_01_055: [ Getting the `ignore_all_calls` property shall be done by calling
 * `umockcall_get_ignore_all_calls`. ]*/
TEST_FUNCTION(
    umockcallrecorder_get_expected_calls_with_1_expectd_call_with_ignore_all_calls_set_returns_an_empty_string)
{
    // arrange
    const char              *result;
    UMOCKCALLRECORDER_HANDLE call_recorder     = umockcallrecorder_create();
...
/* Tests_SRS_UMOCKCALLRECORDER_01_056: [ If `umockcall_get_ignore_all_calls` returns a negative value then
 * `umockcallrecorder_get_expected_calls` shall fail and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_034: [ If no expected call has been recorded for umock_call_recorder then
...
/* Tests_SRS_UMOCKCALLRECORDER_01_033: [ If umock_call_recorder is NULL, umockcallrecorder_get_last_expected_call shall
 * fail and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_032: [ umockcallrecorder_get_last_expected_call shall return the last expected call
 * for the umock_call_recorder call recorder. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_035: [ umockcallrecorder_clone shall clone a call recorder and return a handle to the
...
/* Tests_SRS_UMOCKCALLRECORDER_01_036: [ If the umock_call_recorder argument is NULL, umockcallrecorder_clone shall fail
 * and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_037: [ If allocating memory for the new umock call recorder instance fails,
...
/* Tests_SRS_UMOCKCALLRECORDER_01_040: [ If cloning an expected call fails, umockcallrecorder_clone shall fail and
 * return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_052: [ If allocating memory for the expected calls fails, umockcallrecorder_clone
...
/* Tests_SRS_UMOCKCALLRECORDER_01_043: [ If cloning an actual call fails, umockcallrecorder_clone shall fail and return
 * NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_053: [ If allocating memory for the actual calls fails, umockcallrecorder_clone shall
 * fail and return NULL. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_044: [ umockcallrecorder_get_expected_call_count shall return in the
...
/* Tests_SRS_UMOCKCALLRECORDER_01_046: [ If any of the arguments is NULL, umockcallrecorder_get_expected_call_count
...
/* Tests_SRS_UMOCKCALLRECORDER_01_047: [ umockcallrecorder_fail_call shall mark an expected call as to be failed by
 * calling umockcall_set_fail_call with a 1 value for fail_call. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_049: [ If umock_call_recorder is NULL, umockcallrecorder_fail_call shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKCALLRECORDER_01_051: [ If umockcall_set_fail_call fails, umockcallrecorder_fail_call shall return a
 * non-zero value. ]*/
