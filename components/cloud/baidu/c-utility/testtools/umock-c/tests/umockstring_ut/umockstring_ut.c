...
/* Tests_UMOCK_STRING_01_001: [ `umockstring_clone` shall allocate memory for the cloned string (including the NULL
 * terminator). ]*/
/* Tests_UMOCK_STRING_01_002: [ `umockstring_clone` shall copy the string to the newly allocated memory (including the
 * NULL terminator). ]*/
/* Tests_UMOCK_STRING_01_003: [ On success `umockstring_clone` shall return a pointer to the newly allocated memory
 * containing the copy of the string. ]*/
