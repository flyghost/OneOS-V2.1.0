...
int umocktypes_register_type(const char              *type,
                             UMOCKTYPE_STRINGIFY_FUNC stringify_func,
                             UMOCKTYPE_ARE_EQUAL_FUNC are_equal_func,
                             UMOCKTYPE_COPY_FUNC      copy_func,
                             UMOCKTYPE_FREE_FUNC      free_func)
{
    ...
    umocktypes_register_type_CALL *new_calls = (umocktypes_register_type_CALL *)realloc(
        umocktypes_register_type_calls,
        sizeof(umocktypes_register_type_CALL)  *(umocktypes_register_type_call_count + 1));
    if (new_calls != NULL)
    {
        ...
        (void)memcpy(umocktypes_register_type_calls[umocktypes_register_type_call_count].type,
                     type,
                     typename_length + 1);
...
/* Tests_SRS_UMOCKTYPES_C_01_004: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_char_fails)
{
    ...
    // act
    result = umocktypes_stringify_char(&input);
 ...
 * ]*/
/* Tests_SRS_UMOCKTYPES_C_01_008: [ If the values pointed to by left and right are equal, umocktypes_are_equal_char
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_009: [ If the values pointed to by left and right are different, umocktypes_are_equal_char
 * shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_012: [ If source or destination are NULL, umocktypes_copy_char shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_016: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_unsignedchar_fails)
{
    ...
    // act
    result = umocktypes_stringify_unsignedchar(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_018: [ umocktypes_are_equal_unsignedchar shall compare the 2 unsigned chars pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_020: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_021: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_022: [ umocktypes_copy_unsignedchar shall copy the unsigned char value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_024: [ If source or destination are NULL, umocktypes_copy_unsignedchar shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_028: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_short_fails)
{
    ...
    // act
    result = umocktypes_stringify_short(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_030: [ umocktypes_are_equal_short shall compare the 2 shorts poshorted to by left and
 * right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_032: [ If the values poshorted to by left and right are equal, umocktypes_are_equal_short
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_033: [ If the values poshorted to by left and right are different,
 * umocktypes_are_equal_short shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_036: [ If source or destination are NULL, umocktypes_copy_short shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_040: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_unsignedshort_fails)
{
    ...
    // act
    result = umocktypes_stringify_unsignedshort(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_042: [ umocktypes_are_equal_unsignedshort shall compare the 2 unsigned shorts pounsigned
 * shorted to by left and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_044: [ If the values pounsigned shorted to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_045: [ If the values pounsigned shorted to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_046: [ umocktypes_copy_unsignedshort shall copy the unsigned short value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_048: [ If source or destination are NULL, umocktypes_copy_unsignedshort shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_052: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_int_fails)
{
    ...
    // act
    result = umocktypes_stringify_int(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_056: [ If the values pointed to by left and right are equal, umocktypes_are_equal_int shall
 * return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_057: [ If the values pointed to by left and right are different, umocktypes_are_equal_int
 * shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_060: [ If source or destination are NULL, umocktypes_copy_int shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_064: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_unsignedint_fails)
{
    ...
    // act
    result = umocktypes_stringify_unsignedint(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_066: [ umocktypes_are_equal_unsignedint shall compare the 2 unsigned ints pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_068: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_069: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_070: [ umocktypes_copy_unsignedint shall copy the unsigned int value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_072: [ If source or destination are NULL, umocktypes_copy_unsignedint shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_076: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_long_fails)
{
    ...
    // act
    result = umocktypes_stringify_long(&input);
 ...
 * ]*/
/* Tests_SRS_UMOCKTYPES_C_01_080: [ If the values pointed to by left and right are equal, umocktypes_are_equal_long
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_081: [ If the values pointed to by left and right are different, umocktypes_are_equal_long
 * shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_084: [ If source or destination are NULL, umocktypes_copy_long shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_088: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_unsignedlong_fails)
{
    ...
    // act
    result = umocktypes_stringify_unsignedlong(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_090: [ umocktypes_are_equal_unsignedlong shall compare the 2 unsigned longs pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_092: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_093: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_094: [ umocktypes_copy_unsignedlong shall copy the unsigned long value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_096: [ If source or destination are NULL, umocktypes_copy_unsignedlong shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_100: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_longlong_fails)
{
    ...
    // act
    result = umocktypes_stringify_longlong(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_102: [ umocktypes_are_equal_longlong shall compare the 2 long longs pointed to by left and
 * right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_104: [ If the values pointed to by left and right are equal, umocktypes_are_equal_longlong
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_105: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_108: [ If source or destination are NULL, umocktypes_copy_longlong shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_110: [ umocktypes_stringify_unsignedlonglong shall return the string representation of
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_112: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_unsignedlonglong_fails)
{
    ...
    // act
    result = umocktypes_stringify_unsignedlonglong(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_114: [ umocktypes_are_equal_unsignedlonglong shall compare the 2 unsigned long longs
 * pointed to by left and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_116: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_117: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_115: [ If any of the arguments is NULL, umocktypes_are_equal_unsignedlonglong shall return
 * -1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_118: [ umocktypes_copy_unsignedlonglong shall copy the unsigned long long value from source
 * to destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_120: [ If source or destination are NULL, umocktypes_copy_unsignedlonglong shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_124: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_float_fails)
{
    ...
    // act
    result = umocktypes_stringify_float(&input);
 ...
 * ]*/
/* Tests_SRS_UMOCKTYPES_C_01_128: [ If the values pointed to by left and right are equal, umocktypes_are_equal_float
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_129: [ If the values pointed to by left and right are different, umocktypes_are_equal_float
 * shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_132: [ If source or destination are NULL, umocktypes_copy_float shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_136: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_double_fails)
{
    ...
    // act
    result = umocktypes_stringify_double(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_138: [ umocktypes_are_equal_double shall compare the 2 doubles pointed to by left and
 * right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_140: [ If the values pointed to by left and right are equal, umocktypes_are_equal_double
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_141: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_144: [ If source or destination are NULL, umocktypes_copy_double shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_148: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_longdouble_fails)
{
    ...
    // act
    result = umocktypes_stringify_longdouble(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_150: [ umocktypes_are_equal_longdouble shall compare the 2 long doubles pointed to by left
 * and right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_152: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_C_01_153: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_154: [ umocktypes_copy_longdouble shall copy the long double value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_156: [ If source or destination are NULL, umocktypes_copy_longdouble shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_160: [ If allocating a new string to hold the string representation fails,
...
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_size_t_fails)
{
    ...
    // act
    result = umocktypes_stringify_size_t(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_162: [ umocktypes_are_equal_size_t shall compare the 2 size_ts pointed to by left and
 * right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_164: [ If the values pointed to by left and right are equal, umocktypes_are_equal_size_t
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_165: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_C_01_168: [ If source or destination are NULL, umocktypes_copy_size_t shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_172: [ If allocating a new string to hold the string representation fails,
 * umocktypes_stringify_void_ptr shall return NULL. ]*/
TEST_FUNCTION(when_allocating_memory_fails_umocktypes_stringify_void_ptr_fails)
{
    ...
    // act
    result = umocktypes_stringify_void_ptr(&input);
...
/* Tests_SRS_UMOCKTYPES_C_01_174: [ umocktypes_are_equal_void_ptr shall compare the 2 void_ptrs pointed to by left and
 * right. ]*/
/* Tests_SRS_UMOCKTYPES_C_01_176: [ If the values pointed to by left and right are equal, umocktypes_are_equal_void_ptr
 * shall return 1. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_177: [ If the values pointed to by left and right are different,
 * umocktypes_are_equal_void_ptr shall return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_180: [ If source or destination are NULL, umocktypes_copy_void_ptr shall return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_C_01_171: [ If registering any of the types fails, umocktypes_c_register_types shall fail and
