...
/* Tests_SRS_UMOCKTYPES_STDINT_01_001: [ umocktypes_stdint_register_types shall register support for all the types in
 * the module. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_003: [ If registering any of the types fails, umocktypes_stdint_register_types shall
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_006: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_008: [ umocktypes_are_equal_uint8_t shall compare the 2 uint8_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_010: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_011: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_012: [ umocktypes_copy_uint8_t shall copy the uint8_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_014: [ If source or destination are NULL, umocktypes_copy_uint8_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_018: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_020: [ umocktypes_are_equal_int8_t shall compare the 2 int8_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_022: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_023: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_026: [ If source or destination are NULL, umocktypes_copy_int8_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_030: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_032: [ umocktypes_are_equal_uint16_t shall compare the 2 uint16_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_034: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_035: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_036: [ umocktypes_copy_uint16_t shall copy the uint16_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_038: [ If source or destination are NULL, umocktypes_copy_uint16_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_042: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_044: [ umocktypes_are_equal_int16_t shall compare the 2 int16_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_046: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_047: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_048: [ umocktypes_copy_int16_t shall copy the int16_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_050: [ If source or destination are NULL, umocktypes_copy_int16_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_054: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_056: [ umocktypes_are_equal_uint32_t shall compare the 2 uint32_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_058: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_059: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_060: [ umocktypes_copy_uint32_t shall copy the uint32_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_062: [ If source or destination are NULL, umocktypes_copy_uint32_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_066: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_068: [ umocktypes_are_equal_int32_t shall compare the 2 int32_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_070: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_071: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_072: [ umocktypes_copy_int32_t shall copy the int32_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_074: [ If source or destination are NULL, umocktypes_copy_int32_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_078: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_080: [ umocktypes_are_equal_uint64_t shall compare the 2 uint64_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_082: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_083: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_084: [ umocktypes_copy_uint64_t shall copy the uint64_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_086: [ If source or destination are NULL, umocktypes_copy_uint64_t shall return a
 * non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_090: [ If allocating a new string to hold the string representation fails,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_092: [ umocktypes_are_equal_int64_t shall compare the 2 int64_t values pointed to by
 * left and right. ]*/
/* Tests_SRS_UMOCKTYPES_STDINT_01_094: [ If the values pointed to by left and right are equal,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_095: [ If the values pointed to by left and right are different,
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_096: [ umocktypes_copy_int64_t shall copy the int64_t value from source to
 * destination. ]*/
...
/* Tests_SRS_UMOCKTYPES_STDINT_01_098: [ If source or destination are NULL, umocktypes_copy_int64_t shall return a
 * non-zero value. ]*/
