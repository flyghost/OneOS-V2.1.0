...
char *umocktypename_normalize(const char *type_name)
{
    ...
    umocktypename_normalize_CALL *new_calls = (umocktypename_normalize_CALL *)realloc(
        umocktypename_normalize_calls,
        sizeof(umocktypename_normalize_CALL)  *(umocktypename_normalize_call_count + 1));
    if (new_calls != NULL)
    {
        size_t type_name_length       = strlen(type_name);
        umocktypename_normalize_calls = new_calls;
        umocktypename_normalize_calls[umocktypename_normalize_call_count].type_name =
            (char *)malloc(type_name_length + 1);
        (void)memcpy(umocktypename_normalize_calls[umocktypename_normalize_call_count].type_name,
                     type_name,
                     type_name_length + 1);
    ...
    if (umocktypename_normalize_call_result[umocktypename_normalize_call_count - 1] != NULL)
    {
        ...
        (void)memcpy(result,
                     umocktypename_normalize_call_result[umocktypename_normalize_call_count - 1],
                     result_length + 1);
    }
    else
    {
...
{
    char                              *result;
    test_stringify_func_testtype_CALL *new_calls = (test_stringify_func_testtype_CALL *)realloc(
        test_stringify_func_testtype_calls,
        sizeof(test_stringify_func_testtype_CALL)  *(test_stringify_func_testtype_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_copy_func_testtype_CALL *new_calls = (test_copy_func_testtype_CALL *)realloc(
        test_copy_func_testtype_calls,
        sizeof(test_copy_func_testtype_CALL)  *(test_copy_func_testtype_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_free_func_testtype_CALL *new_calls = (test_free_func_testtype_CALL *)realloc(
        test_free_func_testtype_calls,
        sizeof(test_free_func_testtype_CALL)  *(test_free_func_testtype_call_count + 1));
    if (new_calls != NULL)
    {
...
{
    test_are_equal_func_testtype_CALL *new_calls = (test_are_equal_func_testtype_CALL *)realloc(
        test_are_equal_func_testtype_calls,
        sizeof(test_are_equal_func_testtype_CALL)  *(test_are_equal_func_testtype_call_count + 1));
    if (new_calls != NULL)
    {
...
TEST_FUNCTION(after_umocktypes_init_no_type_shall_be_registered)
{
    ...
    (void)umocktypes_register_type("testtype",
                                   test_stringify_func_testtype,
                                   test_are_equal_func_testtype,
                                   test_copy_func_testtype,
                                   test_free_func_testtype);
    umocktypes_deinit();
    (void)umocktypes_init();

    // act
    result = umocktypes_are_equal("testtype", test_value_1, test_value_2);

    // assert
    ASSERT_ARE_EQUAL(int, -1, result);
}

/* Tests_SRS_UMOCKTYPES_01_004: [ umocktypes_init after another umocktypes_init without deinitializing the module shall
...
/* Tests_SRS_UMOCKTYPES_01_005: [ umocktypes_deinit shall free all resources associated with the registered types and
 * shall leave the module in a state where another init is possible. ]*/
TEST_FUNCTION(umocktypes_deinit_after_umocktypes_init_deinitializes_the_module)
{
    // arrange
    (void)umocktypes_init();
    (void)umocktypes_register_type("testtype1",
                                   test_stringify_func_testtype,
                                   test_are_equal_func_testtype,
                                   test_copy_func_testtype,
                                   test_free_func_testtype);
    (void)umocktypes_register_type("testtype2",
                                   test_stringify_func_testtype,
                                   test_are_equal_func_testtype,
                                   test_copy_func_testtype,
                                   test_free_func_testtype);
...
/* Tests_SRS_UMOCKTYPES_01_040: [ An umocktypes_init call after deinit shall succeed provided all underlying calls
 * succeed. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_007: [ umocktypes_register_type shall register an interface made out of the stringify, are
 * equal, copy and free functions for the type identified by the argument type. ] */
...
TEST_FUNCTION(umocktypes_register_type_when_module_is_initialized_succeeds)
{
    ...
    // act
    result = umocktypes_register_type("testtype",
                                      test_stringify_func_testtype,
                                      test_are_equal_func_testtype,
                                      test_copy_func_testtype,
                                      test_free_func_testtype);
...
/* Tests_SRS_UMOCKTYPES_01_009: [ If any of the arguments is NULL, umocktypes_register_type shall fail and return a
 * non-zero value. ]*/
TEST_FUNCTION(umocktypes_register_type_with_NULL_type_fails)
{
    ...
    // act
    result = umocktypes_register_type(NULL,
                                      test_stringify_func_testtype,
                                      test_are_equal_func_testtype,
                                      test_copy_func_testtype,
                                      test_free_func_testtype);
...
/* Tests_SRS_UMOCKTYPES_01_010: [ If the type has already been registered with the same function pointers then
 * umocktypes_register_type shall succeed and return 0. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_011: [ If the type has already been registered but at least one of the function pointers is
 * different, umocktypes_register_type shall fail and return a non-zero value. ]*/
TEST_FUNCTION(umocktypes_register_type_2_times_on_the_same_type_with_different_stringify_function_fails)
{
    ...
    // act
    result = umocktypes_register_type("testtype",
                                      test_stringify_func_testtype_2,
                                      test_are_equal_func_testtype,
                                      test_copy_func_testtype,
                                      test_free_func_testtype);
...
TEST_FUNCTION(umocktypes_register_type_2_times_on_the_same_type_with_different_are_equal_function_fails)
{
    ...
    result = umocktypes_register_type("testtype",
                                      test_stringify_func_testtype,
                                      test_are_equal_func_testtype_2,
                                      test_copy_func_testtype,
                                      test_free_func_testtype);
...
/* Tests_SRS_UMOCKTYPES_01_045: [ If normalizing the typename fails, umocktypes_register_type shall fail and return a
 * non-zero value. ] */
TEST_FUNCTION(when_normalizing_the_type_fails_umocktypes_register_type_fails)
{
    ...
    // act
    result = umocktypes_register_type("char  *",
                                      test_stringify_func_testtype,
                                      test_are_equal_func_testtype,
                                      test_copy_func_testtype,
                                      test_free_func_testtype);
...
/* Tests_SRS_UMOCKTYPES_01_050: [ If umocktypes_register_type is called when the module is not initialized,
 * umocktypes_register_type shall fail and return a non zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_012: [ If an error occurs allocating memory for the newly registered type,
 * umocktypes_register_type shall fail and return a non-zero value. ]*/
...
TEST_FUNCTION(umocktypes_register_alias_type_registers_an_alias_type)
{
    ...
    // act
    result = umocktypes_register_alias_type("PSTR", "char*");
...
TEST_FUNCTION(when_type_is_NULL_umocktypes_register_alias_type_fails)
{
    ...
    // act
    result = umocktypes_register_alias_type(NULL, "char*");
...
TEST_FUNCTION(when_is_type_is_NULL_umocktypes_register_alias_type_fails)
{
    ...
    // act
    result = umocktypes_register_alias_type("PSTR", NULL);

    // assert
    ASSERT_ARE_NOT_EQUAL(int, 0, result);
}

/* Tests_SRS_UMOCKTYPES_01_057: [ If is_type was not already registered, umocktypes_register_alias_type shall fail and
...
/* Tests_SRS_UMOCKTYPES_01_060: [ If umocktypename_normalize fails, umocktypes_register_alias_type shall fail and return
 * a non-zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_061: [ If umocktypes_register_alias_type is called when the module is not initialized,
 * umocktypes_register_type shall fail and return a non zero value. ] */
...
/* Tests_SRS_UMOCKTYPES_01_013: [ umocktypes_stringify shall return a char\* with the string representation of the value
 * argument. ]*/
/* Tests_SRS_UMOCKTYPES_01_014: [ The string representation shall be obtained by calling the stringify function
 * registered for the type identified by the argument type. ]*/
/* Tests_SRS_UMOCKTYPES_01_015: [ On success umocktypes_stringify shall return the char\* produced by the underlying
 * stringify function for type (passed in umocktypes_register_type). ]*/
/* Tests_SRS_UMOCKTYPES_01_035: [ Before looking it up, the type string shall be normalized by calling
...
TEST_FUNCTION(umocktypes_stringify_calls_the_underlying_stringify)
{
    ...
    (void)umocktypes_register_type("char *",
                                   test_stringify_func_testtype,
                                   test_are_equal_func_testtype,
                                   test_copy_func_testtype,
                                   test_free_func_testtype);
    ...
    ASSERT_ARE_EQUAL(size_t, 1, umocktypename_normalize_call_count);
    ASSERT_ARE_EQUAL(char_ptr, "char *", umocktypename_normalize_calls[0].type_name);
    ASSERT_ARE_EQUAL(size_t, 1, test_stringify_func_testtype_call_count);
...
TEST_FUNCTION(umocktypes_stringify_with_NULL_value_fails)
{
    ...
    // act
    result = umocktypes_stringify("char *", NULL);
...
TEST_FUNCTION(umocktypes_stringify_with_NULL_type_fails)
{
    ...
    // act
    result = umocktypes_stringify(NULL, test_value_1);

    // assert
    ASSERT_IS_NULL(result);
}

/* Tests_SRS_UMOCKTYPES_01_017: [ If type can not be found in the registered types list maintained by the module,
 * umocktypes_stringify shall fail and return NULL. ]*/
TEST_FUNCTION(umocktypes_stringify_with_a_type_that_is_not_registered_fails)
{
    ...
    // act
    result = umocktypes_stringify("const char  *", test_value_1);
...
/* Tests_SRS_UMOCKTYPES_01_049: [ If umocktypes_stringify is called when the module is not initialized,
 * umocktypes_stringify shall return NULL. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_063: [ If type is a pointer type and type was not registered then umocktypes_stringify shall
 * execute as if type is void*. ]*/
TEST_FUNCTION(umocktypes_stringify_with_an_unregistered_pointer_type_defaults_to_void_ptr)
{
    ...
    (void)umocktypes_register_type("void*",
                                   test_stringify_func_testtype,
                                   test_are_equal_func_testtype,
                                   test_copy_func_testtype,
                                   test_free_func_testtype);
...
TEST_FUNCTION(umocktypes_stringify_with_an_unregistered_non_pointer_type_fails)
{
    ...
    ASSERT_ARE_EQUAL(size_t, 1, umocktypename_normalize_call_count);
    ASSERT_ARE_EQUAL(char_ptr, "char", umocktypename_normalize_calls[0].type_name);
    ASSERT_ARE_EQUAL(size_t, 0, test_stringify_func_testtype_call_count);
}

/* umocktypes_are_equal */

/* Tests_SRS_UMOCKTYPES_01_018: [ umocktypes_are_equal shall evaluate whether 2 values are equal. ]*/
/* Tests_SRS_UMOCKTYPES_01_019: [ umocktypes_are_equal shall call the underlying are_equal function for the type
 * identified by the argument type (passed in umocktypes_register_type). ] */
/* Tests_SRS_UMOCKTYPES_01_021: [ If the underlying are_equal function indicates the types are equal,
 * umocktypes_are_equal shall return 1. ]*/
/* Tests_SRS_UMOCKTYPES_01_036: [ Before looking it up, the type string shall be normalized by calling
 * umocktypename_normalize. ]*/
TEST_FUNCTION(umocktypes_are_equal_with_2_equal_values_returns_1)
{
    ...
    ASSERT_ARE_EQUAL(size_t, 1, umocktypename_normalize_call_count);
    ASSERT_ARE_EQUAL(char_ptr, "char *", umocktypename_normalize_calls[0].type_name);
    ASSERT_ARE_EQUAL(size_t, 1, test_are_equal_func_testtype_call_count);
...
/* Tests_SRS_UMOCKTYPES_01_019: [ umocktypes_are_equal shall call the underlying are_equal function for the type
 * identified by the argument type (passed in umocktypes_register_type). ] */
/* Tests_SRS_UMOCKTYPES_01_022: [ If the underlying are_equal function indicates the types are not equal,
 * umocktypes_are_equal shall return 0. ]*/
...
TEST_FUNCTION(umocktypes_are_equal_with_NULL_type_fails)
{
    ...
    // act
    result = umocktypes_are_equal(NULL, test_value_1, test_value_2);
...
TEST_FUNCTION(umocktypes_are_equal_with_NULL_left_argument_fails)
{
    ...
    // act
    result = umocktypes_are_equal("char *", NULL, test_value_2);
...
TEST_FUNCTION(umocktypes_are_equal_with_NULL_right_argument_fails)
{
    ...
    // act
    result = umocktypes_are_equal("char *", test_value_1, NULL);
...
/* Tests_SRS_UMOCKTYPES_01_024: [ If type can not be found in the registered types list maintained by the module,
 * umocktypes_are_equal shall fail and return -1. ]*/
TEST_FUNCTION(umocktypes_are_equal_with_a_not_registered_type_fails)
{
    ...
    // act
    result = umocktypes_are_equal("const char *", test_value_1, test_value_2);
...
/* Tests_SRS_UMOCKTYPES_01_046: [ If umocktypes_are_equal is called when the module is not initialized,
 * umocktypes_are_equal shall return -1. ] */
...
/* Tests_SRS_UMOCKTYPES_01_020: [ If the underlying are_equal function fails,, umocktypes_are_equal shall fail and
 * return -1. ] */
...
/* Tests_SRS_UMOCKTYPES_01_051: [ If the pointer values for left and right are equal, umocktypes_are_equal shall return
 * 1 without calling the underlying are_equal function. ]*/
TEST_FUNCTION(umocktypes_are_equal_with_2_equal_pointers_returns_1)
{
    ...
    // act
    result = umocktypes_are_equal("char *", test_value_1, test_value_1);
...
/* Tests_SRS_UMOCKTYPES_01_064: [ If type is a pointer type and type was not registered then umocktypes_are_equal shall
 * execute as if type is void*. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_026: [ The copy shall be done by calling the underlying copy function (passed in
 * umocktypes_register_type) for the type identified by the type argument. ]*/
/* Tests_SRS_UMOCKTYPES_01_052: [ On success, umocktypes_copy shall return 0. ]*/
/* Tests_SRS_UMOCKTYPES_01_037: [ Before looking it up, the type string shall be normalized by calling
 * umocktypename_normalize. ]*/
TEST_FUNCTION(umocktypes_copy_calls_the_underlying_copy_function)
{
    ...
    // act
    result = umocktypes_copy("char *", destination, test_value_1);

    // assert
    ASSERT_ARE_EQUAL(int, 0, result);
    ASSERT_ARE_EQUAL(size_t, 1, umocktypename_normalize_call_count);
    ASSERT_ARE_EQUAL(char_ptr, "char *", umocktypename_normalize_calls[0].type_name);
    ASSERT_ARE_EQUAL(size_t, 1, test_copy_func_testtype_call_count);
...
TEST_FUNCTION(umocktypes_copy_with_NULL_type_fails)
{
    ...
    // act
    result = umocktypes_copy(NULL, destination, test_value_1);
...
TEST_FUNCTION(umocktypes_copy_with_NULL_destination_fails)
{
    ...
    // act
    result = umocktypes_copy("char *", NULL, test_value_1);
...
TEST_FUNCTION(umocktypes_copy_with_NULL_source_fails)
{
    ...
    // act
    result = umocktypes_copy("char *", destination, NULL);
...
/* Tests_SRS_UMOCKTYPES_01_029: [ If type can not be found in the registered types list maintained by the module,
 * umocktypes_copy shall fail and return -1. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_042: [ If normalizing the typename fails, umocktypes_copy shall fail and return a non-zero
 * value. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_047: [ If umocktypes_copy is called when the module is not initialized, umocktypes_copy shall
 * fail and return a non zero value. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_065: [ If type is a pointer type and type was not registered then umocktypes_copy shall
 * execute as if type is void*. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_033: [ The free shall be done by calling the underlying free function (passed in
 * umocktypes_register_type) for the type identified by the type argument. ]*/
/* Tests_SRS_UMOCKTYPES_01_038: [ Before looking it up, the type string shall be normalized by calling
 * umocktypename_normalize. ]*/
TEST_FUNCTION(umocktypes_free_calls_the_underlying_free_function)
{
    ...
    ASSERT_ARE_EQUAL(size_t, 1, umocktypename_normalize_call_count);
    ASSERT_ARE_EQUAL(char_ptr, "char *", umocktypename_normalize_calls[0].type_name);
    ASSERT_ARE_EQUAL(size_t, 1, test_free_func_testtype_call_count);
...
/* Tests_SRS_UMOCKTYPES_01_032: [ If type can not be found in the registered types list maintained by the module,
 * umocktypes_free shall do nothing. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_048: [ If umocktypes_free is called when the module is not initialized, umocktypes_free shall
 * do nothing. ]*/
...
/* Tests_SRS_UMOCKTYPES_01_066: [ If type is a pointer type and type was not registered then umocktypes_free shall
 * execute as if type is void*. ]*/
