...
int iotcore_construct_connect_mqtt_param(const IOTCORE_INFO *info, IOTCORE_CONNECT_MQTT_PARAM *mqtt_param)
{
    ...
    do
    {
        ...
        time_t       now_time           = 0;
        unsigned int _user_name_len_max = strlen(s_adp_type)             // adp_type len
                                          + 1                            // @
        ...
        int _passwd_plain_data_len_max = strlen(info->device_key)         // device_key len
                                         + 1                              // &
                                         + 10                             // unixtime len
                                         + 1                              // &
                                         + strlen(s_algorithm_type)       // algorithm_type len
