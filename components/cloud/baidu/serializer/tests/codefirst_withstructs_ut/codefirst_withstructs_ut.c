...
/*Tests_SRS_SERIALIZER_99_016:[ The second macro, DECLARE_STRUCT shall introduce a new struct  type having the fields
 * field1name of type field1Type, field2name having the type field2type etc.]*/
DECLARE_STRUCT(GeoLocation, double, Lat, double, Long);
...
DECLARE_STRUCT(CarLocation,
               int,
               Alt,
               /*Tests_SRS_SERIALIZER_99_017:[ These types can either be one of the types mentioned in WITH_DATA or it
                  can be a type introduced by a previous DECLARE_STRUCT.]*/
               GeoLocation,
               whereIsMyCar);
...
DECLARE_MODEL(TruckType,
              ...
              /*a more complex action that takes as parameter 1xsimple type, 1x complex type (that has another complex
                 type embedded) and another simple type*/
...
DECLARE_STRUCT(FamilyAccount, int16_t, FatherMoney, int8_t, MotherMoney);

DECLARE_STRUCT(MoneyInTheWorld, FamilyAccount, moneyInCanada, FamilyAccount, moneyInRomania, FamilyAccount, moneyInUSA);
...
static DEVICE_HANDLE serializer_getdevicehandle(void)
{
    return TEST_DEVICE_HANDLE;
}
...
/*Tests_SRS_CODEFIRST_99_002:[ CodeFirst_Init shall initialize the CodeFirst module. If initialization is successful, it
...
/*Tests_SRS_SERIALIZER_99_042:[ The parameter types are either predefined parameter types (specs
 * SRS_SERIALIZER_99_004-SRS_SERIALIZER_99_014) or a type introduced by DECLARE_STRUCT.]*/
TEST_FUNCTION(InvokeAction_goToLocation_succeeds)
{
    /// arrange
    void *device = CodeFirst_CreateDevice(TEST_MODEL_HANDLE,
                                          &DummyDataProvider_WithStructs_allReflected,
                                          sizeof(TruckType),
                                          false);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(InvokeAction_alwaysRejected_return_EXECUTE_COMMAND_FAILED)
{
    ...
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "alwaysReject", 0, NULL);
...
TEST_FUNCTION(InvokeAction_alwaysAbandon_return_EXECUTE_COMMAND_ERROR)
{
    ...
    /// act
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "alwaysAbandon", 0, NULL);
...
TEST_FUNCTION(InvokeAction_goToLocation_with_a_non_struct_fails)
{
    ...
    /// act
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "goToLocation", 1, &Lat);
...
TEST_FUNCTION(InvokeAction_moveCarTo_succeeds)
{
    ...
    /// act
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "moveCarTo", 3, parameters);
...
TEST_FUNCTION(InvokeAction_moveCarTo_with_wrong_number_of_parameters_fails_1)
{
    ...
    /// act
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "moveCarTo", 2, parameters);
...
TEST_FUNCTION(InvokeAction_moveCarTo_with_wrong_number_of_parameters_fails_2)
{
    ...
    /// act
    EXECUTE_COMMAND_RESULT result =
        CodeFirst_InvokeAction(TEST_DEVICE_HANDLE, g_InvokeActionCallbackArgument, "", "moveCarTo", 4, parameters);
