...
static MULTITREE_HANDLE my_MultiTree_Create(MULTITREE_CLONE_FUNCTION cloneFunction,
...
/* Tests_SRS_DATA_MARSHALLER_99_018:[ DataMarshaller_Create shall create a new DataMarshaller instance and on success it
 * shall return a non NULL handle.]*/
/* Tests_SRS_DATA_MARSHALLER_99_051:[DataMarshaller_Create shall initialize a BufferProcess instance and associate it
 * with the newly created DataMarshaller instance.] */
...
/*Tests_SRS_DATA_MARSHALLER_99_022:[ DataMarshaller_Destroy shall free all resources associated with the
 * dataMarshallerHandle argument.]*/
...
/*Tests_SRS_DATA_MARSHALLER_99_007:[ DATA_MARSHALLER_INVALID_MODEL_PROPERTY shall be returned when any of the items in
...
TEST_FUNCTION(DataMarshaller_SendData_with_Second_PropertyName_NULL_fails)
{
    ...
    DATA_MARSHALLER_VALUE values[] = {{DEFAULT_PROPERTY_NAME, &floatValid}, {NULL, &floatValid}};

    /// act
    DATA_MARSHALLER_RESULT result =
        DataMarshaller_SendData(handle, sizeof(values) / sizeof(values[0]), values, &destination, &destinationSize);
...
TEST_FUNCTION(DataMarshaller_SendData_with_Second_Value_NULL_In_The_DATA_MARSHALLER_VALUE_fails)
{
    ...
    DATA_MARSHALLER_VALUE values[] = {{DEFAULT_PROPERTY_NAME, &floatValid}, {DEFAULT_PROPERTY_NAME_2, NULL}};
...
/*Tests_SRS_DATA_MARSHALLER_99_004:[ DATA_MARSHALLER_INVALID_ARG shall be returned when the function has detected an
 * invalid parameter (NULL) being passed to the function.]*/
/*Tests_SRS_DATA_MARSHALLER_99_034:[All argument checks shall be performed before calling any other modules.]*/
...
/* Tests_SRS_DATA_MARSHALLER_99_035:[DATA_MARSHALLER_MULTITREE_ERROR shall be returned in case any MultiTree API call
 * fails.] */
TEST_FUNCTION(DataMarshaller_SendData_When_MultiTree_Create_Fails_Then_Fails)
{
    ...
    EXPECTED_CALL(MultiTree_Create(IGNORED_PTR_ARG, IGNORED_PTR_ARG)).SetReturn((MULTITREE_HANDLE)NULL);
...
/* Tests_SRS_DATA_MARSHALLER_99_027:[ DATA_MARSHALLER_JSON_ENCODER_ERROR shall be returned when JSONEncoder returns an
 * error code.] */
...
/* Tests_SRS_DATAMARSHALLER_01_002: [If the includePropertyPath argument passed to DataMarshaller_Create was false and
 * the number of values passed to SendData is greater than 1 and at least one of them is a struct,
 * DataMarshaller_SendData shall fallback to  including the complete property path in the output JSON.] */
/*Tests_SRS_DATAMARSHALLER_02_007: [DataMarshaller_SendData shall copy in the output parameters *destination,
 * *destinationSize the content and the content length of the encoded JSON tree.] */
TEST_FUNCTION(
    when_includepropertypath_is_false_and_value_count_is_greater_than_1_and_one_of_them_is_a_struct_the_property_path_is_included)
{
    /// arrange
    ...
    EXPECTED_CALL(STRING_length(IGNORED_PTR_ARG)).SetReturn(strlen(json_payload));

    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG)).IgnoreArgument_size();

    EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)).SetReturn(json_payload);
...
/*Tests_SRS_DATAMARSHALLER_02_006: [The complete JSON object shall be handed over to IoTHubClient by a call to
 * IoTHubClient_LL_SendEventAsync if parameter transportType of _Create was TRANSPORT_LL.] */
 ...
 * DataMarshaller_SendData shall fallback to  including the complete property path in the output JSON.] */
TEST_FUNCTION(
    when_includepropertypath_is_false_and_value_count_is_greater_than_1_and_one_but_no_structs_SendData_succeeds)
{
    /// arrange
    DATA_MARSHALLER_HANDLE handle = DataMarshaller_Create(TEST_MODEL_HANDLE, false);
    unsigned char         *destination;
...
/* Tests_SRS_DATA_MARSHALLER_99_039:[ If the includePropertyPath argument passed to DataMarshaller_Create was true each
 * property shall be placed in the appropriate position in the JSON according to its path in the model.] */
...
/* Tests_SRS_DATAMARSHALLER_01_001: [If the includePropertyPath argument passed to DataMarshaller_Create was false and
 * only one struct is being sent, the relative path of the value passed to DataMarshaller_SendData - including property
 * name - shall be ignored and the value shall be placed at JSON root.] */
/* Tests_SRS_DATAMARSHALLER_01_004: [In this case the members of the struct shall be added as leafs into the MultiTree,
 * each leaf having the name of the struct member.] */
TEST_FUNCTION(
    when_includePropertyPath_is_false_and_one_struct_is_being_sent_the_property_name_is_not_placed_in_the_JSON_and_SendAsync_is_called)
{
    /// arrange
    DATA_MARSHALLER_HANDLE handle = DataMarshaller_Create(TEST_MODEL_HANDLE, false);
    unsigned char         *destination;
    ...
    STRICT_EXPECTED_CALL(
        MultiTree_AddLeaf(IGNORED_PTR_ARG, "x", structTypeValue2Members.value.edmComplexType.fields[0].value))
        .IgnoreArgument_treeHandle();
    STRICT_EXPECTED_CALL(
        MultiTree_AddLeaf(IGNORED_PTR_ARG, "y", structTypeValue2Members.value.edmComplexType.fields[1].value))
        .IgnoreArgument_treeHandle();
    EXPECTED_CALL(STRING_new());
    EXPECTED_CALL(JSONEncoder_EncodeTree(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_treeHandle()
...
/* Tests_SRS_DATAMARSHALLER_01_003: [DATA_MARSHALLER_ERROR shall be returned for any errors when calling IoTHubMessage
 * APIs.] */
TEST_FUNCTION(when_STRING_new_fails_SendData_Fails)
{
    ...
    STRICT_EXPECTED_CALL(MultiTree_AddLeaf(IGNORED_PTR_ARG, DEFAULT_PROPERTY_NAME, &floatValid))
        .IgnoreArgument_treeHandle();
    EXPECTED_CALL(STRING_new()).SetReturn(NULL);
    STRICT_EXPECTED_CALL(MultiTree_Destroy(IGNORED_PTR_ARG)).IgnoreArgument_treeHandle();
...
/*Tests_SRS_DATA_MARSHALLER_02_021: [ If argument dataMarshallerHandle is NULL then
 * DataMarshaller_SendData_ReportedProperties shall fail and return DATA_MARSHALLER_INVALID_ARG. ]*/
TEST_FUNCTION(DataMarshaller_SendData_ReportedProperties_with_NULL_dataMarshallerHandle_fails)
{
    ...
    DATA_MARSHALLER_RESULT result =
        DataMarshaller_SendData_ReportedProperties(NULL, values, &destination, &destinationSize);
...
/*Tests_SRS_DATA_MARSHALLER_02_008: [ If argument values is NULL then DataMarshaller_SendData_ReportedProperties shall
 * fail and return DATA_MARSHALLER_INVALID_ARG. ]*/
TEST_FUNCTION(DataMarshaller_SendData_ReportedProperties_with_NULL_values_fails)
{
    ...
    DATA_MARSHALLER_RESULT result =
        DataMarshaller_SendData_ReportedProperties(handle, NULL, &destination, &destinationSize);
...
/*Tests_SRS_DATA_MARSHALLER_02_009: [ If argument destination NULL then DataMarshaller_SendData_ReportedProperties shall
 * fail and return DATA_MARSHALLER_INVALID_ARG. ]*/
...
/*Tests_SRS_DATA_MARSHALLER_02_010: [ If argument destinationSize NULL then DataMarshaller_SendData_ReportedProperties
 * shall fail and return DATA_MARSHALLER_INVALID_ARG. ]*/
...
void DataMarshaller_SendData_ReportedProperties_inert_path(void)
{
    ...
    STRICT_EXPECTED_CALL(json_object(IGNORED_PTR_ARG)).IgnoreArgument_value();

    STRICT_EXPECTED_CALL(VECTOR_size(IGNORED_PTR_ARG)).IgnoreArgument_handle();
    size_t i;
    for (i = 0; i < 1; i++) /*these is property indexer*/
    {
        STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, i)).IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(STRING_new());
        STRICT_EXPECTED_CALL(AgentDataTypes_ToString(IGNORED_PTR_ARG, &floatValid)).IgnoreArgument_destination();
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)).IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(json_parse_string(IGNORED_PTR_ARG)).IgnoreArgument_string();
        STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, DEFAULT_PROPERTY_NAME)).IgnoreArgument_destination();

        STRICT_EXPECTED_CALL(
            json_object_dotset_value(IGNORED_PTR_ARG, DEFAULT_PROPERTY_NAME_SLASHES_REPLACED_BY_DOTS, IGNORED_PTR_ARG))
    ...
    STRICT_EXPECTED_CALL(json_serialize_to_string_pretty(IGNORED_PTR_ARG)).IgnoreArgument_value();

    STRICT_EXPECTED_CALL(json_value_free(IGNORED_PTR_ARG)).IgnoreArgument_value();
}

/*Tests_SRS_DATA_MARSHALLER_02_011: [ DataMarshaller_SendData_ReportedProperties shall ignore the value of
 * includePropertyPath and shall consider it to be true. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_012: [ DataMarshaller_SendData_ReportedProperties shall create an empty JSON_Value. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_013: [ DataMarshaller_SendData_ReportedProperties shall get the object behind the
 * JSON_Value by calling json_object. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_014: [ For every reported property, DataMarshaller_SendData_ReportedProperties shall get
 * the reported property's JSON value (as string) by calling AgentDataTypes_ToString. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_015: [ DataMarshaller_SendData_ReportedProperties shall import the JSON value (as string)
 * by calling json_parse_string. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_016: [ DataMarshaller_SendData_ReportedProperties shall replace all the occurences of /
 * with . in the reported property paths. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_017: [ DataMarshaller_SendData_ReportedProperties shall use json_object_dotset_value
 * passing the reported property path and the imported json value. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_018: [ DataMarshaller_SendData_ReportedProperties shall use
 * json_serialize_to_string_pretty to produce the output JSON string that fills out parameters destination and
 * destionationSize. ]*/
/*Tests_SRS_DATA_MARSHALLER_02_020: [ Otherwise DataMarshaller_SendData_ReportedProperties shall succeed and return
 * DATA_MARSHALLER_OK. ]*/
TEST_FUNCTION(DataMarshaller_SendData_ReportedProperties_happy_path)
{
    ...
    /// act
    DATA_MARSHALLER_RESULT result =
        DataMarshaller_SendData_ReportedProperties(handle, values, &destination, &destinationSize);
...
/*Tests_SRS_DATA_MARSHALLER_02_019: [ If any failure occurs, DataMarshaller_SendData_ReportedProperties shall fail and
...
void DataMarshaller_SendData_ReportedProperties_of_model_in_model_inert_path(void)
{
    ...
    for (i = 0; i < 1; i++) /*these is property indexer*/
    {
        ...
        STRICT_EXPECTED_CALL(json_object_dotset_value(IGNORED_PTR_ARG,
                                                      DEFAULT_PROPERTY_NAME_LEVEL2_SLASHES_REPLACED_BY_DOTS,
                                                      IGNORED_PTR_ARG))
            .IgnoreArgument_object()
            .IgnoreArgument_value();
