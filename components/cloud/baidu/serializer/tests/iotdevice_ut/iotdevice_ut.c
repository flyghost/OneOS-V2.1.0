...
static COMMAND_DECODER_HANDLE my_CommandDecoder_Create(SCHEMA_MODEL_TYPE_HANDLE modelHandle,
                                                       ACTION_CALLBACK_FUNC     actionCallback,
                                                       void                    *actionCallbackContext,
                                                       METHOD_CALLBACK_FUNC     deviceMethodCallback,
...
static DATA_PUBLISHER_RESULT my_DataPublisher_EndTransaction(TRANSACTION_HANDLE transactionHandle,
...
static REPORTED_PROPERTIES_TRANSACTION_HANDLE
my_DataPublisher_CreateTransaction_ReportedProperties(DATA_PUBLISHER_HANDLE dataPublisherHandle)
{
    (void)(dataPublisherHandle);
...
TEST_SUITE_INITIALIZE(BeforeSuite)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURNS(CommandDecoder_IngestDesiredProperties,
    ...
    REGISTER_GLOBAL_MOCK_HOOK(DataPublisher_CreateTransaction_ReportedProperties,
                              my_DataPublisher_CreateTransaction_ReportedProperties);
    REGISTER_GLOBAL_MOCK_HOOK(DataPublisher_DestroyTransaction_ReportedProperties,
                              my_DataPublisher_DestroyTransaction_ReportedProperties);
}
...
/* Tests_SRS_DEVICE_05_014: [If any of the modelHandle, deviceHandle or deviceActionCallback arguments are NULL,
 * Device_Create shall return DEVICE_INVALID_ARG.]*/
TEST_FUNCTION(Device_Create_with_NULL_model_handle_fails)
{
    ...
    // act
    DEVICE_RESULT res = Device_Create(NULL,
                                      DeviceActionCallback,
...
/* Tests_SRS_DEVICE_05_014: [If any of the iotHubClientHandle, modelHandle, deviceHandle or deviceActionCallback
 * arguments are NULL, Device_Create shall return DEVICE_INVALID_ARG.] */
TEST_FUNCTION(Device_Create_with_NULL_Action_Callback_fails)
{
    ...
    // act
    DEVICE_RESULT res = Device_Create(irrelevantModel,
                                      NULL,
                                      TEST_CALLBACK_CONTEXT,
                                      deviceMethodCallback,
                                      TEST_CALLBACK_CONTEXT,
 ...
 */
/* Tests_SRS_DEVICE_01_001: [Device_Create shall create a CommandDecoder instance by calling CommandDecoder_Create and
 * passing to it the model handle.] */
/* Tests_SRS_DEVICE_01_002: [Device_Create shall also pass to CommandDecoder_Create a callback to be invoked when a
 * command is received and a context that shall be the device handle.]  */
...
TEST_FUNCTION(Device_Create_can_return_a_device_handle)
{
    ...
    STRICT_EXPECTED_CALL(
        CommandDecoder_Create(irrelevantModel, NULL, NULL, commandDecoderArgument, TEST_CALLBACK_CONTEXT))
...
/* Tests_SRS_DEVICE_01_019: [If creating the DataPublisher instance fails, Device_Create shall return
...
TEST_FUNCTION(When_DataPublisher_Create_Fails_Then_Device_Create_Fails)
{
    ...
    STRICT_EXPECTED_CALL(DataPublisher_Create(irrelevantModel, true)).SetReturn((DATA_PUBLISHER_HANDLE)NULL);
...
TEST_FUNCTION(When_CommandDecoder_Create_Fails_Device_Create_Fails)
{
    ...
    STRICT_EXPECTED_CALL(DataPublisher_Destroy(IGNORED_PTR_ARG)).IgnoreArgument_dataPublisherHandle();
...
TEST_FUNCTION(Device_Destroy_with_a_Valid_handle_frees_all_underlying_modules)
{
    // arrange
    DEVICE_HANDLE h = NULL;
    (void)Device_Create(irrelevantModel,
                        DeviceActionCallback,
                        TEST_CALLBACK_CONTEXT,
                        deviceMethodCallback,
                        TEST_CALLBACK_CONTEXT,
    ...
    STRICT_EXPECTED_CALL(DataPublisher_Destroy(IGNORED_PTR_ARG)).IgnoreArgument_dataPublisherHandle();
    STRICT_EXPECTED_CALL(CommandDecoder_Destroy(IGNORED_PTR_ARG)).IgnoreArgument_commandDecoderHandle();
...
/* Tests_SRS_DEVICE_01_034: [Device_StartTransaction shall invoke DataPublisher_StartTransaction for the DataPublisher
 * handle associated with the deviceHandle argument.] */
...
TEST_FUNCTION(Device_StartTransaction_Calls_DataPublisher_And_Succeeds)
{
    ...
    STRICT_EXPECTED_CALL(DataPublisher_StartTransaction(IGNORED_PTR_ARG)).IgnoreArgument_dataPublisherHandle();
...
/* Tests_SRS_DEVICE_01_049: [When DataPublisher_PublishTransacted fails, Device_PublishTransacted shall return
 * DEVICE_DATA_PUBLISHER_FAILED.] */
TEST_FUNCTION(When_DataPublisher_PublishTransacted_Fails_Then_Device_PublishTransacted_Fails)
{
    ...
    STRICT_EXPECTED_CALL(DataPublisher_PublishTransacted(transaction, "p", &ag)).SetReturn(DATA_PUBLISHER_ERROR);
...
/* Tests_SRS_DEVICE_01_050: [When DataPublisher_EndTransaction fails, Device_EndTransaction shall return
 * DEVICE_DATA_PUBLISHER_FAILED.] */
...
/* Tests_SRS_DEVICE_01_051: [When DataPublisher_CancelTransaction fails, Device_CancelTransaction shall return
 * DEVICE_DATA_PUBLISHER_FAILED.] */
TEST_FUNCTION(When_DataPublisher_CancelTransaction_Fails_Then_Device_CancelTransaction_Fails)
{
    ...
    STRICT_EXPECTED_CALL(DataPublisher_CancelTransaction(transaction)).SetReturn(DATA_PUBLISHER_ERROR);
...
/*Tests_SRS_DEVICE_02_011: [If the parameter actionCallbackContent passed the callback is NULL then the callback shall
 * return EXECUTION_COMMAND_ERROR.] */
...
/* Tests_SRS_DEVICE_01_052: [When the action callback passed to CommandDecoder is called, Device shall call the
 * appropriate user callback associated with the device handle.] */
/* Tests_SRS_DEVICE_01_053: [The action name, argument count and action arguments shall be passed to the user callback.]
 */
/* Tests_SRS_DEVICE_01_055: [The value passed in callbackUserContext when creating the device shall be passed to the
 * callback as the value for the callbackUserContext argument.] */
...
/* Tests_SRS_DEVICE_01_054: [If the user callback returns a non-zero value, a non-zero value shall be returned to
 * CommandReader.] */
...
/*Tests_SRS_DEVICE_02_012: [If any parameters are NULL, then Device_ExecuteCommand shall return
 * EXECUTE_COMMAND_ERROR.]*/
...
/*Tests_SRS_DEVICE_02_013: [Otherwise, Device_ExecuteCommand shall call CommandDecoder_ExecuteCommand and return what
 * CommandDecoder_ExecuteCommand is returning.]*/
TEST_FUNCTION(Device_ExecuteCommand_returns_what_CommandDecoder_ExecuteCommand_returns_EXECUTE_COMMAND_SUCCESS)
{
    ...
    STRICT_EXPECTED_CALL(CommandDecoder_ExecuteCommand(IGNORED_PTR_ARG, "some command")).IgnoreArgument(1);
...
/*Tests_SRS_DEVICE_02_014: [ If argument deviceHandle is NULL then Device_CreateTransaction_ReportedProperties shall
...
TEST_FUNCTION(Device_CreateTransaction_ReportedProperties_with_NULL_deviceHandle_fails)
{
    ...
    /// act
    REPORTED_PROPERTIES_TRANSACTION_HANDLE reportedPropertiesTransactionHandle =
        Device_CreateTransaction_ReportedProperties(NULL);
...
/*Tests_SRS_DEVICE_02_015: [ Otherwise, Device_CreateTransaction_ReportedProperties shall call
 * DataPublisher_CreateTransaction_ReportedProperties. ]*/
/*Tests_SRS_DEVICE_02_017: [ Otherwise Device_CreateTransaction_ReportedProperties shall succeed and return a non-NULL
 * value. ]*/
TEST_FUNCTION(Device_CreateTransaction_ReportedProperties_succeeds)
{
    ...
    /// act
    REPORTED_PROPERTIES_TRANSACTION_HANDLE reportedPropertiesTransactionHandle =
        Device_CreateTransaction_ReportedProperties(h);
...
/*Tests_SRS_DEVICE_02_016: [ If DataPublisher_CreateTransaction_ReportedProperties fails then
 * Device_CreateTransaction_ReportedProperties shall fail and return NULL. ]*/
...
/*Tests_SRS_DEVICE_02_018: [ If argument transactionHandle is NULL then Device_PublishTransacted_ReportedProperty shall
 * fail and return DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_019: [ If argument reportedPropertyPath is NULL then Device_PublishTransacted_ReportedProperty
 * shall fail and return DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_020: [ If argument data is NULL then Device_PublishTransacted_ReportedProperty shall fail and
 * return DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_021: [ Device_PublishTransacted_ReportedProperty shall call
...
/*Tests_SRS_DEVICE_02_022: [ If DataPublisher_PublishTransacted_ReportedProperty fails then
 * Device_PublishTransacted_ReportedProperty shall fail and return DEVICE_DATA_PUBLISHER_FAILED. ]*/
...
/*Tests_SRS_DEVICE_02_024: [ If argument transactionHandle is NULL then Device_CommitTransaction_ReportedProperties
 * shall fail and return DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_025: [ If argument destination is NULL then Device_CommitTransaction_ReportedProperties shall fail
 * and return DEVICE_INVALID_ARG. ]*/
TEST_FUNCTION(Device_CommitTransaction_ReportedProperties_with_NULL_destination_fails)
{
    ...
    DEVICE_RESULT result =
        Device_CommitTransaction_ReportedProperties(reportedPropertiesTransactionHandle, NULL, &destinationSize);
...
/*Tests_SRS_DEVICE_02_026: [ If argument destinationSize is NULLthen Device_CommitTransaction_ReportedProperties shall
 * fail and return DEVICE_INVALID_ARG. ]*/
TEST_FUNCTION(Device_CommitTransaction_ReportedProperties_with_NULL_destinationSize_fails)
{
    ...
    /// act
    DEVICE_RESULT result =
        Device_CommitTransaction_ReportedProperties(reportedPropertiesTransactionHandle, &destination, NULL);
...
/*Tests_SRS_DEVICE_02_027: [ Device_CommitTransaction_ReportedProperties shall call
...
TEST_FUNCTION(Device_CommitTransaction_ReportedProperties_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(
        DataPublisher_CommitTransaction_ReportedProperties(IGNORED_PTR_ARG, &destination, &destinationSize))
        .IgnoreArgument_transactionHandle();

    /// act
    DEVICE_RESULT result = Device_CommitTransaction_ReportedProperties(reportedPropertiesTransactionHandle,
                                                                       &destination,
                                                                       &destinationSize);
...
/*Tests_SRS_DEVICE_02_028: [ If DataPublisher_CommitTransaction_ReportedProperties fails then
 * Device_CommitTransaction_ReportedProperties shall fail and return DEVICE_DATA_PUBLISHER_FAILED. ]*/
...
/*Tests_SRS_DEVICE_02_030: [ If argument transactionHandle is NULL then Device_DestroyTransaction_ReportedProperties
 * shall return. ]*/
...
TEST_FUNCTION(Device_DestroyTransaction_ReportedProperties_succeeds_3)
{
    ...
    REPORTED_PROPERTIES_TRANSACTION_HANDLE reportedPropertiesTransactionHandle =
        Device_CreateTransaction_ReportedProperties(h);
    (void)Device_PublishTransacted_ReportedProperty(reportedPropertiesTransactionHandle, "a", &ag);
    (void)Device_CommitTransaction_ReportedProperties(reportedPropertiesTransactionHandle,
                                                      &destination,
                                                      &destinationSize);
    umock_c_reset_all_calls();
...
/*Tests_SRS_DEVICE_02_032: [ If deviceHandle is NULL then Device_IngestDesiredProperties shall fail and return
 * DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_033: [ If jsonPayload is NULL then Device_IngestDesiredProperties shall fail and return
 * DEVICE_INVALID_ARG. ]*/
...
/*Tests_SRS_DEVICE_02_037: [ If startAddress is NULL then Device_IngestDesiredProperties shall fail and return
 * DEVICE_INVALID_ARG. ]*/
...
TEST_FUNCTION(Device_IngestDesiredProperties_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(
        CommandDecoder_IngestDesiredProperties(FAKE_DEVICE_START_ADDRESS, IGNORED_PTR_ARG, "{}", false))
...
/*Tests_SRS_DEVICE_02_035: [ If any failure happens then Device_IngestDesiredProperties shall fail and return
 * DEVICE_ERROR. ]*/
...
/*Tests_SRS_DEVICE_02_040: [ Device_ExecuteMethod shall call CommandDecoder_ExecuteMethod and shall return what
 * CommandDecoder_ExecuteMethod returns. ]*/
TEST_FUNCTION(Device_ExecuteMethod_happy_path)
{
    ...
    STRICT_EXPECTED_CALL(CommandDecoder_ExecuteMethod(IGNORED_PTR_ARG, "theMethod", NULL)).IgnoreArgument_handle();
