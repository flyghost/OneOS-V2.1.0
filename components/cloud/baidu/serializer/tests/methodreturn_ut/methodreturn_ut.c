...
static void MethodReturn_Create_with_non_NULL_jsonValue_inert_path(const char *jsonValue)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, jsonValue)).IgnoreArgument_destination();
}

/*Tests_SRS_METHODRETURN_02_001: [ MethodReturn_Create shall create a non-NULL handle containing statusCode and a clone
 * of jsonValue. ]*/
...
/*Tests_SRS_METHODRETURN_02_011: [ Otherwise, MethodReturn_GetReturn shall return a non-NULL const pointer to a
 * METHODRETURN_DATA. ]*/
