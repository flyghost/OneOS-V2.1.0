...
/* Tests_SRS_SCHEMA_99_153: [Schema_GetSchemaCount shall return the number of "active" schemas (all schemas created with
   Schema_Create in the current process, for which Schema_Destroy has not been called).] */
...
/* Tests_SRS_SCHEMA_99_151: [If no active schema matches the schemaNamespace argument, Schema_GetSchemaByNamespace shall
 * return NULL.] */
...
/* Tests_SRS_SCHEMA_99_129: [Schema_GetSchemaNamespace shall return the namespace for the schema identified by
 * schemaHandle.] */
...
{
    STRICT_EXPECTED_CALL(gballoc_realloc(IGNORED_PTR_ARG, IGNORED_NUM_ARG)).IgnoreArgument_ptr().IgnoreArgument_size();

    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG)).IgnoreArgument_size();

    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, MODEL_NAME)).IgnoreArgument_destination();
...
/* Tests_SRS_SCHEMA_99_011:[Schema_AddModelProperty shall add one property to the model type identified by
 * modelTypeHandle.] */
...
/* Tests_SRS_SCHEMA_99_015:[The property name shall be unique per model, if the same property name is added twice to a
 * model, SCHEMA_DUPLICATE_ELEMENT shall be returned.] */
 ...
 * model, SCHEMA_DUPLICATE_ELEMENT shall be returned.] */
TEST_FUNCTION(
    Schema_AddModelProperty_Adding_The_Same_Property_In_The_Same_Model_When_The_Duplicate_Property_Is_Not_First_Fails)
{
    // arrange
    SCHEMA_HANDLE            schemaHandle = Schema_Create(SCHEMA_NAMESPACE, TEST_SCHEMA_METADATA);
    SCHEMA_MODEL_TYPE_HANDLE modelType    = Schema_CreateModelType(schemaHandle, "Model");
...
/* Tests_SRS_SCHEMA_99_104: [If any of the modelTypeHandle or actionName arguments is NULL, Schema_CreateModelAction
 * shall return NULL.] */
...
/* Tests SRS_SCHEMA_99_102: [Schema_CreateModelAction shall add one action to the model type identified by
 * modelTypeHandle.] */
/* Tests_SRS_SCHEMA_99_103: [On success, Schema_CreateModelAction shall return a none-NULL SCHEMA_ACTION_HANDLE to the
...
/* Tests_SRS_SCHEMA_99_105: [The action name shall be unique per model, if the same action name is added twice to a
 * model, Schema_CreateModelAction shall return NULL.] */
...
/* Tests_SRS_SCHEMA_99_109: [If any of the arguments is NULL, Schema_AddModelActionArgument shall return
 * SCHEMA_INVALID_ARG.] */
...
/* Tests_SRS_SCHEMA_99_107: [Schema_AddModelActionArgument shall add one argument name & type to an action identified by
 * actionHandle.] */
...
/* Tests_SRS_SCHEMA_99_110: [The argument name shall be unique per action, if the same name is added twice to an action,
 * SCHEMA_DUPLICATE_ELEMENT shall be returned.] */
...
/* Tests_SRS_SCHEMA_99_111: [Schema_AddModelActionArgument shall accept arguments with different names of the same
 * type.]  */
...
/* Tests_SRS_SCHEMA_99_120: [Schema_GetModelCount shall provide the number of models defined in the schema identified by
 * schemaHandle.] */
...
/* Tests_SRS_SCHEMA_99_125: [Schema_GetModelByName shall return NULL if unable to find a matching model, or if any of
...
/* Tests_SRS_SCHEMA_99_124: [Schema_GetModelByName shall return a non-NULL SCHEMA_MODEL_TYPE_HANDLE corresponding to the
 * model identified by schemaHandle and matching the modelName argument value.] */
...
/* Tests_SRS_SCHEMA_99_128: [Schema_GetModelByIndex shall return NULL if the index specified is outside the valid range
 * or if schemaHandle argument is NULL.] */
...
/* Tests_SRS_SCHEMA_99_128: [Schema_GetModelByIndex shall return NULL if the index specified is outside the valid range
 * or if schemaHandle argument is NULL.] */
/* Tests_SRS_SCHEMA_99_127: [The index argument is zero based, and the order in which models were added shall be the
...
/* Tests_SRS_SCHEMA_99_126: [Schema_GetModelByIndex shall return a non-NULL SCHEMA_MODEL_TYPE_HANDLE corresponding to
 * the model identified by schemaHandle and matching the index number provided by the index argument.] */
/* Tests_SRS_SCHEMA_99_127: [The index argument is zero based, and the order in which models were added shall be the
 * index in which they will be retrieved.] */
...
/* Tests_SRS_SCHEMA_99_038:[Schema_GetModelPropertyByName shall return NULL if unable to find a matching property or if
...
/* Tests_SRS_SCHEMA_99_036:[Schema_GetModelPropertyByName shall return a non-NULL SCHEMA_PROPERTY_HANDLE corresponding
 * to the model type identified by modelTypeHandle and matching the propertyName argument value.] */
...
/* Tests_SRS_SCHEMA_99_092: [Schema_GetModelPropertyCount shall return SCHEMA_INVALID_ARG if any of the arguments is
 * NULL.] */
...
/* Tests_SRS_SCHEMA_99_089: [Schema_GetModelPropertyCount shall provide the number of properties defined in the model
 * type identified by modelTypeHandle.] */
...
/* Tests_SRS_SCHEMA_99_094: [Schema_GetModelProperty shall return NULL if the index specified is outside the valid range
 * or if modelTypeHandle argument is NULL.] */
...
/* Tests_SRS_SCHEMA_99_093: [Schema_GetModelProperty shall return a non-NULL SCHEMA_PROPERTY_HANDLE corresponding to the
 * model type identified by modelTypeHandle and matching the index number provided by the index argument.] */
/* Tests_SRS_SCHEMA_99_097: [index is zero based, and the order in which actions were added shall be the index in which
...
/* Tests_SRS_SCHEMA_99_041:[Schema_GetModelActionByName shall return NULL if unable to find a matching action, if any of
 * the arguments are NULL.] */
...
/* Tests_SRS_SCHEMA_99_040:[Schema_GetModelActionByName shall return a non-NULL SCHEMA_ACTION_HANDLE corresponding to
 * the model type identified by modelTypeHandle and matching the actionName argument value.] */
...
/* Tests_SRS_SCHEMA_99_045:[If any of the modelTypeHandle or actionCount arguments is NULL, Schema_GetModelActionCount
 * shall return SCHEMA_INVALID_ARG.] */
...
/* Tests_SRS_SCHEMA_99_042:[Schema_GetModelActionCount shall provide the total number of actions defined in a model type
 * identified by the modelTypeHandle.] */
...
/* Tests_SRS_SCHEMA_99_048:[Schema_GetModelAction shall return NULL if the index specified is outside the valid range or
 * if modelTypeHandle argument is NULL.] */
...
/* Tests_SRS_SCHEMA_99_047:[Schema_GetModelAction shall return a non-NULL SCHEMA_ACTION_HANDLE corresponding to the
 * model type identified by modelTypeHandle and matching the index number provided by the index argument.] */
/* Tests_SRS_SCHEMA_99_096: [index is zero based and the order in which actions were added shall be the index in which
 * they will be retrieved.] */
...
/* Tests_SRS_SCHEMA_99_054:[If any argument is NULL, Schema_GetModelActionArgumentCount shall return
 * SCHEMA_INVALID_ARG.] */
...
/* Tests_SRS_SCHEMA_99_051:[Schema_GetModelActionArgumentCount shall provide the number of arguments for a specific
 * schema action identified by actionHandle.] */
...
/* Tests_SRS_SCHEMA_99_118: [Schema_GetModelActionArgumentByName shall return NULL if unable to find a matching argument
...
/* Tests_SRS_SCHEMA_99_117: [Schema_GetModelActionArgumentByName shall return a non-NULL handle corresponding to an
 * action argument identified by the actionHandle and actionArgumentName.] */
...
/* Tests_SRS_SCHEMA_99_056:[Schema_GetModelActionArgumentByIndex shall return NULL if the index specified is outside the
...
/* Tests_SRS_SCHEMA_99_055:[Schema_GetModelActionArgumentByIndex shall return a non-NULL SCHEMA_ACTION_ARGUMENT_HANDLE
...
/* Tests_SRS_SCHEMA_99_113: [Schema_GetActionArgumentName shall return the argument name identified by the
...
/* Tests_SRS_SCHEMA_99_115: [Schema_GetActionArgumentType shall return the argument type identified by the
 * actionArgumentHandle.] */
...
/* Tests_SRS_SCHEMA_99_061:[If a struct type with the same name already exists, Schema_CreateStructType shall return
 * NULL.] */
...
/* Tests_SRS_SCHEMA_99_136: [If structTypeHandle is NULL, Schema_GetStructTypeName shall return NULL.] */
/* Tests_SRS_SCHEMA_99_135: [Schema_GetStructTypeName shall return the name of a struct type identified by the
...
/* Tests_SRS_SCHEMA_99_069:[Schema_GetStructTypeByName shall return NULL if unable to find a matching struct or if any
...
/* Tests_SRS_SCHEMA_99_072:[If any of the arguments is NULL, Schema_AddStructTypeProperty shall return
 * SCHEMA_INVALID_ARG.] */
...
/* Tests_SRS_SCHEMA_99_070:[Schema_AddStructTypeProperty shall add one property to the struct type identified by
 * structTypeHandle.] */
...
/* Tests_SRS_SCHEMA_99_074:[The property name shall be unique per struct type, if the same property name is added twice
 * to a struct type, SCHEMA_DUPLICATE_ELEMENT shall be returned.] */
 ...
 * to a struct type, SCHEMA_DUPLICATE_ELEMENT shall be returned.] */
TEST_FUNCTION(
    Schema_AddStructTypeProperty_Adding_The_Same_Property_In_The_Same_StructType_When_The_Duplicate_Property_Is_Not_First_Fails)
{
    // arrange
    SCHEMA_HANDLE             schemaHandle = Schema_Create(SCHEMA_NAMESPACE, TEST_SCHEMA_METADATA);
    SCHEMA_STRUCT_TYPE_HANDLE structType   = Schema_CreateStructType(schemaHandle, "Struct");
...
/* Tests_SRS_SCHEMA_99_137: [Schema_GetStructTypeCount shall provide the number of structs defined in the schema
...
/* Tests_SRS_SCHEMA_99_143: [Schema_GetStructTypeByIndex shall return NULL if the index specified is outside the valid
...
/* Tests_SRS_SCHEMA_99_143: [Schema_GetStructTypeByIndex shall return NULL if the index specified is outside the valid
 * range or if schemaHandle argument is NULL.] */
/* Tests_SRS_SCHEMA_99_142: [The index argument is zero based, and the order in which models were added shall be the
 * index in which they will be retrieved.] */
...
/* Tests_SRS_SCHEMA_99_141: [Schema_GetStructTypeByIndex shall return a non-NULL SCHEMA_STRUCT_TYPE_HANDLE corresponding
 * to the struct type identified by schemaHandle and matching the index number provided by the index argument.] */
/* Tests_SRS_SCHEMA_99_142: [The index argument is zero based, and the order in which models were added shall be the
 * index in which they will be retrieved.] */
...
/* Tests_SRS_SCHEMA_99_076:[Schema_GetStructTypePropertyByName shall return NULL if unable to find a matching property
 * or if any of the arguments are NULL.] */
...
/* Tests_SRS_SCHEMA_99_075:[Schema_GetStructTypePropertyByName shall return a non-NULL handle corresponding to a
 ...
 * property identified by the structTypeHandle and propertyName.] */
TEST_FUNCTION(
    Schema_GetStructTypePropertyByName_When_The_Property_Is_Found_After_Adding_2_Properties_Returns_A_Property_Handle)
{
    // arrange
    SCHEMA_HANDLE             schemaHandle = Schema_Create(SCHEMA_NAMESPACE, TEST_SCHEMA_METADATA);
    SCHEMA_STRUCT_TYPE_HANDLE structType   = Schema_CreateStructType(schemaHandle, "StructName");
...
/* Tests_SRS_SCHEMA_99_079: [Schema_GetStructTypePropertyCount shall return SCHEMA_INVALID_ARG if any of the
...
/* Tests_SRS_SCHEMA_99_077: [Schema_GetStructTypePropertyCount shall provide the total number of properties defined in a
 * struct type identified by structTypeHandle. The value is provided via the out argument propertyCount.] */
...
/* Tests_SRS_SCHEMA_99_083: [Schema_ GetStructTypeProperty shall return NULL if the index specified is outside the valid
 * range, if structTypeHandle argument is NULL] */
...
/* Tests_SRS_SCHEMA_99_082: [Schema_GetStructTypeProperty shall return a non-NULL SCHEMA_PROPERTY_HANDLE corresponding
 * to the struct type identified by strutTypeHandle and matching the index number provided by the index argument.] */
/* Tests_SRS_SCHEMA_99_098: [index is zero based and the order in which actions were added shall be the index in which
 * they will be retrieved.] */
...
/*Tests_SRS_SCHEMA_99_160: [Schema_GetModelName shall return the name of the model identified by modelTypeHandle. If the
...
/*Tests_SRS_SCHEMA_99_163: [Schema_AddModelModel shall insert an existing model, identified by the handle modelType,
...
/*Tests_SRS_SCHEMA_99_167: [Schema_GetModelModelCount shall return in parameter modelCount the number of models inserted
 * in the model identified by parameter modelTypeHandle.]*/
...
/*Tests_SRS_SCHEMA_99_170: [Schema_GetModelModelByName shall return a handle to the model identified by the property
 * with the name propertyName in the model identified by the handle modelTypeHandle.]*/
...
/*Tests_SRS_SCHEMA_99_172: [ Schema_GetModelModelyByIndex shall return a handle to the "index"th model inserted in the
 * model identified by the parameter modelTypeHandle.]*/
/*Tests_SRS_SCHEMA_99_173: [Schema_GetModelModelyByIndex shall return NULL in the cases when it cannot provide the
 * handle.]*/
...
/*Tests_SRS_SCHEMA_99_175: [Schema_GetModelModelPropertyNameByIndex shall return the name of the property for the
 * "index"th model in the model identified by modelTypeHandle parameter.]*/
/*Tests_SRS_SCHEMA_99_176: [If Schema_GetModelModelPropertyNameByIndex cannot produce the property name, it shall return
 * NULL.]*/
...
/* Tests_SRS_SCHEMA_99_177: [Schema_ModelPropertyByPathExists shall return true if a leaf property exists in the model
 * modelTypeHandle.] */
...
/* Tests_SRS_SCHEMA_99_181: [If the property cannot be found Schema_ModelPropertyByPathExists shall return false.] */
TEST_FUNCTION(
    Schema_When_Property_Is_Not_Found_In_A_2nd_Level_Child_Model_Schema_ModelPropertyByPathExists_Returns_True)
{
    /// arrange
    SCHEMA_HANDLE            schemaHandle = Schema_Create(SCHEMA_NAMESPACE, TEST_SCHEMA_METADATA);
    SCHEMA_MODEL_TYPE_HANDLE bigModel     = Schema_CreateModelType(schemaHandle, "someBigModel");
...
/* Tests_SRS_SCHEMA_99_182: [A single slash ('/') at the beginning of the path shall be ignored and the path shall still
 * be valid.] */
...
/* Tests_SRS_SCHEMA_99_183: [If the path propertyPathpoints to a sub-model, Schema_ModelPropertyByPathExists shall
 * return true.] */
...
/*Tests_SRS_SCHEMA_02_001: [ If modelTypeHandle is NULL then Schema_AddModelReportedProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_002: [ If reportedPropertyName is NULL then Schema_AddModelReportedProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_003: [ If reportedPropertyType is NULL then Schema_AddModelReportedProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_004: [ If reportedPropertyName has already been added then Schema_AddModelReportedProperty shall
 * fail and return SCHEMA_DUPLICATE_ELEMENT. ]*/
TEST_FUNCTION(Schema_AddModelReportedProperty_adding_twice_the_same_reportedproperty_fails)
{
    ...
    /// act
    SCHEMA_RESULT result =
        Schema_AddModelReportedProperty(modelType, reportedPropertyName, "int"); /*added the second time*/
...
void Schema_AddModelReportedProperty_inert_path(const char *reportedPropertyName, const char *reportedPropertyType)
{
    STRICT_EXPECTED_CALL(VECTOR_find_if(IGNORED_PTR_ARG, IGNORED_PTR_ARG, reportedPropertyName))
        ...
        .IgnoreArgument_pred();
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG)).IgnoreArgument_size();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, reportedPropertyName)).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, reportedPropertyType)).IgnoreArgument_destination();
...
/*Tests_SRS_SCHEMA_02_006: [ If any error occurs then Schema_AddModelReportedProperty shall fail and return
 * SCHEMA_ERROR. ]*/
TEST_FUNCTION(Schema_AddModelReportedProperty_unhappy_paths)
{
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        ...
        for (j = 0; j < sizeof(calls_that_cannot_fail) / sizeof(calls_that_cannot_fail[0]);
             j++) /*not running the tests that cannot fail*/
        {
        ...
        if (j == sizeof(calls_that_cannot_fail) / sizeof(calls_that_cannot_fail[0]))
        {
            ...
            /// act
            SCHEMA_RESULT result =
                Schema_AddModelReportedProperty(modelType, reportedPropertyName, reportedPropertyType);
...
/*Tests_SRS_SCHEMA_02_008: [ If parameter modelTypeHandle is NULL then Schema_GetModelReportedPropertyCount shall fail
...
/*Tests_SRS_SCHEMA_02_009: [ If parameter reportedPropertyCount is NULL then Schema_GetModelReportedPropertyCount shall
...
/*Tests_SRS_SCHEMA_02_010: [ Schema_GetModelReportedPropertyCount shall provide in reportedPropertyCount the number of
 * reported properties and return SCHEMA_OK. ]*/
TEST_FUNCTION(Schema_GetModelReportedPropertyCount_happy_path)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_size(IGNORED_PTR_ARG)).IgnoreArgument_handle();
...
/*Tests_SRS_SCHEMA_02_011: [ If argument modelTypeHandle is NULL then Schema_GetModelReportedPropertyByName shall fail
 * and return NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_012: [ If argument reportedPropertyName is NULL then Schema_GetModelReportedPropertyByName shall
...
/*Tests_SRS_SCHEMA_02_013: [ If reported property by the name reportedPropertyName exists then
...
/*Tests_SRS_SCHEMA_02_015: [ If argument modelTypeHandle is NULL then Schema_GetModelReportedPropertyByIndex shall fail
 * and return NULL. ]*/
...
TEST_FUNCTION(Schema_GetModelReportedPropertyByIndex_unhappy_path)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 0)).IgnoreArgument_handle();
...
/*Tests_SRS_SCHEMA_02_016: [ If a reported property with index equal to index exists then
 * Schema_GetModelReportedPropertyByIndex shall succeed and return the non-NULL handle of that REPORTED_PROPERTY. ]*/
...
/*Tests_SRS_SCHEMA_02_018: [ If argument modelTypeHandle is NULL then Schema_ModelReportedPropertyByPathExists shall
...
/*Tests_SRS_SCHEMA_02_019: [ If argument reportedPropertyPath is NULL then Schema_ModelReportedPropertyByPathExists
...
/*Tests_SRS_SCHEMA_02_021: [ If the reported property cannot be found Schema_ModelReportedPropertyByPathExists shall
 * fail and return false. ]*/
...
/*Tests_SRS_SCHEMA_02_020: [ reportedPropertyPath shall be assumed to be in the format
 * model1/model2/.../reportedPropertyName. ]*/
/*Tests_SRS_SCHEMA_02_022: [ If the path reportedPropertyPath points to a sub-model,
 * Schema_ModelReportedPropertyByPathExists shall succeed and true. ]*/
/*Tests_SRS_SCHEMA_02_023: [ If reportedPropertyPath exists then Schema_ModelReportedPropertyByPathExists shall succeed
 * and return true ]*/
TEST_FUNCTION(Schema_ModelReportedPropertyByPathExists_with_1_model_in_model_succeeds)
{
    ...
    */
    ...
    bool result3 =
        Schema_ModelReportedPropertyByPathExists(model, "ManicMiner/reported"); /*only "a" and "ManicMiner" exists*/
...
/*Tests_SRS_SCHEMA_02_024: [ If modelTypeHandle is NULL then Schema_AddModelDesiredProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
TEST_FUNCTION(Schema_AddModelDesiredProperty_with_NULL_modelTypeHandle_fails)
{
    ...
    /// act
    SCHEMA_RESULT result = Schema_AddModelDesiredProperty(NULL,
                                                          "a",
                                                          "b",
                                                          g_pfDesiredPropertyFromAGENT_DATA_TYPE,
                                                          g_pfDesiredPropertyInitialize,
                                                          g_pfDesiredPropertyDeinitialize,
                                                          0,
                                                          NULL);
...
/*Tests_SRS_SCHEMA_02_025: [ If desiredPropertyName is NULL then Schema_AddModelDesiredProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
TEST_FUNCTION(Schema_AddModelDesiredProperty_with_NULL_desiredPropertyName_fails)
{
    ...
    /// act
    SCHEMA_RESULT result = Schema_AddModelDesiredProperty(modelType,
                                                          NULL,
                                                          "b",
                                                          g_pfDesiredPropertyFromAGENT_DATA_TYPE,
                                                          g_pfDesiredPropertyInitialize,
...
/*Tests_SRS_SCHEMA_02_026: [ If desiredPropertyType is NULL then Schema_AddModelDesiredProperty shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_048: [ If desiredPropertyFromAGENT_DATA_TYPE is NULL then Schema_AddModelDesiredProperty shall
 * fail and return SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_049: [ If desiredPropertyInitialize is NULL then Schema_AddModelDesiredProperty shall fail and
...
/*Tests_SRS_SCHEMA_02_050: [ If desiredPropertyDeinitialize is NULL then Schema_AddModelDesiredProperty shall fail and
 * return SCHEMA_INVALID_ARG. ]*/
...
static void Schema_AddModelDesiredProperty_inert_path(const char *desiredPropertyName, const char *desiredPropertyType)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, desiredPropertyName)).IgnoreArgument_destination();

    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, desiredPropertyType)).IgnoreArgument_destination();
...
/*Tests_SRS_SCHEMA_02_027: [ Schema_AddModelDesiredProperty shall add the desired property given by the name
...
/*Tests_SRS_SCHEMA_02_028: [ If any failure occurs then Schema_AddModelDesiredProperty shall fail and return
 * SCHEMA_ERROR. ]*/
...
/*Tests_SRS_SCHEMA_02_047: [ If the desired property already exists, then Schema_AddModelDesiredProperty shall fail and
 * return SCHEMA_DUPLICATE_ELEMENT. ]*/
TEST_FUNCTION(Schema_AddModelDesiredProperty_the_same_desired_property_twice_fails)
{
    ...
    const char              *name         = "a";
    const char              *type         = "b";
    (void)Schema_AddModelDesiredProperty(modelType,
                                         name,
                                         type,
                                         g_pfDesiredPropertyFromAGENT_DATA_TYPE,
                                         g_pfDesiredPropertyInitialize,
...
/*Tests_SRS_SCHEMA_02_030: [ If modelTypeHandle is NULL then Schema_GetModelDesiredPropertyCount shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_031: [ If desiredPropertyCount is NULL then Schema_GetModelDesiredPropertyCount shall fail and
 * return SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_032: [ Otherwise, Schema_GetModelDesiredPropertyCount shall succeed and write in
...
/*Tests_SRS_SCHEMA_02_034: [ If modelTypeHandle is NULL then Schema_GetModelDesiredPropertyByName shall fail and return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_035: [ If desiredPropertyName is NULL then Schema_GetModelDesiredPropertyByName shall fail and
 * return NULL. ]*/
...
TEST_FUNCTION(Schema_GetModelDesiredPropertyByName_with_non_existing_desiredPropertyName_fails)
{
    ...
    SCHEMA_DESIRED_PROPERTY_HANDLE result =
        Schema_GetModelDesiredPropertyByName(modelType,
                                             desiredPropertyName); /*doesn't exist because no desired properties*/
...
/*Tests_SRS_SCHEMA_02_038: [ If modelTypeHandle is NULL then Schema_GetModelDesiredPropertyByIndex shall fail and return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_039: [ If index is outside the range for existing indexes of desire properties, then
...
TEST_FUNCTION(Schema_GetModelDesiredPropertyByIndex_with_1_desiredProperties_fails)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_element(IGNORED_PTR_ARG, 1)).IgnoreArgument_handle();
...
/*Tests_SRS_SCHEMA_02_041: [ If modelTypeHandle is NULL then Schema_ModelDesiredPropertyByPathExists shall fail and
 * return false. ]*/
...
/*Tests_SRS_SCHEMA_02_042: [ If desiredPropertyPath is NULL then Schema_ModelDesiredPropertyByPathExists shall fail and
 * return false. ]*/
...
/*Tests_SRS_SCHEMA_02_044: [ If the desired property cannot be found Schema_ModelDesiredPropertyByPathExists shall fail
 * and return false. ]*/
...
/*Tests_SRS_SCHEMA_02_046: [ If desiredPropertyPath exists then Schema_ModelDesiredPropertyByPathExists shall succeed
 * and return true. ]*/
...
TEST_FUNCTION(Schema_ModelDesiredPropertyByPathExists_with_1_model_in_model_fails)
{
    ...
    SCHEMA_MODEL_TYPE_HANDLE minerModel   = Schema_CreateModelType(schemaHandle, "someMinerModel");
    (void)Schema_AddModelModel(model, "ManicMiner", minerModel, 0, NULL);
    (void)Schema_AddModelDesiredProperty(model,
                                         "a",
                                         "b",
                                         g_pfDesiredPropertyFromAGENT_DATA_TYPE,
                                         g_pfDesiredPropertyInitialize,
...
/*Tests_SRS_SCHEMA_02_045: [ If the path desiredPropertyPath points to a sub-model,
...
TEST_FUNCTION(Schema_ModelDesiredPropertyByPathExists_with_1_model_in_model_succeeds)
{
    ...
    SCHEMA_MODEL_TYPE_HANDLE model        = Schema_CreateModelType(schemaHandle, "someModel");
    SCHEMA_MODEL_TYPE_HANDLE minerModel   = Schema_CreateModelType(schemaHandle, "someMinerModel");
    (void)Schema_AddModelDesiredProperty(minerModel,
                                         "reported",
                                         "five_miles_of_gallery",
                                         g_pfDesiredPropertyFromAGENT_DATA_TYPE,
                                         g_pfDesiredPropertyInitialize,
                                         g_pfDesiredPropertyDeinitialize,
                                         0,
    ...
    */
    ...
    bool result3 =
        Schema_ModelDesiredPropertyByPathExists(model, "ManicMiner/reported"); /*only "a" and "ManicMiner" exists*/
...
/*Tests_SRS_SCHEMA_02_051: [ If desiredPropertyHandle is NULL then
 * Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE shall fail and return NULL. ]*/
TEST_FUNCTION(Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE_with_NULL_desiredPropertyHandle_fails)
{
    ...
    pfDesiredPropertyFromAGENT_DATA_TYPE result =
        Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE(NULL);
...
/*Tests_SRS_SCHEMA_02_052: [ Otherwise Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE shall succeed
 * and return a non-NULL value. ]*/
TEST_FUNCTION(Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE_succeeds)
{
    ...
    /// act
    pfDesiredPropertyFromAGENT_DATA_TYPE result =
        Schema_GetModelDesiredProperty_pfDesiredPropertyFromAGENT_DATA_TYPE(desiredPropertyHandle);
...
/*Tests_SRS_SCHEMA_02_056: [ If propertyName is not a model then Schema_GetModelModelByName_Offset shall fail and return
 * 0. ]*/
...
TEST_FUNCTION(Schema_GetModelModelByIndex_Offset_with_invalid_index_fails)
{
    ...
    /// act
    size_t offset =
        Schema_GetModelModelByIndex_Offset(modelType, 0);    //<---invalid index, there are no model in models
...
/*Tests_SRS_SCHEMA_02_060: [ If desiredPropertyHandle is NULL then Schema_GetModelDesiredProperty_offset shall fail and
 * return 0. ]*/
...
/*Tests_SRS_SCHEMA_02_062: [ If desiredPropertyHandle is NULL then Schema_GetModelDesiredPropertyType shall fail and
 * return NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_063: [ Otherwise, Schema_GetModelDesiredPropertyType shall return the type of the desired
 * property. ]*/
...
/*Tests_SRS_SCHEMA_02_064: [ If desiredPropertyHandle is NULL then
...
/*Tests_SRS_SCHEMA_02_065: [Otherwise Schema_GetModelDesiredProperty_pfDesiredPropertyDeinitialize shall return a non -
...
TEST_FUNCTION(Schema_GetModelDesiredProperty_pfDesiredPropertyDeinitialize_succeeds)
{
    ...
    /// act
    pfDesiredPropertyDeinitialize deinit =
        Schema_GetModelDesiredProperty_pfDesiredPropertyDeinitialize(desiredPropertyHandle);
...
/*Tests_SRS_SCHEMA_02_066: [ If desiredPropertyHandle is NULL then
...
/*Tests_SRS_SCHEMA_02_067: [ Otherwise Schema_GetModelDesiredProperty_pfDesiredPropertyInitialize shall return a
...
TEST_FUNCTION(Schema_GetModelDesiredProperty_pfDesiredPropertyInitialize_succeeds)
{
    ...
    /// act
    pfDesiredPropertyInitialize init =
        Schema_GetModelDesiredProperty_pfDesiredPropertyInitialize(desiredPropertyHandle);
...
/*Tests_SRS_SCHEMA_02_078: [ If elementName is a property then Schema_GetModelElementByName shall succeed and set
 * SCHEMA_MODEL_ELEMENT.elementType to SCHEMA_PROPERTY and SCHEMA_MODEL_ELEMENT.elementHandle.propertyHandle to the
 * handle of the property. ]*/
/*Tests_SRS_SCHEMA_02_079: [ If elementName is a reported property then Schema_GetModelElementByName shall succeed and
 * set SCHEMA_MODEL_ELEMENT.elementType to SCHEMA_REPORTED_PROPERTY and
 * SCHEMA_MODEL_ELEMENT.elementHandle.reportedPropertyHandle to the handle of the reported property. ]*/
/*Tests_SRS_SCHEMA_02_080: [ If elementName is a desired property then Schema_GetModelElementByName shall succeed and
 * set SCHEMA_MODEL_ELEMENT.elementType to SCHEMA_DESIRED_PROPERTY and
 * SCHEMA_MODEL_ELEMENT.elementHandle.desiredPropertyHandle to the handle of the desired property. ]*/
/*Tests_SRS_SCHEMA_02_081: [ If elementName is a model action then Schema_GetModelElementByName shall succeed and set
 * SCHEMA_MODEL_ELEMENT.elementType to SCHEMA_MODEL_ACTION and SCHEMA_MODEL_ELEMENT.elementHandle.actionHandle to the
 * handle of the action. ]*/
/*Tests_SRS_SCHEMA_02_082: [ If elementName is a model in model then Schema_GetModelElementByName shall succeed and set
 * SCHEMA_MODEL_ELEMENT.elementType to SCHEMA_MODEL_IN_MODEL and SCHEMA_MODEL_ELEMENT.elementHandle.modelHandle to the
 * handle of the model. ]*/
/*Tests_SRS_SCHEMA_02_083: [ Otherwise Schema_GetModelElementByName shall fail and set SCHEMA_MODEL_ELEMENT.elementType
 * to SCHEMA_NOT_FOUND. ]*/
...
/*Tests_SRS_SCHEMA_02_084: [ If desiredPropertyHandle is NULL then Schema_GetModelDesiredProperty_pfOnDesiredProperty
 * shall return NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_085: [ Otherwise Schema_GetModelDesiredProperty_pfOnDesiredProperty shall return the saved desired
 * property callback. ]*/
 ...
 * property callback. ]*/
TEST_FUNCTION(
    Schema_GetModelDesiredProperty_pfOnDesiredProperty_created_with_non_NULL_pfOnDesiredProperty_returns_non_NULL)
{
    /// arrange
    SCHEMA_HANDLE            schemaHandle = Schema_Create(SCHEMA_NAMESPACE, TEST_SCHEMA_METADATA);
    SCHEMA_MODEL_TYPE_HANDLE modelType    = Schema_CreateModelType(schemaHandle, "Model");
...
/*Tests_SRS_SCHEMA_02_086: [ If modelTypeHandle is NULL then Schema_GetModelModelByName_OnDesiredProperty shall return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_087: [ If propertyName is NULL then Schema_GetModelModelByName_OnDesiredProperty shall return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_089: [ Otherwise Schema_GetModelModelByName_OnDesiredProperty shall return the desired property
 * callback. ]*/
...
/*Tests_SRS_SCHEMA_02_094: [ Schema_GetSchemaForModel shall find the SCHEMA_HANDLE that contains a model by name
...
/*Tests_SRS_SCHEMA_02_095: [ If the model is not found in any schema, then Schema_GetSchemaForModel shall fail and
 * return NULL. ]*/
...
static void Schema_CreateModelMethod_inert_path(void)
{
    ...
    STRICT_EXPECTED_CALL(VECTOR_create(IGNORED_NUM_ARG)).IgnoreArgument_elementSize();
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "method")).IgnoreArgument_destination();
    STRICT_EXPECTED_CALL(VECTOR_push_back(IGNORED_PTR_ARG, IGNORED_PTR_ARG, 1))
        .IgnoreArgument_handle()
        .IgnoreArgument_elements();
}
 ...
 * ]*/
/*Tests_SRS_SCHEMA_02_104: [ Otherwise, Schema_CreateModelMethod shall succeed and return a non-NULL
...
/*Tests_SRS_SCHEMA_02_105: [ If methodHandle is NULL then Schema_AddModelMethodArgument shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_106: [ If argumentName is NULL then Schema_AddModelMethodArgument shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_107: [ If argumentType is NULL then Schema_AddModelMethodArgument shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_108: [ If argumentName already exists in the list of arguments then then
...
static void Schema_AddModelMethodArgument_inert_path(void)
{
    ...
    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "a")).IgnoreArgument_destination();

    STRICT_EXPECTED_CALL(mallocAndStrcpy_s(IGNORED_PTR_ARG, "int")).IgnoreArgument_destination();
...
/*Tests_SRS_SCHEMA_02_112: [ Schema_AddModelMethodArgument shall add the created argument to the method's list of
 * arguments. ]*/
...
/*Tests_SRS_SCHEMA_02_113: [ If any of the above operations fails, then Schema_AddModelMethodArgument shall fail and
 * return SCHEMA_ERROR. ]*/
...
/*Tests_SRS_SCHEMA_02_117: [ If a method with the name methodName exists then Schema_GetModelMethodByName shall succeed
...
/*Tests_SRS_SCHEMA_02_119: [ If methodHandle is NULL then Schema_GetModelMethodArgumentCount shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_120: [ If argumentCount is NULL then Schema_GetModelMethodArgumentCount shall fail and return
 * SCHEMA_INVALID_ARG. ]*/
...
/*Tests_SRS_SCHEMA_02_121: [ Otherwise, Schema_GetModelMethodArgumentCount shall succeed, return in argumentCount the
 * number of arguments for the method and return SCHEMA_OK. ]*/
...
/*Tests_SRS_SCHEMA_02_122: [ If methodHandle is NULL then Schema_GetModelMethodArgumentByIndex shall fail and return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_123: [ If argumentIndex does not exist then Schema_GetModelMethodArgumentByIndex shall fail and
 * return NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_125: [ If methodArgumentHandle is NULL then Schema_GetMethodArgumentName shall fail and return
 * NULL. ]*/
...
/*Tests_SRS_SCHEMA_02_127: [ If methodArgumentHandle is NULL then Schema_GetMethodArgumentType shall fail and return
 * NULL. ]*/
