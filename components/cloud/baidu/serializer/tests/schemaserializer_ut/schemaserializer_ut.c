...
/* Tests_SRS_SCHEMA_SERIALIZER_01_013: [If the modelHandle argument is NULL, SchemaSerializer_SerializeCommandMetadata
 * shall return SCHEMA_SERIALIZER_INVALID_ARG.] */
...
/* Tests_SRS_SCHEMA_SERIALIZER_01_014: [If the schemaText argument is NULL, SchemaSerializer_SerializeCommandMetadata
 * shall return SCHEMA_SERIALIZER_INVALID_ARG.] */
...
static void
SchemaSerializer_SerializeCommandMetadata_When_Command_Count_Is_0_Should_Yield_An_Empty_Commands_Array_inert_path(
...
/* Tests_SRS_SCHEMA_SERIALIZER_01_001: [SchemaSerializer_SerializeCommandMetadata shall serialize a specific model to a
 * string using JSON as format.] */
/* Tests_SRS_SCHEMA_SERIALIZER_01_002: [Only commands shall be serialized, the properties of a model shall be ignored.]
 */
/* Tests_SRS_SCHEMA_SERIALIZER_01_003: [The output JSON shall have an array, where each array element shall represent a
 * command.] */
/* Tests_SRS_SCHEMA_SERIALIZER_01_011: [The JSON text shall be built into the string indicated by the schemaText
 * argument by using String APIs.] */
/* Tests_SRS_SCHEMA_SERIALIZER_01_012: [On success SchemaSerializer_SerializeCommandMetadata shall return
 * SCHEMA_SERIALIZER_OK.] */
/* Tests_SRS_SCHEMA_SERIALIZER_01_006: [The object for a command shall have a member named Name, whose value shall be
 * the command name as obtained by using Schema APIs.] */
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_When_Command_Count_Is_0_Should_Yield_An_Empty_Commands_Array_happy_path)
{
    // arrange
...
/*negative testing*/
/*Tests_SRS_SCHEMA_SERIALIZER_01_015: [ If any of the Schema or String APIs fail then
 * SchemaSerializer_SerializeCommandMetadata shall return SCHEMA_SERIALIZER_ERROR. ]*/
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_When_Command_Count_Is_0_Should_Yield_An_Empty_Commands_Array_unhappy_paths)
{
    // arrange
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        ...
        SCHEMA_SERIALIZER_RESULT result =
            SchemaSerializer_SerializeCommandMetadata(TEST_MODEL_HANDLE, TEST_STRING_HANDLE);
    ...
    const size_t *argCount)
{
    ...
    STRICT_EXPECTED_CALL(Schema_GetModelActionCount(TEST_MODEL_HANDLE, IGNORED_PTR_ARG))
        .CopyOutArgumentBuffer(2, commandCount, sizeof(*commandCount));
    STRICT_EXPECTED_CALL(Schema_GetModelActionByIndex(TEST_MODEL_HANDLE, 0)).SetReturn(TEST_ACTION_1);
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "{ \"Name\":\""));
    STRICT_EXPECTED_CALL(Schema_GetModelActionName(TEST_ACTION_1)).SetReturn("Action1");
...
TEST_FUNCTION(SchemaSerializer_SerializeCommandMetadata_1_Command_With_No_Arguments_Yields_The_Proper_JSON_happy_path)
{
    ...
    size_t argCount     = 0;
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_No_Arguments_Yields_The_Proper_JSON_inert_path(
        &commandCount,
        &argCount);
 ...
 * SchemaSerializer_SerializeCommandMetadata shall return SCHEMA_SERIALIZER_ERROR. ]*/
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_No_Arguments_Yields_The_Proper_JSON_unhappy_paths)
{
    // arrange
    umock_c_negative_tests_init();
    ...
    const size_t *argCount)
{
    ...
    STRICT_EXPECTED_CALL(Schema_GetModelActionArgumentCount(TEST_ACTION_1, IGNORED_PTR_ARG))
        .CopyOutArgumentBuffer(2, argCount, sizeof(*argCount));
    STRICT_EXPECTED_CALL(Schema_GetModelActionArgumentByIndex(TEST_ACTION_1, 0)).SetReturn(TEST_ARG_1);
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "{\"Name\":\""));
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentName(TEST_ARG_1)).SetReturn("Argument1");
    ...
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentType(TEST_ARG_1)).SetReturn("ascii_char_ptr");
...
/* Tests_SRS_SCHEMA_SERIALIZER_01_008: [The parameters member shall be an array, where each entry is a command
 * parameter.]*/
/* Tests_SRS_SCHEMA_SERIALIZER_01_009: [Each command parameter shall have a member named "Name", that should have as
 * value the command argument name as obtained by using Schema APIs.] */
/* Tests_SRS_SCHEMA_SERIALIZER_01_010: [Each command parameter shall have a member named "Type", that should have as
 * value the command argument type as obtained by using Schema APIs.] */
TEST_FUNCTION(SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Yields_The_Proper_JSON_happy_path)
{
    // arrange
    size_t commandCount = 1;
    size_t argCount     = 1;
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Yields_The_Proper_JSON_inert_path(&commandCount,
                                                                                                          &argCount);
    // act
    SCHEMA_SERIALIZER_RESULT result = SchemaSerializer_SerializeCommandMetadata(TEST_MODEL_HANDLE, TEST_STRING_HANDLE);
...
static void SchemaSerializer_SerializeCommandMetadata_2_Commanda_With_1_Argument_Each_Yields_The_Proper_JSON_inert_path(
    const size_t *commandCount,
    const size_t *argCount)
{
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "["));
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\"}"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "]},"));
    STRICT_EXPECTED_CALL(Schema_GetModelActionByIndex(TEST_MODEL_HANDLE, 1)).SetReturn(TEST_ACTION_2);
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "{ \"Name\":\""));
    STRICT_EXPECTED_CALL(Schema_GetModelActionName(TEST_ACTION_2)).SetReturn("Action2");
    ...
    STRICT_EXPECTED_CALL(Schema_GetModelActionArgumentCount(TEST_ACTION_2, IGNORED_PTR_ARG))
        .CopyOutArgumentBuffer(2, argCount, sizeof(*argCount));
    STRICT_EXPECTED_CALL(Schema_GetModelActionArgumentByIndex(TEST_ACTION_2, 0)).SetReturn(TEST_ARG_1);
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "{\"Name\":\""));
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentName(TEST_ARG_1)).SetReturn("Argument1");
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "Argument1"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\",\"Type\":\""));
 ...
 * value the command argument type as obtained by using Schema APIs.] */
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_2_Commanda_With_1_Argument_Each_Yields_The_Proper_JSON_happy_path)
{
    // arrange
    size_t commandCount = 2;
    size_t argCount     = 1;
    SchemaSerializer_SerializeCommandMetadata_2_Commanda_With_1_Argument_Each_Yields_The_Proper_JSON_inert_path(
        &commandCount,
        &argCount);
 ...
 * SchemaSerializer_SerializeCommandMetadata shall return SCHEMA_SERIALIZER_ERROR. ]*/
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_2_Commanda_With_1_Argument_Each_Yields_The_Proper_JSON_unhappy_paths)
{
    // arrange
    size_t commandCount = 2;
    size_t argCount     = 1;
...
void static SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Different_Than_String_Keeps_The_Same_Type_inert_path(
    const size_t *commandCount,
    const size_t *argCount)
{
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "["));
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "Argument1"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\",\"Type\":\""));
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentType(TEST_ARG_1)).SetReturn("pupu");
...
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Different_Than_String_Keeps_The_Same_Type_happy_path)
{
    // arrange
    size_t commandCount = 1;
    size_t argCount     = 1;

    SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Different_Than_String_Keeps_The_Same_Type_inert_path(
        &commandCount,
        &argCount);
 ...
 * SchemaSerializer_SerializeCommandMetadata shall return SCHEMA_SERIALIZER_ERROR. ]*/
TEST_FUNCTION(
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_1_Argument_Different_Than_String_Keeps_The_Same_Type_unhappy_paths)
{
    // arrange
    size_t commandCount = 1;
    size_t argCount     = 1;
...
static void SchemaSerializer_SerializeCommandMetadata_1_Command_With_2_Arguments_Yields_The_Proper_JSON_inert_path(
    const size_t *commandCount,
    const size_t *argCount)
{
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "["));
    ...
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "string"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\"},"));
    STRICT_EXPECTED_CALL(Schema_GetModelActionArgumentByIndex(TEST_ACTION_1, 1)).SetReturn(TEST_ARG_2);
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "{\"Name\":\""));
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentName(TEST_ARG_2)).SetReturn("Argument2");
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "Argument2"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\",\"Type\":\""));
    STRICT_EXPECTED_CALL(Schema_GetActionArgumentType(TEST_ARG_2)).SetReturn("ascii_char_ptr");
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "string"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "\"}"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "]}"));
    STRICT_EXPECTED_CALL(STRING_concat(TEST_STRING_HANDLE, "]"));
...
TEST_FUNCTION(SchemaSerializer_SerializeCommandMetadata_1_Command_With_2_Arguments_Yields_The_Proper_JSON_happy_path)
{
    ...
    SchemaSerializer_SerializeCommandMetadata_1_Command_With_2_Arguments_Yields_The_Proper_JSON_inert_path(
        &commandCount,
        &argCount);
