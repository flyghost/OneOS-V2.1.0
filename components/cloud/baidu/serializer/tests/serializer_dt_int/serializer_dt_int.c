...
static IOTHUB_CLIENT_RESULT my_IoTHubClient_SetDeviceTwinCallback(IOTHUB_CLIENT_HANDLE               iotHubClientHandle,
...
my_IoTHubClient_LL_SetDeviceTwinCallback(IOTHUB_CLIENT_LL_HANDLE            iotHubClientHandle,
                                         IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK deviceTwinCallback,
                                         void                              *userContextCallback)
{
    (void)(iotHubClientHandle);
...
static IOTHUB_CLIENT_RESULT
my_IoTHubClient_SetDeviceMethodCallback(IOTHUB_CLIENT_HANDLE                       iotHubClientHandle,
...
static IOTHUB_CLIENT_RESULT
my_IoTHubClient_LL_SetDeviceMethodCallback(IOTHUB_CLIENT_LL_HANDLE                    iotHubClientHandle,
                                           IOTHUB_CLIENT_DEVICE_METHOD_CALLBACK_ASYNC deviceMethodCallback,
                                           void                                      *userContextCallback)
{
    (void)(iotHubClientHandle);
...
static IOTHUB_CLIENT_RESULT
my_IoTHubClient_SendReportedState(IOTHUB_CLIENT_HANDLE                  iotHubClientHandle,
...
static IOTHUB_CLIENT_RESULT
my_IoTHubClient_LL_SendReportedState(IOTHUB_CLIENT_LL_HANDLE               iotHubClientHandle,
                                     const unsigned char                  *reportedState,
                                     size_t                                size,
                                     IOTHUB_CLIENT_REPORTED_STATE_CALLBACK reportedStateCallback,
                                     void                                 *userContextCallback)
...
TEST_FUNCTION(SERIALIZER_DT_AUTOMATICALLY_SUBSCRIBED_TO_DEVICETWIN_AND_METHODS_SUCCEEDS)
{
    ...
    STRICT_EXPECTED_CALL(
        IoTHubClient_SetDeviceTwinCallback(TEST_IOTHUB_CLIENT_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_deviceTwinCallback()
        .IgnoreArgument_userContextCallback();

    STRICT_EXPECTED_CALL(
        IoTHubClient_SetDeviceMethodCallback(TEST_IOTHUB_CLIENT_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
...
TEST_FUNCTION(SERIALIZER_DT_AUTOMATICALLY_SUBSCRIBED_TO_DEVICETWIN_AND_METHODS_LL_SUCCEEDS)
{
    ...
    STRICT_EXPECTED_CALL(
        IoTHubClient_LL_SetDeviceTwinCallback(TEST_IOTHUB_CLIENT_LL_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_deviceTwinCallback()
        .IgnoreArgument_userContextCallback();

    STRICT_EXPECTED_CALL(
        IoTHubClient_LL_SetDeviceMethodCallback(TEST_IOTHUB_CLIENT_LL_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
        .IgnoreArgument_deviceMethodCallback()
        .IgnoreArgument_userContextCallback();
...
TEST_FUNCTION(SERIALIZER_DT_AUTOMATICALLY_SUBSCRIBED_TO_DEVICETWIN_AND_RECEIVES_DESIRED_PROPERTY_SUCCEEDS)
{
    ...
    /// act
    g_SerializerIngest_fp(DEVICE_TWIN_UPDATE_COMPLETE,
                          (const unsigned char *)inputJsonAsString,
                          strlen(inputJsonAsString),
                          modelWithData);
...
TEST_FUNCTION(SERIALIZER_DT_AUTOMATICALLY_SUBSCRIBED_TO_DEVICETWIN_AND_RECEIVES_DESIRED_PROPERTY_LL_SUCCEEDS)
{
    ...
    basicModel_WithData15 *modelWithData =
        IoTHubDeviceTwin_LL_CreatebasicModel_WithData15(TEST_IOTHUB_CLIENT_LL_HANDLE);
...
TEST_FUNCTION(SERIALIZER_DT_AUTOMATICALLY_SUBSCRIBED_TO_DEVICETWIN_AND_RECEIVES_PARTIAL_DESIRED_PROPERTY_SUCCEEDS)
{
    ...
    /// act
    g_SerializerIngest_fp(DEVICE_TWIN_UPDATE_PARTIAL,
                          (const unsigned char *)inputJsonAsString,
                          strlen(inputJsonAsString),
                          modelWithData);
...
TEST_FUNCTION(SERIALIZER_DT_RECEIVES_AND_EXECUTES_A_METHOD)
{
    ...
    /// act
    int r = g_deviceMethodCallback_fp("methodA",
                                      (const unsigned char *)inputJsonAsString,
                                      strlen(inputJsonAsString),
                                      &result,
                                      &result_size,
                                      g_deviceMethodCallback_userContextCallback);
...
TEST_FUNCTION(SERIALIZER_DT_SENDREPORTEDSTATE_SUCCEEDS_CONVENIENCE)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_SendReportedState(TEST_IOTHUB_CLIENT_HANDLE,
                                                        IGNORED_PTR_ARG,
                                                        IGNORED_NUM_ARG,
    ...
    IOTHUB_CLIENT_RESULT r =
        IoTHubDeviceTwin_SendReportedStatebasicModel_WithData15(modelWithData, sendReportedStateCallback, (void *)0x44);
...
TEST_FUNCTION(SERIALIZER_DT_SENDREPORTEDSTATE_SUCCEEDS_LL)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_LL_SendReportedState(TEST_IOTHUB_CLIENT_LL_HANDLE,
                                                           IGNORED_PTR_ARG,
                                                           IGNORED_NUM_ARG,
                                                           sendReportedStateCallback,
                                                           (void *)0x44))
    ...
    /// act
    IOTHUB_CLIENT_RESULT r = IoTHubDeviceTwin_LL_SendReportedStatebasicModel_WithData15(modelWithData,
                                                                                        sendReportedStateCallback,
                                                                                        (void *)0x44);
