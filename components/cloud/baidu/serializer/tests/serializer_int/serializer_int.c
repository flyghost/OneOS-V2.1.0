...
DECLARE_STRUCT(struct_WithData2,
               ...
               with_data_bool2,
               ascii_char_ptr,
               with_data_ascii_char_ptr2,
               ascii_char_ptr_no_quotes,
               with_data_ascii_char_ptr_no_quotes2,
               EDM_DATE_TIME_OFFSET,
               with_data_EdmDateTimeOffset2,
               EDM_GUID,
               with_data_EdmGuid2,
               EDM_BINARY,
               with_data_EdmBinary2)
DECLARE_MODEL(basicModel_WithStruct2, WITH_DATA(struct_WithData2, structure2))
...
DECLARE_MODEL(basicModel_WithModel3, WITH_DATA(model_WithData3, model3))
...
DECLARE_STRUCT(struct_WithData4,
               ...
               with_data_bool4,
               ascii_char_ptr,
               with_data_ascii_char_ptr4,
               ascii_char_ptr_no_quotes,
               with_data_ascii_char_ptr_no_quotes4,
               EDM_DATE_TIME_OFFSET,
               with_data_EdmDateTimeOffset4,
               EDM_GUID,
               with_data_EdmGuid4,
               EDM_BINARY,
               with_data_EdmBinary4)
DECLARE_MODEL(innerModel4, WITH_DATA(struct_WithData4, structure4))
DECLARE_MODEL(outerModel4, WITH_DATA(innerModel4, inner_model4))
...
DECLARE_STRUCT(struct_WithReportedPropery6,
               double,
               with_reported_property_double6,
               int,
               with_reported_property_int6,
               float,
               with_reported_property_float6,
               long,
               with_reported_property_long6,
               int8_t,
               with_reported_property_sint8_t6,
               uint8_t,
               with_reported_property_uint8_t6,
               int16_t,
               with_reported_property_int16_t6,
               int32_t,
               with_reported_property_int32_t6,
               int64_t,
               with_reported_property_int64_t6,
               bool,
               with_reported_property_bool6,
               ascii_char_ptr,
               with_reported_property_ascii_char_ptr6,
               ascii_char_ptr_no_quotes,
               with_reported_property_ascii_char_ptr_no_quotes6,
               EDM_DATE_TIME_OFFSET,
               with_reported_property_EdmDateTimeOffset6,
               EDM_GUID,
               with_reported_property_EdmGuid6,
               EDM_BINARY,
               with_reported_property_EdmBinary6)
DECLARE_MODEL(basicModel_WithStruct6, WITH_REPORTED_PROPERTY(struct_WithReportedPropery6, structure6))
...
DECLARE_MODEL(basicModel_WithReportedProperty7, WITH_REPORTED_PROPERTY(model_WithReported7, model7))
...
DECLARE_STRUCT(struct_WithData8,
               double,
               with_reported_property_double8,
               int,
               with_reported_property_int8,
               float,
               with_reported_property_float8,
               long,
               with_reported_property_long8,
               int8_t,
               with_reported_property_sint8_t8,
               uint8_t,
               with_reported_property_uint8_t8,
               int16_t,
               with_reported_property_int16_t8,
               int32_t,
               with_reported_property_int32_t8,
               int64_t,
               with_reported_property_int64_t8,
               bool,
               with_reported_property_bool8,
               ascii_char_ptr,
               with_reported_property_ascii_char_ptr8,
               ascii_char_ptr_no_quotes,
               with_reported_property_ascii_char_ptr_no_quotes8,
               EDM_DATE_TIME_OFFSET,
               with_reported_property_EdmDateTimeOffset8,
               EDM_GUID,
               with_reported_property_EdmGuid8,
               EDM_BINARY,
               with_reported_property_EdmBinary8)
DECLARE_MODEL(innerModel8, WITH_REPORTED_PROPERTY(struct_WithData8, structure8))
DECLARE_MODEL(outerModel8, WITH_REPORTED_PROPERTY(innerModel8, inner_model8))
...
DECLARE_STRUCT(struct_WithData10,
               double,
               with_desired_property_double10,
               int,
               with_desired_property_int10,
               float,
               with_desired_property_float10,
               long,
               with_desired_property_long10,
               int8_t,
               with_desired_property_sint8_t10,
               uint8_t,
               with_desired_property_uint8_t10,
               int16_t,
               with_desired_property_int16_t10,
               int32_t,
               with_desired_property_int32_t10,
               int64_t,
               with_desired_property_int64_t10,
               bool,
               with_desired_property_bool10,
               ascii_char_ptr,
               with_desired_property_ascii_char_ptr10,
               ascii_char_ptr_no_quotes,
               with_desired_property_ascii_char_ptr_no_quotes10,
               EDM_DATE_TIME_OFFSET,
               with_desired_property_EdmDateTimeOffset10,
               EDM_GUID,
               with_desired_property_EdmGuid10,
               EDM_BINARY,
               with_desired_property_EdmBinary10)
DECLARE_MODEL(basicModel_WithStruct10, WITH_DESIRED_PROPERTY(struct_WithData10, structure10))
...
DECLARE_MODEL(basicModel_WithModel11, WITH_DESIRED_PROPERTY(model_WithData11, model11))
...
DECLARE_STRUCT(struct_WithData12,
               double,
               with_desired_property_double12,
               int,
               with_desired_property_int12,
               float,
               with_desired_property_float12,
               long,
               with_desired_property_long12,
               int8_t,
               with_desired_property_sint8_t12,
               uint8_t,
               with_desired_property_uint8_t12,
               int16_t,
               with_desired_property_int16_t12,
               int32_t,
               with_desired_property_int32_t12,
               int64_t,
               with_desired_property_int64_t12,
               bool,
               with_desired_property_bool12,
               ascii_char_ptr,
               with_desired_property_ascii_char_ptr12,
               ascii_char_ptr_no_quotes,
               with_desired_property_ascii_char_ptr_no_quotes12,
               EDM_DATE_TIME_OFFSET,
               with_desired_property_EdmDateTimeOffset12,
               EDM_GUID,
               with_desired_property_EdmGuid12,
               EDM_BINARY,
               with_desired_property_EdmBinary12)
DECLARE_MODEL(innerModel12, WITH_DESIRED_PROPERTY(struct_WithData12, structure12))
DECLARE_MODEL(outerModel12, WITH_DESIRED_PROPERTY(innerModel12, inner_model12))
...
DECLARE_MODEL(outerModel14, WITH_DATA(model_WithAction14, modelAction14));
...
DECLARE_MODEL(basicModel_WithData15,
              ...
              WITH_DESIRED_PROPERTY(ascii_char_ptr,
                                    with_desired_property_ascii_char_ptr15,
                                    on_desired_property_ascii_char_ptr15),
              WITH_DESIRED_PROPERTY(ascii_char_ptr_no_quotes,
                                    with_desired_property_ascii_char_ptr_no_quotes15,
                                    on_desired_property_ascii_char_ptr_no_quotes15),
              WITH_DESIRED_PROPERTY(EDM_DATE_TIME_OFFSET,
                                    with_desired_property_EdmDateTimeOffset15,
                                    on_desired_property_EdmDateTimeOffset15),
...
DECLARE_STRUCT(struct_WithData16,
               double,
               with_desired_property_double16,
               int,
               with_desired_property_int16,
               float,
               with_desired_property_float16,
               long,
               with_desired_property_long16,
               int8_t,
               with_desired_property_sint8_t16,
               uint8_t,
               with_desired_property_uint8_t16,
               int16_t,
               with_desired_property_int16_t16,
               int32_t,
               with_desired_property_int32_t16,
               int64_t,
               with_desired_property_int64_t16,
               bool,
               with_desired_property_bool16,
               ascii_char_ptr,
               with_desired_property_ascii_char_ptr16,
               ascii_char_ptr_no_quotes,
               with_desired_property_ascii_char_ptr_no_quotes16,
               EDM_DATE_TIME_OFFSET,
               with_desired_property_EdmDateTimeOffset16,
               EDM_GUID,
               with_desired_property_EdmGuid16,
               EDM_BINARY,
               with_desired_property_EdmBinary16)
DECLARE_MODEL(innerModel16, WITH_DESIRED_PROPERTY(struct_WithData16, structure16, on_structure16))
DECLARE_MODEL(outerModel16, WITH_DESIRED_PROPERTY(innerModel16, inner_model16, on_inner_model16))
...
DECLARE_STRUCT(totallyNotUnique, double, totallyNotUnique)
DECLARE_MODEL(totallyNotUnique_model1, WITH_DATA(totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model3, WITH_ACTION(A, totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model4, WITH_REPORTED_PROPERTY(totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model6, WITH_DESIRED_PROPERTY(totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model7, WITH_DATA(totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model8, WITH_ACTION(A2, totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model9, WITH_REPORTED_PROPERTY(totallyNotUnique, tnu))

DECLARE_MODEL(totallyNotUnique_model10, WITH_DESIRED_PROPERTY(totallyNotUnique, tnu))
...
DECLARE_MODEL(outerModel19, WITH_DATA(model_WithMethod19, modelMethod19));
...
DECLARE_MODEL(model_WithMethod20, WITH_METHOD(method20));

DECLARE_MODEL(outerModel20, WITH_DATA(model_WithMethod20, modelMethod20));
...
static bool areTwoJsonsEqual(const unsigned char *left, size_t leftSize, const char *right)
{
    ...
    char *cloneOfLeft =
        (char *)malloc(leftSize + 1); /*because of out SERIALIZE... there is a byte array that is NOT '\0' terminated*/
...
{
    /// arrange
    basicModel_WithReportedProperty5 *modelWithReportedProperty =
        CREATE_MODEL_INSTANCE(basic5, basicModel_WithReportedProperty5, true);
...
{
    /// arrange
    basicModel_WithReportedProperty7 *basicModel_WithModel =
        CREATE_MODEL_INSTANCE(basic7, basicModel_WithReportedProperty7, true);
...
TEST_FUNCTION(WITH_DESIRED_PROPERTY_IN_STRUCT_IN_ROOT_MODEL)
{
    ...
    ASSERT_ARE_EQUAL(char_ptr,
                     "\"twelve\"",
                     modelWithData->structure10.with_desired_property_ascii_char_ptr_no_quotes10);
    ...
    ASSERT_ARE_EQUAL(uint8_t,
                     1,
                     modelWithData->structure10.with_desired_property_EdmDateTimeOffset10.hasFractionalSecond);
    ASSERT_ARE_EQUAL(uint64_t,
                     5,
                     modelWithData->structure10.with_desired_property_EdmDateTimeOffset10.fractionalSecond);
...
TEST_FUNCTION(WITH_DESIRED_PROPERTY_IN_STRUCT_IN_MODEL_IN_MODEL)
{
    ...
    ASSERT_ARE_EQUAL(char_ptr,
                     "e/leven",
                     modelWithData->inner_model12.structure12.with_desired_property_ascii_char_ptr12);
    ASSERT_ARE_EQUAL(char_ptr,
                     "\"twelve\"",
                     modelWithData->inner_model12.structure12.with_desired_property_ascii_char_ptr_no_quotes12);
    ASSERT_ARE_EQUAL(
        int,
        114,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_year);
    ASSERT_ARE_EQUAL(
        int,
        6 - 1,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_mon);
    ASSERT_ARE_EQUAL(
        int,
        17,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_mday);
    ASSERT_ARE_EQUAL(
        int,
        8,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_hour);
    ASSERT_ARE_EQUAL(
        int,
        51,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_min);
    ASSERT_ARE_EQUAL(
        int,
        23,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.dateTime.tm_sec);
    ASSERT_ARE_EQUAL(
        uint8_t,
        1,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.hasFractionalSecond);
    ASSERT_ARE_EQUAL(
        uint64_t,
        5,
        modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.fractionalSecond);
    ASSERT_ARE_EQUAL(uint8_t,
                     1,
                     modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.hasTimeZone);
    ASSERT_ARE_EQUAL(int8_t,
                     -8,
                     modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.timeZoneHour);
    ASSERT_ARE_EQUAL(uint8_t,
                     1,
                     modelWithData->inner_model12.structure12.with_desired_property_EdmDateTimeOffset12.timeZoneMinute);
...
TEST_FUNCTION(WITH_ACTION_IN_ROOT_MODEL)
{
    ...
    CODEFIRST_RESULT result =
        (EXECUTE_COMMAND(modelWithData, inputJsonAsString) == EXECUTE_COMMAND_SUCCESS) ? CODEFIRST_OK : CODEFIRST_ERROR;
...
/*Tests_SRS_CODEFIRST_02_036: [ CodeFirst_CreateDevice shall initialize all the desired properties to their default
 * values. ]*/
...
/*this function tests that a regular desired properties of a model can have a desired property callback that is
 * invoked*/
...
TEST_FUNCTION(WITH_DESIRED_PROPERTY_IN_STRUCT_IN_MODEL_IN_MODEL_DESIRED_PROPERTY_CALLBACK)
{
    ...
    ASSERT_ARE_EQUAL(char_ptr,
                     "e/leven",
                     modelWithData->inner_model16.structure16.with_desired_property_ascii_char_ptr16);
    ASSERT_ARE_EQUAL(char_ptr,
                     "\"twelve\"",
                     modelWithData->inner_model16.structure16.with_desired_property_ascii_char_ptr_no_quotes16);
    ASSERT_ARE_EQUAL(
        int,
        114,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_year);
    ASSERT_ARE_EQUAL(
        int,
        6 - 1,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_mon);
    ASSERT_ARE_EQUAL(
        int,
        17,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_mday);
    ASSERT_ARE_EQUAL(
        int,
        8,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_hour);
    ASSERT_ARE_EQUAL(
        int,
        51,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_min);
    ASSERT_ARE_EQUAL(
        int,
        23,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.dateTime.tm_sec);
    ASSERT_ARE_EQUAL(
        uint8_t,
        1,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.hasFractionalSecond);
    ASSERT_ARE_EQUAL(
        uint64_t,
        5,
        modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.fractionalSecond);
    ASSERT_ARE_EQUAL(uint8_t,
                     1,
                     modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.hasTimeZone);
    ASSERT_ARE_EQUAL(int8_t,
                     -8,
                     modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.timeZoneHour);
    ASSERT_ARE_EQUAL(uint8_t,
                     1,
                     modelWithData->inner_model16.structure16.with_desired_property_EdmDateTimeOffset16.timeZoneMinute);
