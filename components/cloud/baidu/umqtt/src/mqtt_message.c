...
MQTT_MESSAGE_HANDLE mqttmessage_create_in_place(uint16_t       packetId,
                                                const char    *topicName,
                                                QOS_VALUE      qosValue,
                                                const uint8_t *appMsg,
                                                size_t         appMsgLength)
{
    /* Codes_SRS_MQTTMESSAGE_07_026: [If the parameters topicName is NULL then mqttmessage_create_in_place shall return
     * NULL.].] */
    MQTT_MESSAGE *result;
    if (topicName == NULL)
    {
    ...
    else
    {
        ...
        {
            /* Codes_SRS_MQTTMESSAGE_07_028: [If any memory allocation fails mqttmessage_create_in_place shall free any
             * allocated memory and return NULL.] */
            LogError("Failure unable to allocate MQTT Message.");
        }
    }
    /* Codes_SRS_MQTTMESSAGE_07_029: [ Upon success, mqttmessage_create_in_place shall return a NON-NULL
     * MQTT_MESSAGE_HANDLE value.] */
    return (MQTT_MESSAGE_HANDLE)result;
}

MQTT_MESSAGE_HANDLE mqttmessage_create(uint16_t       packetId,
                                       const char    *topicName,
                                       QOS_VALUE      qosValue,
                                       const uint8_t *appMsg,
                                       size_t         appMsgLength)
{
    /* Codes_SRS_MQTTMESSAGE_07_001:[If the parameters topicName is NULL is zero then mqttmessage_create shall return
     * NULL.] */
    MQTT_MESSAGE *result;
    if (topicName == NULL)
    {
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_002: [mqttmessage_create shall allocate and copy the topicName and appMsg
         * parameters.] */
        result = malloc(sizeof(MQTT_MESSAGE));
        if (result != NULL)
        {
            ...
            {
                /* Codes_SRS_MQTTMESSAGE_07_003: [If any memory allocation fails mqttmessage_create shall free any
                 * allocated memory and return NULL.] */
            ...
            else
            {
                ...
                if (result->appPayload.length > 0)
                {
                    ...
                    {
                        /* Codes_SRS_MQTTMESSAGE_07_003: [If any memory allocation fails mqttmessage_create shall free
                         * any allocated memory and return NULL.] */
    ...
    /* Codes_SRS_MQTTMESSAGE_07_004: [If mqttmessage_createMessage succeeds the it shall return a NON-NULL
     * MQTT_MESSAGE_HANDLE value.] */
    return (MQTT_MESSAGE_HANDLE)result;
}
...
void mqttmessage_destroy(MQTT_MESSAGE_HANDLE handle)
{
    ...
    if (msgInfo != NULL)
    {
        /* Codes_SRS_MQTTMESSAGE_07_006: [mqttmessage_destroyMessage shall free all resources associated with the
         * MQTT_MESSAGE_HANDLE value] */
...
MQTT_MESSAGE_HANDLE mqttmessage_clone(MQTT_MESSAGE_HANDLE handle)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_008: [mqttmessage_clone shall create a new MQTT_MESSAGE_HANDLE with data content
         * identical of the handle value.] */
        MQTT_MESSAGE *mqtt_message = (MQTT_MESSAGE *)handle;
        result                     = mqttmessage_create(mqtt_message->packetId,
                                    mqtt_message->topicName,
                                    mqtt_message->qosInfo,
                                    mqtt_message->appPayload.message,
                                    mqtt_message->appPayload.length);
        if (result != NULL)
        {
...
uint16_t mqttmessage_getPacketId(MQTT_MESSAGE_HANDLE handle)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_011: [mqttmessage_getPacketId shall return the packetId value contained in
...
const char *mqttmessage_getTopicName(MQTT_MESSAGE_HANDLE handle)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_013: [mqttmessage_getTopicName shall return the topicName contained in
         * MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo = (MQTT_MESSAGE *)handle;
        if (msgInfo->topicName == NULL)
        {
...
QOS_VALUE mqttmessage_getQosType(MQTT_MESSAGE_HANDLE handle)
{
    ...
    if (handle == NULL)
    {
        /* Codes_SRS_MQTTMESSAGE_07_014: [If handle is NULL then mqttmessage_getQosType shall return the default
         * DELIVER_AT_MOST_ONCE value.] */
        LogError("Invalid Parameter handle: %p.", handle);
        result = DELIVER_AT_MOST_ONCE;
    }
    else
    {
        /* Codes_SRS_MQTTMESSAGE_07_015: [mqttmessage_getQosType shall return the QOS Type value contained in
         * MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo = (MQTT_MESSAGE *)handle;
...
bool mqttmessage_getIsDuplicateMsg(MQTT_MESSAGE_HANDLE handle)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_017: [mqttmessage_getIsDuplicateMsg shall return the isDuplicateMsg value contained
         * in MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo = (MQTT_MESSAGE *)handle;
...
bool mqttmessage_getIsRetained(MQTT_MESSAGE_HANDLE handle)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_019: [mqttmessage_getIsRetained shall return the isRetained value contained in
         * MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo = (MQTT_MESSAGE *)handle;
...
{
    int result;
    /* Codes_SRS_MQTTMESSAGE_07_022: [If handle is NULL then mqttmessage_setIsDuplicateMsg shall return a non-zero
     * value.] */
    if (handle == NULL)
    {
        LogError("Invalid Parameter handle: %p.", handle);
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_023: [mqttmessage_setIsDuplicateMsg shall store the duplicateMsg value in the
         * MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo   = (MQTT_MESSAGE *)handle;
...
int mqttmessage_setIsRetained(MQTT_MESSAGE_HANDLE handle, bool retainMsg)
{
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_025: [mqttmessage_setIsRetained shall store the retainMsg value in the
         * MQTT_MESSAGE_HANDLE handle.] */
        MQTT_MESSAGE *msgInfo      = (MQTT_MESSAGE *)handle;
...
const APP_PAYLOAD *mqttmessage_getApplicationMsg(MQTT_MESSAGE_HANDLE handle)
{
    ...
    if (handle == NULL)
    {
        /* Codes_SRS_MQTTMESSAGE_07_020: [If handle is NULL or if msgLen is 0 then mqttmessage_getApplicationMsg shall
         * return NULL.] */
        LogError("Invalid Parameter handle: %p.", handle);
        result = NULL;
    }
    ...
    {
        /* Codes_SRS_MQTTMESSAGE_07_021: [mqttmessage_getApplicationMsg shall return the applicationMsg value contained
         * in MQTT_MESSAGE_HANDLE handle and the length of the appMsg in the msgLen parameter.] */
        MQTT_MESSAGE *msgInfo = (MQTT_MESSAGE *)handle;
