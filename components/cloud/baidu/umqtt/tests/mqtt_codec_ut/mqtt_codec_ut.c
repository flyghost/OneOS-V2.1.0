...
static const char *TEST_PASSWORD = "SharedAccessSignature "
                                   "sr=iot-sdks-test.azure-devices.net&sig=VT%2bGaJ72cpMojDbR6l81ubjORboMY97fb3%"
                                   "2bzoRQtf6g%3d&se=1484433462&skn=iothubowner";

static SUBSCRIBE_PAYLOAD TEST_SUBSCRIBE_PAYLOAD[]    = {{"subTopic1", DELIVER_AT_LEAST_ONCE},
                                                     {"subTopic2", DELIVER_EXACTLY_ONCE}};
...
static void SetupMqttLibOptions(MQTT_CLIENT_OPTIONS *options,
                                const char          *clientId,
                                const char          *willMsg,
...
/* Tests_SRS_MQTT_CODEC_07_008: [If the parameters mqttOptions is NULL then mqtt_codec_connect shall return a null
 * value.] */
...
TEST_FUNCTION(mqtt_codec_connect_BUFFER_enlarge_fail)
{
    ...
    SetupMqttLibOptions(&mqttOptions,
                        TEST_CLIENT_ID,
                        NULL,
                        NULL,
                        "testuser",
...
TEST_FUNCTION(mqtt_codec_connect_second_succeeds)
{
    ...
    const unsigned char CONNECT_VALUE[] = {0x10, 0x36, 0x00, 0x04, 0x4d, 0x51, 0x54, 0x54, 0x04, 0x26, 0x00, 0x14,
                                           0x00, 0x14, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x5f, 0x74, 0x68, 0x72,
                                           0x65, 0x61, 0x64, 0x65, 0x64, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x00, 0x0a,
                                           0x57, 0x69, 0x6c, 0x6c, 0x20, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x00, 0x08,
                                           0x57, 0x69, 0x6c, 0x6c, 0x20, 0x4d, 0x73, 0x67};
...
/* Tests_SRS_MQTT_CODEC_07_009: [mqtt_codec_connect shall construct a BUFFER_HANDLE that represents a MQTT CONNECT
 * packet.] */
TEST_FUNCTION(mqtt_codec_connect_succeeds)
{
    ...
    const unsigned char CONNECT_VALUE[] = {0x10, 0x38, 0x00, 0x04, 0x4d, 0x51, 0x54, 0x54, 0x04, 0xc2, 0x00, 0x14,
                                           0x00, 0x14, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x5f, 0x74, 0x68, 0x72,
                                           0x65, 0x61, 0x64, 0x65, 0x64, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x00, 0x08,
                                           0x74, 0x65, 0x73, 0x74, 0x75, 0x73, 0x65, 0x72, 0x00, 0x0c, 0x74, 0x65,
                                           0x73, 0x74, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64};
...
TEST_FUNCTION(mqtt_codec_connect_no_password_succeeds)
{
    ...
    const unsigned char CONNECT_VALUE[] = {0x10, 0x2a, 0x00, 0x04, 0x4d, 0x51, 0x54, 0x54, 0x04, 0x82, 0x00, 0x14,
                                           0x00, 0x14, 0x73, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x5f, 0x74, 0x68, 0x72,
                                           0x65, 0x61, 0x64, 0x65, 0x64, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x00, 0x08,
                                           0x74, 0x65, 0x73, 0x74, 0x75, 0x73, 0x65, 0x72, 0x00, 0x00};
...
TEST_FUNCTION(mqtt_codec_connect_Large_Data_succeeds)
{
    ...
    SetupMqttLibOptions(&mqttOptions,
                        ...
                        NULL,
                        NULL,
                        "testuser.testusersuffix/deviceId",
                        TEST_PASSWORD,
                        20,
                        false,
                        true,
    ...
    const unsigned char CONNECT_VALUE[] = {
        };
...
/* Tests_SRS_MQTT_CODEC_07_011: [On success mqtt_codec_disconnect shall construct a BUFFER_HANDLE that represents a MQTT
 * DISCONNECT packet.] */
...
/* Tests_SRS_MQTT_CODEC_07_021: [On success mqtt_codec_ping shall construct a BUFFER_HANDLE that represents a MQTT
 * PINGREQ packet.] */
...
TEST_FUNCTION(mqtt_codec_publish_topicName_NULL_fail)
{
    ...
    // act
    BUFFER_HANDLE handle = mqtt_codec_publish(DELIVER_AT_MOST_ONCE,
                                              true,
                                              false,
                                              TEST_PACKET_ID,
                                              NULL,
...
/* Tests_SRS_CONTROL_PACKET_07_052: [mqtt_codec_publish shall constuct the MQTT variable header and shall return a
...
TEST_FUNCTION(mqtt_codec_publish_BUFFER_enlarge_fails)
{
    ...
    // act
    BUFFER_HANDLE handle = mqtt_codec_publish(DELIVER_AT_LEAST_ONCE,
                                              true,
                                              false,
                                              TEST_PACKET_ID,
                                              TEST_TOPIC_NAME,
...
{
    // arrange
    const unsigned char PUBLISH_VALUE[] =
        {0x38, 0x0c, 0x00, 0x0a, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x20, 0x4e, 0x61, 0x6d, 0x65};
    ...
    BUFFER_HANDLE handle =
        mqtt_codec_publish(DELIVER_AT_MOST_ONCE, true, false, TEST_PACKET_ID, TEST_TOPIC_NAME, NULL, 0, NULL);
...
/* Tests_SRS_MQTT_CODEC_07_007: [mqtt_codec_publish shall return a BUFFER_HANDLE that represents a MQTT PUBLISH
 * message.] */
TEST_FUNCTION(mqtt_codec_publish_succeeds)
{
    // arrange
    const unsigned char PUBLISH_VALUE[] = {0x3a, 0x1d, 0x00, 0x0a, 0x74, 0x6f, 0x70, 0x69, 0x63, 0x20, 0x4e,
                                           0x61, 0x6d, 0x65, 0x12, 0x34, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
                                           0x65, 0x20, 0x74, 0x6f, 0x20, 0x73, 0x65, 0x6e, 0x64};
...
{
    // arrange
    const unsigned char PUBLISH_VALUE[] = {0x30, 0x1c, 0x00, 0x04, 0x6d, 0x73, 0x67, 0x41, 0x54, 0x68,
                                           0x69, 0x73, 0x20, 0x69, 0x73, 0x20, 0x74, 0x68, 0x65, 0x20,
                                           0x61, 0x70, 0x70, 0x20, 0x6d, 0x73, 0x67, 0x20, 0x41, 0x2e};
    ...
    // act
    BUFFER_HANDLE handle =
        mqtt_codec_publish(DELIVER_AT_MOST_ONCE, false, false, 12, TOPIC_NAME_A, APP_NAME_A, APP_NAME_A_LEN, NULL);
...
/* Tests_SRS_MQTT_CODEC_07_013: [On success mqtt_codec_publishAck shall return a BUFFER_HANDLE representation of a MQTT
 * PUBACK packet.] */
TEST_FUNCTION(mqtt_codec_publish_ack_pre_build_fail)
{
    // arrange
    EXPECTED_CALL(BUFFER_new());
    STRICT_EXPECTED_CALL(BUFFER_pre_build(IGNORED_PTR_ARG, 4)).IgnoreArgument(1).SetReturn(__FAILURE__);
    EXPECTED_CALL(BUFFER_delete(IGNORED_PTR_ARG));
...
/* Codes_SRS_MQTT_CODEC_07_036: [mqtt_codec_publish shall return NULL if the buffLen variable is greater than the
 * MAX_SEND_SIZE (0xFFFFFF7F).] */
...
TEST_FUNCTION(mqtt_codec_publish_ack_succeeds)
{
    ...
    EXPECTED_CALL(BUFFER_new());
    STRICT_EXPECTED_CALL(BUFFER_pre_build(IGNORED_PTR_ARG, 4)).IgnoreArgument(1);
    EXPECTED_CALL(BUFFER_u_char(IGNORED_PTR_ARG));
    EXPECTED_CALL(BUFFER_length(IGNORED_PTR_ARG));
...
/* Codes_SRS_MQTT_CODEC_07_015: [On success mqtt_codec_publishRecieved shall return a BUFFER_HANDLE representation of a
 * MQTT PUBREC packet.] */
...
/* Codes_SRS_MQTT_CODEC_07_017: [On success mqtt_codec_publishRelease shall return a BUFFER_HANDLE representation of a
 * MQTT PUBREL packet.] */
...
/* Codes_SRS_MQTT_CODEC_07_019: [On success mqtt_codec_publishComplete shall return a BUFFER_HANDLE representation of a
 * MQTT PUBCOMP packet.] */
...
/* Codes_SRS_MQTT_CODEC_07_023: [If the parameters subscribeList is NULL or if count is 0 then mqtt_codec_subscribe
 * shall return NULL.] */
...
/* Codes_SRS_MQTT_CODEC_07_026: [mqtt_codec_subscribe shall return a BUFFER_HANDLE that represents a MQTT SUBSCRIBE
 * message.]*/
...
{
    // arrange
    unsigned char SUBSCRIBE_VALUE[] = {0x82, 0x1a, 0x12, 0x34, 0x00, 0x09, 0x73, 0x75, 0x62, 0x54,
                                       0x6f, 0x70, 0x69, 0x63, 0x31, 0x01, 0x00, 0x09, 0x73, 0x75,
                                       0x62, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x32, 0x02};
...
/* Codes_SRS_MQTT_CODEC_07_027: [If the parameters unsubscribeList is NULL or if count is 0 then mqtt_codec_unsubscribe
 * shall return NULL.] */
...
/* Codes_SRS_MQTT_CODEC_07_030: [mqtt_codec_unsubscribe shall return a BUFFER_HANDLE that represents a MQTT SUBSCRIBE
 * message.] */
TEST_FUNCTION(mqtt_codec_unsubscribe_succeeds)
{
    // arrange
    unsigned char UNSUBSCRIBE_VALUE[] = {0xa2, 0x18, 0x12, 0x34, 0x00, 0x09, 0x73, 0x75, 0x62, 0x54, 0x6f, 0x70, 0x69,
                                         0x63, 0x31, 0x00, 0x09, 0x73, 0x75, 0x62, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x32};
...
TEST_FUNCTION(mqtt_codec_unsubscribe_trace_succeeds)
{
    ...
    // act
    BUFFER_HANDLE handle =
        mqtt_codec_unsubscribe(TEST_PACKET_ID, TEST_UNSUBSCRIPTION_TOPIC, 2, TEST_TRACE_STRING_HANDLE);
...
/* Codes_SRS_MQTT_CODEC_07_031: [If the parameters handle or buffer is NULL then mqtt_codec_bytesReceived shall return a
 * non-zero value.] */
...
/* Codes_SRS_MQTT_CODEC_07_032: [If the parameters size is zero then mqtt_codec_bytesReceived shall return a non-zero
 * value.] */
...
/* Codes_SRS_MQTT_CODEC_07_035: [ If any error is encountered then the packet state will be marked as error and
 * mqtt_codec_bytesReceived shall return a non-zero value. ] */
...
/* Codes_SRS_MQTT_CODEC_07_033: [mqtt_codec_bytesReceived constructs a sequence of bytes into the corresponding MQTT
 * packets and on success returns zero.] */
/* Codes_SRS_MQTT_CODEC_07_034: [Upon a constructing a complete MQTT packet mqtt_codec_bytesReceived shall call the
 * ON_PACKET_COMPLETE_CALLBACK function.] */
...
TEST_FUNCTION(mqtt_codec_bytesReceived_publish_2_succeed)
{
    ...
    // arrange
    unsigned char PUBLISH_RESP_1[] = { 0x30, 0x7f, 0x00, 0x04, 0x6d, 0x73, 0x67, 0x42, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41 }; unsigned char PUBLISH_RESP_2[] = { 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41, 0x41,
0x41 }; unsigned char PUBLISH_RESP_3[] = { 0x41 };

    unsigned char PUBLISH_RESULT[] = {  }; size_t length =
sizeof(PUBLISH_RESULT) / sizeof(PUBLISH_RESULT[0]);
...
TEST_FUNCTION(mqtt_codec_bytesReceived_publish_long_message_succeed)
{
    ...
    unsigned char PUBLISH[] = {
        
    };
...
TEST_FUNCTION(mqtt_codec_bytesReceived_publish_succeed)
{
    ...
    //                            1    2     3     4     T     o     p     i     c     10    11    d     a     t     a
    //                            sp    M     s     g
    unsigned char               PUBLISH[] = {0x3F,
                               0x11,
                               0x00,
                               0x06,
                               0x54,
...
TEST_FUNCTION(mqtt_codec_bytesReceived_publish_second_succeed)
{
    ...
    //                            1    2     3     4     T     o     p     i     c     10    11    d     a     t     a
    //                            sp    M     s     g
    unsigned char PUBLISH[] = {0x30, 0x1e, 0x00, 0x04, 0x6d, 0x73, 0x67, 0x41, 0x00, 0x16, 0x54,
                               0x68, 0x69, 0x73, 0x20, 0x69, 0x73, 0x20, 0x74, 0x68, 0x65, 0x20,
                               0x61, 0x70, 0x70, 0x20, 0x6d, 0x73, 0x67, 0x20, 0x41, 0x2e};
    // unsigned char PUBLISH[] = { 0x3F, 0x11, 0x00, 0x06, 0x54, 0x6f, 0x70, 0x69, 0x63, 0x12, 0x34, 0x64, 0x61, 0x74,
    // 0x61, 0x20, 0x4d, 0x73, 0x67 };
    size_t                      length   = sizeof(PUBLISH) / sizeof(PUBLISH[0]);
    TEST_COMPLETE_DATA_INSTANCE testData = {0};
    testData.dataHeader                  = PUBLISH + FIXED_HEADER_SIZE;
    testData.Length                      = length - FIXED_HEADER_SIZE;
...
TEST_FUNCTION(mqtt_codec_connect_trace_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(STRING_copy(IGNORED_PTR_ARG, IGNORED_NUM_ARG)).IgnoreArgument_s1().IgnoreArgument_s2();
    EXPECTED_CALL(BUFFER_length(IGNORED_PTR_ARG));
    EXPECTED_CALL(BUFFER_new());
    EXPECTED_CALL(BUFFER_pre_build(IGNORED_PTR_ARG, IGNORED_NUM_ARG));
    EXPECTED_CALL(BUFFER_u_char(IGNORED_PTR_ARG));
