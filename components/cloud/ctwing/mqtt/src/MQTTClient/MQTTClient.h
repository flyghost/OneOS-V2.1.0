...
enum returnCode { BUFFER_OVERFLOW = -2, MQTT_FAILURE = -1, MQTT_SUCCESS = 0 };
...
extern unsigned char globalPingTimes;
...
//typedef void (*TlinkMsgCallback)(unsigned short);
...
typedef struct MQTTClient
{
    ...
    Network* ipstack;
    Timer last_sent, last_received, wait_ping_rsp_timer;//oneos
    //TlinkMsgCallback tlinkMessageCallback;
    void (*tlinkMessageCallback)(unsigned short);
