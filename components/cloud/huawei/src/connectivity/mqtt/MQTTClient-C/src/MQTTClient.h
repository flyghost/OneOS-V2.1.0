 ...
 * @param
 */
DLLExport int MQTTClientInit(MQTTClient    *client,
                             Network       *network,
 ...
 */
DLLExport int
MQTTSubscribeWithResults(MQTTClient *client, const char *topicFilter, enum QoS, messageHandler, MQTTSubackData *data);
 ...
 */
static inline int
MQTTIsConnected(MQTTClient *client)    // static inline DLLExport int MQTTIsConnected(MQTTClient* client)
{
