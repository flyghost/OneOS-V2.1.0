 ...
 *
 */
#if defined(OS_HWCRYPTO_USING_AES)
#define MBEDTLS_AES_ALT
#endif
#if defined(OS_HWCRYPTO_USING_RC4)
#define MBEDTLS_ARC4_ALT
#endif
#if defined(OS_HWCRYPTO_USING_DES) || defined(OS_HWCRYPTO_USING_3DES)
#define MBEDTLS_DES_ALT
#endif
#if defined(OS_HWCRYPTO_USING_GCM)
#define MBEDTLS_GCM_ALT
#endif
#ifdef OS_HWCRYPTO_USING_MD5
#define MBEDTLS_MD5_ALT
#endif
#if defined(OS_HWCRYPTO_USING_BIGNUM)
#define MBEDTLS_RSA_ALT
#endif
#if defined(OS_HWCRYPTO_USING_SHA1)
#define MBEDTLS_SHA1_ALT
#endif
#if defined(OS_HWCRYPTO_USING_SHA2_256) || defined(OS_HWCRYPTO_USING_SHA2_224)
#define MBEDTLS_SHA256_ALT
#endif
#if defined(OS_HWCRYPTO_USING_SHA2_512) || defined(OS_HWCRYPTO_USING_SHA2_384)
...
#ifdef SECURITY_USING_MBEDTLS_DEBUG
...
// each of the two internal I/O buffers */ #define MBEDTLS_SSL_DEFAULT_TICKET_LIFETIME     86400 /**< Lifetime of
// session tickets (if enabled) */ #define MBEDTLS_PSK_MAX_LEN               32 /**< Max size of TLS pre-shared keys, in
// bytes (default 256 bits) */ #define MBEDTLS_SSL_COOKIE_TIMEOUT        60 /**< Default expiration delay of DTLS
