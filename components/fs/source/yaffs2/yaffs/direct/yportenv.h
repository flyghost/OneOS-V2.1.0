...
#define YAFFS_DT_UNKNOWN	0
#define YAFFS_DT_FIFO		1
#define YAFFS_DT_CHR		2
#define YAFFS_DT_DIR		4
#define YAFFS_DT_BLK		6
#define YAFFS_DT_REG		8
#define YAFFS_DT_LNK		10
#define YAFFS_DT_SOCK		12
#define YAFFS_DT_WHT		14
