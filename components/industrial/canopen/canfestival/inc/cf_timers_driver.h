...
void CanOpen_WaitReceiveTaskEnd(TASK_HANDLE*);
 ...
 */
void CanOpen_StartTimerLoop(TimerCallback_t Callback);
 ...
 */
void CanOpen_CreateReceiveTask(CAN_PORT port, TASK_HANDLE* handle, void* ReceiveLoopPtr);
