 ...
 *
 * @file        a7600x_general.h
 *
 * @brief       a7600x module link kit general api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __A7600X_GENERAL_H__
#define __A7600X_GENERAL_H__
