 ...
 *
 * @file        air720uh_netconn.h
 *
 * @brief       air720uh module link kit netconn api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __AIR720UH_NETCONN_H__
#define __AIR720UH_NETCONN_H__
