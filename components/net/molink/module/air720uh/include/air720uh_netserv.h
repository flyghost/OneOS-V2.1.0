 ...
 *
 * @file        air720uh_netserv.h
 *
 * @brief       air720uh module link kit netserv api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __AIR720UH_NETSERV_H__
#define __AIR720UH_NETSERV_H__
