 ...
 *
 * @file        air720uh_ping.c
 *
 * @brief       air720uh module link kit ping api implement
 *
 * @revision
 * Date         Author          Notes
...
#define AIR720UH_MAX_PING_PKG_LEN (5120)
#define AIR720UH_MIN_PING_TIMEOUT (1)
#define AIR720UH_MAX_PING_TIMEOUT (600)
...
os_err_t air720uh_ping(mo_object_t *self, const char *host, os_uint16_t len, os_uint32_t timeout, struct ping_resp *resp)
{
    ...
    /* Def timeout value is 5000ms, AIR720UH in units of 100 ms */
    timeout /= 100;
