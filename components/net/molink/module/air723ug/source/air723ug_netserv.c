 ...
 *
 * @file        air723ug_netserv.c
 *
 * @brief       air723ug module link kit netserv api implement
 *
 * @revision
 * Date         Author          Notes
...
os_err_t air723ug_set_cgact(mo_object_t *self, os_uint8_t cid, os_uint8_t act_stat)
{
    ...
    if (cid != AIR723UG_DEFAULT_CID)
    {
        cid = AIR723UG_DEFAULT_CID;
        ERROR("air723ug only support cid 5");
    }
