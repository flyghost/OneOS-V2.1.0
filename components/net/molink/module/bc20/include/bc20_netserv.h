 ...
 * @file        bc20_netserv.h
 *
 * @brief       bc20 module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __BC20_NETSERV_H__
#define __BC20_NETSERV_H__
...
os_err_t bc20_set_cgact(mo_object_t *module, os_uint8_t cid, os_uint8_t act_n);
