 ...
 * @file        bc20_general.c
 *
 * @brief       bc20 module link kit general api
 *
 * @revision
 * Date         Author          Notes
...
os_err_t bc20_at_test(mo_object_t *module)
{
...
os_err_t bc20_get_imei(mo_object_t *module, char *value, os_size_t len)
{
...
os_err_t bc20_get_imsi(mo_object_t *module, char *value, os_size_t len)
{
...
os_err_t bc20_get_iccid(mo_object_t *module, char *value, os_size_t len)
{
...
os_err_t bc20_get_cfun(mo_object_t *module, os_uint8_t *fun_lvl)
{
    at_parser_t *parser = &module->parser;
...
os_err_t bc20_set_cfun(mo_object_t *module, os_uint8_t fun_lvl)
{
    at_parser_t *parser = &module->parser;
...
static void bc20_ip_indicator_urc(struct at_parser *parser, const char *data, os_size_t size)
{
...
static void bc20_cpin_indicator_urc(struct at_parser *parser, const char *data, os_size_t size)
{
    OS_ASSERT(OS_NULL != parser);
    OS_ASSERT(OS_NULL != data);
...
void bc20_general_init(mo_bc20_t *module)
{
