 ...
 * @file        bc26_netserv.c
 *
 * @brief       bc26 module link kit netservice api
 *
 * @revision
 * Date         Author          Notes
...
#define MO_LOG_TAG "bc26.netserv"
#define MO_LOG_LVL  MO_LOG_INFO
#include "mo_log.h"

#ifdef BC26_USING_NETSERV_OPS

#define BC26_EARFCN_MAX        (65535)
#define BC26_PCI_MAX           (0x1F7)
...
os_err_t bc26_set_cgact(mo_object_t *module, os_uint8_t cid, os_uint8_t act_stat)
{
    at_parser_t *parser = &module->parser;
...
os_err_t bc26_get_csq(mo_object_t *module, os_uint8_t *rssi, os_uint8_t *ber)
{
    ...
    /* bc26 dosen't support ber, 99 will be set forever */
