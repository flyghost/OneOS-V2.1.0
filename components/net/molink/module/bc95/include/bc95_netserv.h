 ...
 * @file        bc95_netserv.h
 *
 * @brief       bc95 module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __BC95_NETSERV_H__
#define __BC95_NETSERV_H__
...
os_err_t bc95_set_cgact(mo_object_t *module, os_uint8_t cid, os_uint8_t act_n);
