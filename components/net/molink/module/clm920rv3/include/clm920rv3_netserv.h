 ...
 *
 * @file        clm920rv3_netserv.h
 *
 * @brief       clm920rv3 module link kit netserv api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __CLM920RV3_NETSERV_H__
#define __CLM920RV3_NETSERV_H__
