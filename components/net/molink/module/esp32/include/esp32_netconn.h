 ...
 *
 * @file        esp32_netconn.h
 *
 * @brief       esp32 module link kit netconn api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __ESP32_NETCONN_H__
#define __ESP32_NETCONN_H__
...
os_err_t      esp32_netconn_gethostbyname(mo_object_t *self, const char *domain_name, ip_addr_t *addr);
