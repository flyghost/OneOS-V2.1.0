 ...
 * @file        esp8266_ping.c
 *
 * @brief       esp8266 module link kit ping api implement
 *
 * @revision
 * Date         Author          Notes
...
#define MO_LOG_TAG "esp8266.ping"
#define MO_LOG_LVL MO_LOG_INFO
#include <mo_log.h>

#ifdef ESP8266_USING_PING_OPS

os_err_t esp8266_ping(mo_object_t *self, const char *host, os_uint16_t len, os_uint32_t timeout, struct ping_resp *resp)
{
    ...
    at_resp_t at_resp = {.buff      = resp_buff,
                         ...
                         .timeout   = 20 * AT_RESP_TIMEOUT_DEF};
    ...
    DEBUG("ESP8266 series module does not support setting ping package size and timeout.");
