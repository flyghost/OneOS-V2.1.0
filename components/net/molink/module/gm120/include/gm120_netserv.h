 ...
 *
 * @file        gm120_netserv.h
 *
 * @brief       gm120 module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __GM120_NETSERV_H__
#define __GM120_NETSERV_H__
...
os_err_t gm120_set_cgact(mo_object_t *self, os_uint8_t cid, os_uint8_t act_n);
