 ...
 * @file        l610_netserv.h
 *
 * @brief       l610 module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __L610_NETSERV_H__
#define __L610_NETSERV_H__
...
os_err_t l610_set_cgact(mo_object_t *self, os_uint8_t cid, os_uint8_t act_n);
