 ...
 * @file        mb26_netserv.h
 *
 * @brief       mb26 module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __MB26_NETSERV_H__
#define __MB26_NETSERV_H__
...
os_err_t mb26_clear_stored_earfcn(mo_object_t *self);
