 ...
 *
 * @file        sim7020_netconn.h
 *
 * @brief       SIM7020 module link kit netconnect api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __SIM7020_NETCONN_H__
#define __SIM7020_NETCONN_H__
