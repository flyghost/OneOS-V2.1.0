 ...
 *
 * @file        sim7070x_netconn.h
 *
 * @brief       SIM7070X module link kit netconnect api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __SIM7070X_NETCONN_H__
#define __SIM7070X_NETCONN_H__
