 ...
 *
 * @file        sim7070x_netserv.h
 *
 * @brief       SIM7070X module link kit netservice api declaration
 *
 * @revision
 * Date         Author          Notes
...
#ifndef __SIM7070X_NETSERV_H__
#define __SIM7070X_NETSERV_H__
...
os_err_t sim7070x_get_radio(mo_object_t *self, radio_info_t *radio_info);
