 ...
 *
 * @file        sim7600ce_ping.h
 *
 * @brief       SIM7600CE module link kit ping api declaration
 *
 * @revision
 * Date         Author          Notes
 ...
 ***********************************************************************************************************************
 */
#ifndef __SIM7600CE_PING_H__
#define __SIM7600CE_PING_H__
