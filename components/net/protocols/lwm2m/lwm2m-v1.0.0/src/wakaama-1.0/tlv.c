                    ...
                    size_t * oDataLen)
{
    ...
    lwm2m_log(COMP_LOG_DEBUG, "buffer_len: %d\n", buffer_len);
        ;
              ...
              lwm2m_data_t ** dataP)
{
    ...
    lwm2m_log(COMP_LOG_DEBUG, "bufferLen: %d\n", bufferLen);
                  ...
                  uint8_t ** bufferP)
{
    ...
    lwm2m_log(COMP_LOG_DEBUG, "isResourceInstance: %s, size: %d\n", isResourceInstance?"true":"false", size);
    ...
    *bufferP = (uint8_t *)lwm2m_malloc(length);
    ...
    lwm2m_log(COMP_LOG_DEBUG, "returning %u\n", length);
