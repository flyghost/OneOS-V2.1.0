 ...
 *
 * @file        techtotop_rcvr.c
 *
 * @brief       techtotop gnss recevicer function
 *
 * @revision
 * Date         Author          Notes
...
os_err_t techtotop_rcvr_agnss(rcvr_object_t* rcvr, ...)
{
...
rcvr_object_t *techtotop_rcvr_creat(void)
{
    ...
    #ifdef RCVR_SUPP_AGNSS
    rcvr->ops_table[RCVR_AGNSS_OPS] = (rcvr_ops_pfunc)techtotop_rcvr_agnss;
    #endif
