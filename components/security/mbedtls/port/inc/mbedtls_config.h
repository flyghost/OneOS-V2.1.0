...
#define MBEDTLS_PLATFORM_PRINTF_MACRO        os_kprintf /**< Default printf macro to use, can be undefined */
/* Note: your snprintf must correctly zero-terminate the buffer! */
#define MBEDTLS_PLATFORM_SNPRINTF_MACRO    os_snprintf /**< Default snprintf macro to use, can be undefined */
//#define MBEDTLS_PLATFORM_NV_SEED_READ_MACRO   mbedtls_platform_std_nv_seed_read /**< Default nv_seed_read function to use, can be undefined */
//#define MBEDTLS_PLATFORM_NV_SEED_WRITE_MACRO  mbedtls_platform_std_nv_seed_write /**< Default nv_seed_write function to use, can be undefined */

#define MBEDTLS_PLATFORM_CALLOC_MACRO        calloc

extern  void mbedtls_oneos_free(void *ptr);
#define MBEDTLS_PLATFORM_FREE_MACRO          mbedtls_oneos_free
