...
#include "shell.h"
static os_err_t nimble_shell(os_int32_t argc, char **argv)
{
    const struct shell_cmd *shell_cmd_p = &btshell_commands[0];
...
SH_CMD_EXPORT(nimble_shell, nimble_shell, "nimble shell cmds");

static os_err_t nimble_shell_cmd_list(os_int32_t argc, char **argv)
{
    const struct shell_cmd *shell_cmd_p = &btshell_commands[0];
...
SH_CMD_EXPORT(nimble_sh_list, nimble_shell_cmd_list, "nimble shell cmds list");

#if MYNEWT_VAL(SHELL_CMD_HELP)
void print_cmd_help(const struct shell_cmd *shell_cmd_p)
{
    struct shell_cmd_help *help_stru = shell_cmd_p->help;
    struct shell_param *param_stru;
...
static os_err_t nimble_shell_cmd_help(os_int32_t argc, char **argv)
{
    const struct shell_cmd *shell_cmd_p = &btshell_commands[0];
...
SH_CMD_EXPORT(nimble_sh_help, nimble_shell_cmd_help, "nimble shell cmds help");
#endif
