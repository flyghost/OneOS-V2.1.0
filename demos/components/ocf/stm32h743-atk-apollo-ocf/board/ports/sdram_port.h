...
#define SDRAM_INIT_DELAY 100000

/* SDRAM refresh counter (100Mhz SD clock) */
#define SDRAM_REFRESH_COUNT 0x603
...
#define MPU_REGION_BASE SDRAM_BASE
#define MPU_REGION_SIZE MPU_REGION_SIZE_32MB

#define USE_SDRAM_HEAP      1
