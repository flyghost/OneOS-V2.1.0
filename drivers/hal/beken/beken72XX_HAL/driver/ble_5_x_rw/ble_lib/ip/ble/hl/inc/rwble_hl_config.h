...
#define BLE_GAPM                    1
#if (BLE_OBSERVER)
#define BLE_GAPM_HEAP_ENV_SIZE      (sizeof(struct gapm_actv_scan_tag) + KERNEL_HEAP_MEM_RESERVED)
#elif (BLE_PERIPHERAL)
#define BLE_GAPM_HEAP_ENV_SIZE      (sizeof(struct gapm_actv_adv_tag)  + KERNEL_HEAP_MEM_RESERVED)
#else //(BLE_PERIPHERAL)
...
#define BLE_GAPC                    1
#define BLE_GAPC_HEAP_ENV_SIZE      (sizeof(struct gapc_env_tag)  + KERNEL_HEAP_MEM_RESERVED)
...
#define BLE_GATTM                   1
#define BLE_GATTC                   1
#define BLE_GATTC_HEAP_ENV_SIZE     (sizeof(struct gattc_env_tag)  + KERNEL_HEAP_MEM_RESERVED)
