...
#define USE_CAMERA              GC0308C_DEV// PAS6329_DEV  OV_7670_DEV  PAS6375_DEV  GC0328C_DEV
...
const UINT8 gc0328c_5pfs_talbe[][2] = 
{
...
const UINT8 gc0328c_10pfs_talbe[][2] = 
{
...
const UINT8 gc0328c_20pfs_talbe[][2] = 
{
...
const UINT8 gc0328c_QVGA_320_240_talbe[][2] = 
{
...
const UINT8 gc0328c_VGA_640_480_talbe[][2] = 
{
...
const UINT8 gc0308c_init_talbe[][2] = {
	{0xfe, 0x80},  		
	{0xfe, 0x00},  // set page0	
	{0xd2, 0x10},  // close AEC
	{0x22, 0x55},  // close AWB	
