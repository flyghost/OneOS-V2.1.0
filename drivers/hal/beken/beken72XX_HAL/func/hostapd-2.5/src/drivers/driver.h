...
struct wpa_driver_auth_params {
	...
	size_t ssid_len;
	int auth_alg;
	int proto;	/* Bitfield of allowed protocols, WPA_PROTO_*, added by tiancj */
	/**
	 * mgmt_frame_protection - IEEE 802.11w management frame protection
	 */
	enum mfp_options mgmt_frame_protection;		/* added by tiancj */
	const u8 *ie;
	size_t ie_len;
	const u8 *wep_key[4];
...
enum tdls_oper {
	...
	TDLS_ENABLE_LINK,
	TDLS_DISABLE_LINK,
	TDLS_ENABLE0,	/* renamed from TDLS_ENABLE */
	TDLS_DISABLE
};
