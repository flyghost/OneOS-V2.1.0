...
/* MPI / BIGNUM options */
#define MBEDTLS_MPI_WINDOW_SIZE          2 ///6 /**< Maximum windows size used. */
#define MBEDTLS_MPI_MAX_SIZE             384 ///1024 /**< Maximum number of bytes for usable MPIs. */
...
/* ECP options */
#define MBEDTLS_ECP_MAX_BITS             384 ///521 /**< Maximum bit size of groups */
#define MBEDTLS_ECP_WINDOW_SIZE            2 ///6 /**< Maximum window size used */
#define MBEDTLS_ECP_FIXED_POINT_OPTIM      0  ///1 /**< Enable fixed-point speed-up */

/* Entropy options */
#define MBEDTLS_ENTROPY_MAX_SOURCES             2    ///20 /**< Maximum number of sources supported */
...
#if 0
#define MBEDTLS_SSL_CIPHERSUITES  MBEDTLS_TLS_PSK_WITH_AES_256_CCM_8,             \
