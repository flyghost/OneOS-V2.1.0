...
{
	g_txbw20 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b70);
	g_txbw40 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b74);
	g_txbw80 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b78);
	g_txbw160 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b7c);

	(void)REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b34);
	g_txoctectinampdu = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b38);
	g_txampdu = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b30);

	g_rxbw20 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b80);
	g_rxbw40 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b84);
	g_rxbw80 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b88);
	g_rxbw160 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b8c);
	...
	REG_WRITE(REG_MAC_CORE_BASE_ADDR + 0x00000294, 0x0);
	REG_WRITE(REG_MAC_CORE_BASE_ADDR + 0x00000298, 0x0);
	REG_WRITE(REG_MAC_CORE_BASE_ADDR + 0x00000040, 0x00011881);
...
{	
	...
	txbw20new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b70);
	txbw40new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b74);
	txbw80new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b78);
	txbw160new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b7c);
	...
	rxbw40new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b84);
	rxbw80new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b88);
	rxbw160new = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b8c);
...
void rs_get_rx_result(void)
{
	...
	TXBW160 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b7C);

	(void)REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b34);
	TXOCTECTINAMPDU = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b38);
	TXAMPDU = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b30);

	RXBW20 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b80);
	RXBW40 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b84);
	RXBW80 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b88);
	RXBW160 = REG_READ(REG_MAC_CORE_BASE_ADDR + 0x00000b8C);
