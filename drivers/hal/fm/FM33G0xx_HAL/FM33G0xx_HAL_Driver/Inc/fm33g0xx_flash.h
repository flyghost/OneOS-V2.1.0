...
#define	FLASH_OPTBR_BTSEN_Pos	8   /*BootSwap 功能使能*/
...
#define	FLASH_FLSIF_KEYSTA_Pos	17	/* Flash擦写KEY输入状态 */
#define	FLASH_FLSIF_KEYSTA_Msk	(0x7U << FLASH_FLSIF_KEYSTA_Pos)
#define	FLASH_FLSIF_KEYSTA_ERR_LOCK	 (0x4U << FLASH_FLSIF_KEYSTA_Pos)/* KEY错误锁定状态，需要复位才能解锁*/
#define	FLASH_FLSIF_KEYSTA_P_UNLOCK	 (0x3U << FLASH_FLSIF_KEYSTA_Pos)/* 编程解锁状态 */
#define	FLASH_FLSIF_KEYSTA_SE_UNLOCK	(0x2U << FLASH_FLSIF_KEYSTA_Pos)/* 扇区擦解锁状态*/
#define	FLASH_FLSIF_KEYSTA_ALLE_UNLOCK	(0x1U << FLASH_FLSIF_KEYSTA_Pos)/* 全擦解锁状态 */
#define	FLASH_FLSIF_KEYSTA_WP         (0x0U << FLASH_FLSIF_KEYSTA_Pos) /* Flash 写保护状态，未输入KEY */
