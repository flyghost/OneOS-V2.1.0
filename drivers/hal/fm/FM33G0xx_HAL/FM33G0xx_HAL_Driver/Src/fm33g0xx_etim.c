...
输出: 00-FFFF
      其余为无效值
*********************************/
uint32_t ETIMx_ETxCNT_Read(ETIMx_Type* ETIMx)
{
	volatile uint8_t tmp08;
  uint32_t tmp32;
  tmp08 = ((uint32_t)ETIMx - ETIMER1_BASE)>>5;	//获取ETIM
  switch(tmp08)
  {
    case 0:
      tmp32 = (ETCNT->ET1CNT & ETIMx_ETxCNT_ETxCNT_Msk);
      break;
    case 1:
      tmp32 = (ETCNT->ET2CNT & ETIMx_ETxCNT_ETxCNT_Msk);
      break;
    case 2:
      tmp32 = (ETCNT->ET3CNT & ETIMx_ETxCNT_ETxCNT_Msk);
      break;
    case 3:
      tmp32 = (ETCNT->ET4CNT & ETIMx_ETxCNT_ETxCNT_Msk);
      break;
    default:
      tmp32 = 0x1fffffff;
			break;
