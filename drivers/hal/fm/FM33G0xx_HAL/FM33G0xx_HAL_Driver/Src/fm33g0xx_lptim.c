...
功能:读取LPTIM输入边沿选择
输出:读取LPTIM输入边沿
	LPTIM_LPTCFG_EDGESEL_POS：LPTIN的上升沿计数
	LPTIM_LPTCFG_EDGESEL_NEG：LPTIN的下降沿计数
********************************/
...
功能:脉宽调制模式选择
输入:脉宽调制模式代号
LPTIM_LPTCFG_PWM_TOGGLE：周期方波输出模式
LPTIM_LPTCFG_PWM_PWM：PWM输出模式
********************************/
...
功能:计数模式选择
输入:计数模式选择代号
LPTIM_LPTCFG_MODE_CONTINUE：连续计数模式
LPTIM_LPTCFG_MODE_SINGLE：单次计数模式
********************************/
