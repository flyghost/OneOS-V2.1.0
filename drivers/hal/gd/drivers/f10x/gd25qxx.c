...
void spi_flash_init(void)
{
    ...
    /* SPI4_CLK(PG13), SPI4_MISO(PG12), SPI4_MOSI(PG14),SPI4_IO2(PG10) and SPI4_IO3(PG11) GPIO pin configuration */
    ...
    gpio_output_options_set(GPIOE, GPIO_OTYPE_PP, GPIO_OSPEED_25MHZ, GPIO_PIN_13| GPIO_PIN_14);

    /* SPI4_CS(PG9) GPIO pin configuration */
