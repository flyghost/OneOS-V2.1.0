...
#else
    __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,
    __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,
    __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,
    __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,   __GD32_PIN_DEFAULT,
#endif /* defined(GPIOA) */    
...
static void gd32_pin_mode(os_device_t *dev, os_base_t pin, os_base_t mode)
{
    ...
    os_uint32_t pull_up_down;
    os_uint32_t output_type;
   ...
   default:
    ...
    gpio_output_options_set(index->gpio_periph, output_type, GPIO_OSPEED_50MHZ, index->pin);
}
...
//        rcu_periph_clock_enable(RCU_SYSCFG);
        ...
        nvic_irq_enable(irqmap->irqno, 2U, 0U);
