 ...
 *
 * @file        drv_pulse_encoder.h
 *
 * @brief       This file provides functions declaration for STM32 pulse encoder driver.
 *
 * @revision
 * Date         Author          Notes
...
struct stm32_pulse_encoder
{
    struct os_pulse_encoder_device pulse_encoder;
