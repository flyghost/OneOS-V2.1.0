...
{
    /* enable GPIOB clock */
    rcu_periph_clock_enable((rcu_periph_enum)i2c_info->port_rcu_clk);

    /* I2C GPIO ports */
    /* connect pin to I2C SCL */
    gpio_af_set(i2c_info->pin_port, GPIO_AF_4, i2c_info->scl_pin);
    /* connect pin to I2C SDA */
    gpio_af_set(i2c_info->pin_port, GPIO_AF_4, i2c_info->sda_pin);
    
    /* configure I2C GPIO SCL */
    gpio_mode_set(i2c_info->pin_port, GPIO_MODE_AF, GPIO_PUPD_PULLUP, i2c_info->scl_pin);
    gpio_output_options_set(i2c_info->pin_port, GPIO_OTYPE_OD, GPIO_OSPEED_50MHZ, i2c_info->scl_pin);
    /* configure I2C GPIO SDA */
    gpio_mode_set(i2c_info->pin_port, GPIO_MODE_AF, GPIO_PUPD_PULLUP, i2c_info->sda_pin);
    gpio_output_options_set(i2c_info->pin_port, GPIO_OTYPE_OD, GPIO_OSPEED_50MHZ, i2c_info->sda_pin);
}
...
{
    /* enable I2C clock */
    rcu_periph_clock_enable((rcu_periph_enum)i2c_info->i2c_rcu_clk);
    
    /* configure I2C clock */
    i2c_clock_config(i2c_info->hi2c, i2c_info->i2c_speed, I2C_DTCY_2);
    /* configure I2C address */
    i2c_mode_addr_config(i2c_info->hi2c, I2C_I2CMODE_ENABLE, I2C_ADDFORMAT_7BITS, I2C0_SLAVE_ADDRESS7);
    /* enable I2C */
    i2c_enable(i2c_info->hi2c);
    /* enable acknowledge */
    i2c_ack_config(i2c_info->hi2c,I2C_ACK_ENABLE);
}
...
static int gd_i2c_probe(const os_driver_info_t *drv, const os_device_info_t *dev)
{
    ...
    os_sem_init(&gd_i2c->sem, name, 0, OS_IPC_FLAG_FIFO);
...
OS_DRIVER_DEFINE(gd_i2c_driver, "2");
