...
#if defined(HC32F17xPxxx)	      //100PIN MCU	  
...
#elif defined(HC32F17xMxxx)     //80PIN MCU	  
...
#elif defined(HC32F17xKxxx)     //64PIN MCU	  
...
#elif defined(HC32F17xJxxx)     //48PIN MCU	  
...
#elif defined(HC32F17xFxxx)     //32PIN MCU	  
