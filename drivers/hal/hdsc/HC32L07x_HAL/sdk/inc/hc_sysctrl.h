...
{
    SysctrlTimerClkPll      = 0u,                    ///<定时器使用PLL时，使用系统同频时钟 
    SysctrlTimerClkPll2     = 1u,                    ///<定时器使用PLL是，使用系统时钟2倍频 
...
///< 注意3：本驱动默认宏定义：SYSTEM_XTH=8MHz,SYSTEM_XTL=32768Hz,如使用其它外部晶振，必须修改这两个宏定义的值。
