...
{                                                                                    
    ...
    VcInPCh1 = 1u,                //   输入通道1 PC1        输入通道1 PA1
    VcInPCh2 = 2u,                //   输入通道2 PC2        输入通道2 PA2
    VcInPCh3 = 3u,                //   输入通道3 PC3        输入通道3 PA3
    VcInPCh4 = 4u,                //   输入通道4 PA0        输入通道4 PA4
    VcInPCh5 = 5u,                //   输入通道5 PA1        输入通道5 PA5
    VcInPCh6 = 6u,                //   输入通道6 PA2        输入通道6 PB1
    VcInPCh7 = 7u,                //   输入通道7 PA3        输入通道7 PB2
    VcInPCh8 = 8u,                //   输入通道7 PA4        输入通道8 PB10
    VcInPCh9 = 9u,                //   输入通道7 PA5        输入通道9 PB12
    VcInPCh10 = 10u,              //   输入通道7 PA6        输入通道10 PB13
    VcInPCh11 = 11u,              //   输入通道7 PA7        输入通道11 PB14
    VcInPCh12 = 12u,              //   输入通道7 PB4        输入通道12 PB4
    VcInPCh13 = 13u,              //   输入通道7 PB5        输入通道13 PB5
    VcInPCh14 = 14u,              //   输入通道7 PB6        输入通道14 PB6
    VcInPCh15 = 15u,              //   输入通道7 PB7        输入通道15 PB7                          
}en_vc_input_p_src_t;
...
typedef enum 
{
    ...
    VcInNCh1    = 1u,         //   输入通道1  PA1               输入通道1 PC1
    VcInNCh2    = 2u,         //   输入通道2  PA2               输入通道2 PC2
    VcInNCh3    = 3u,         //   输入通道3  PA3               输入通道3 PC3
    VcInNCh4    = 4u,         //   输入通道4  PA4               输入通道4 PA0
    VcInNCh5    = 5u,         //   输入通道5  PA5               输入通道5 PA1
    VcInNCh6    = 6u,         //   输入通道6  PA6               输入通道6 PB0
    VcInNCh7    = 7u,         //   输入通道7  PA7               输入通道7 PB1
    VcInNCh8    = 8u,         //   输入通道8  PC4               输入通道8 PB2
    VcInNCh9    = 9u,         //   输入通道9  PC5               输入通道9 PB3
    VcInNCh10   = 10u,        //   输入通道10 PB0               输入通道10 PB4  
    ResDivOut   = 11u,        //   电阻分压                     电阻分压
    AiTs        = 12u,        //   内部温度传感器输出电压       内部温度传感器输出电压
    AiBg1p2     = 13u,        //   内部基准1.2V                 内部基准1.2V
    AiAdcVref   = 14u,        //   ADC参考电压VREF              ADC参考电压VREF
    AiLdo       = 15u,        //   VCAP引脚电压                 VCAP引脚电压
}en_vc_input_n_src_t;
...
/**
 ******************************************************************************
 ** \brief VC输出配置                      VCx_OUT_CFG(x=0、1)
 ** \note       对于VC0，CHX = CHA；对于VC1，CHX = CHB
 *****************************************************************************/
