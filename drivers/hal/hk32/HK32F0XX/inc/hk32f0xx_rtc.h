...
/** @defgroup RTC_Wakeup_Timer_Definitions 
  * @brief    These parameters are only available for HK32F072 devices
  * @{
  */
...
#define RTC_Output_WakeUp              ((uint32_t)0x00600000) /*!< available only for HK32F072 devices */
...
#define RTC_IT_WUT                        ((uint32_t)0x00004000) /* Available only for HK32F072 devices */
#define RTC_IT_ALRA                       ((uint32_t)0x00001000)
#define RTC_IT_TAMP                       ((uint32_t)0x00000004) /* Used only to Enable the Tamper Interrupt */
#define RTC_IT_TAMP1                      ((uint32_t)0x00020000)
#define RTC_IT_TAMP2                      ((uint32_t)0x00040000)
#define RTC_IT_TAMP3                      ((uint32_t)0x00080000) /* Available only for HK32F072 devices */
...
void RTC_WakeUpClockConfig(uint32_t RTC_WakeUpClock); /*!< available only for HK32F072 devices */ 
void RTC_SetWakeUpCounter(uint32_t RTC_WakeUpCounter); /*!< available only for HK32F072 devices */ 
uint32_t RTC_GetWakeUpCounter(void); /*!< available only for HK32F072 devices */ 
ErrorStatus RTC_WakeUpCmd(FunctionalState NewState); /*!< available only for HK32F072 devices */ 
