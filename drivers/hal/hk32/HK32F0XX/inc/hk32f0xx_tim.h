...
#if defined HK32F031x4 || defined HK32F031x6 || defined HK32F04Ax 
...
/* LIST10: TIM 1, 2, 3, 6, 7, 16 and 17 */
...
/* LIST6: TIM 1, 3 and 15 */
#define IS_TIM_LIST6_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
                                     ((PERIPH) == TIM3) || \
                                     ((PERIPH) == TIM15)) 

/* LIST7: TIM 1, 3, 6, 7 and 14 */
#define IS_TIM_LIST7_PERIPH(PERIPH)  (((PERIPH) == TIM1) || \
                                      ((PERIPH) == TIM3) || \
                                      ((PERIPH) == TIM6) || \
                                      ((PERIPH) == TIM14))
                                      
/* LIST8: TIM 1,3 and 14 */
#define IS_TIM_LIST8_PERIPH(PERIPH)  (((PERIPH) == TIM1) || \
                                      ((PERIPH) == TIM3) || \
                                      ((PERIPH) == TIM14))

/* LIST9: TIM 1, 3, 6, 7 and 15 */
#define IS_TIM_LIST9_PERIPH(PERIPH)  (((PERIPH) == TIM1) || \
                                      ((PERIPH) == TIM3) || \
                                      ((PERIPH) == TIM6) || \
                                      ((PERIPH) == TIM15))

/* LIST10: TIM 1, 3, 6, 7, 15, 16 and 17 */
#define IS_TIM_LIST10_PERIPH(PERIPH) (((PERIPH) == TIM1) || \
                                     ((PERIPH) == TIM3) || \
                                     ((PERIPH) == TIM6) || \
                                     ((PERIPH) == TIM15)|| \
