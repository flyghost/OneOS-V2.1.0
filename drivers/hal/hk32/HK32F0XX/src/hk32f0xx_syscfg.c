...
/**
  ...
  * @note   This function is only used for HK32F030, HK32F031, HK32F04A devices.   
  * @retval None
  */
...
/**
  ...
  *            @arg SYSCFG_I2CFastModePlus_PA9: Configure fast mode plus driving capability for PA9 (only for HK32F031 and HK32F030 devices)
  *            @arg SYSCFG_I2CFastModePlus_PA10: Configure fast mode plus driving capability for PA10 (only for HK32F031 and HK32F030 devices)
  *            @arg SYSCFG_I2CFastModePlus_I2C1: Configure fast mode plus driving capability for PB10, PB11, PF6 and PF7(only for HK32F031 and HK32F030 devices)
