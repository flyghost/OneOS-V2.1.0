/**
  ******************************************************************************
  * @file    hk32f39a_dcmi.h
  * @author  Thomas.W
  * @version V1.0  
  * @brief   Header file of DCMI module
  * @changelist  
  ******************************************************************************
  */ 

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F39A_DCMI_H
#define __HK32F39A_DCMI_H
...
#if 1
/** 
  * @brief  DCMI State structures definition
  */ 
typedef enum
{
...
/**
  * @brief  Reset the DCMI Big Endian in 8bit mode.
  * @param  __HANDLE__ DCMI handle
  * @retval None
  */
#define __HAL_DCMI_RESETBENDIAN(__HANDLE__)   ((__HANDLE__)->Instance->CR &= ~(DCMI_CR_BENDIAN))

/**
  * @brief  Set the DCMI Big Endian in 8bit mode.
  * @param  __HANDLE__ DCMI handle
  * @retval None
  */
#define __HAL_DCMI_SETBENDIAN(__HANDLE__)    ((__HANDLE__)->Instance->CR |= DCMI_CR_BENDIAN)


/**
  * @brief  Generate one DMA request when receive one word.
  * @param  __HANDLE__ DCMI handle
  * @retval None
  */
#define __HAL_DCMI_SET_DMA_WDREQEST(__HANDLE__)   ((__HANDLE__)->Instance->CR &= ~(DCMI_CR_HALFWD))

/**
  * @brief  Generate one DMA request when receive half word.
  * @param  __HANDLE__ DCMI handle
  * @retval None
  */
#define __HAL_DCMI_SET_DMA_HALFWDREQEST(__HANDLE__)    ((__HANDLE__)->Instance->CR |= DCMI_CR_HALFWD)
