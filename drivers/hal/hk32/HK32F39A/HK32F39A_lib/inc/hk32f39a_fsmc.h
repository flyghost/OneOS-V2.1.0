...
#ifndef __HK32F39A_FSMC_H
#define __HK32F39A_FSMC_H
...
typedef struct
{
  ...
  uint32_t NadvPol;               		/*!< only enable when the address and data values are multiplexed on the data bus.
