...
#ifndef __HK32F39A_HAL_CRYP_H
#define __HK32F39A_HAL_CRYP_H
...
typedef struct
{  
	uint32_t  KeySize;  /* < aes KEY size 128bit/192bit/256bit >*/
...
#define CRYP_KEYSIZE_192B          ((uint32_t)0x00000001U)
#define CRYP_KEYSIZE_256B          ((uint32_t)0x00000002U)
...
//HK32f39a aes_cbc
#define CRYP_CR_ALGOMODE_AES_CBC_KEYDERDECRYPT_HK_0  ((uint32_t)(AES_CR_CHMOD_0|AES_CR_MODE_0))
#define CRYP_CR_ALGOMODE_AES_CBC_KEYDERDECRYPT_HK_1  ((uint32_t)(AES_CR_CHMOD_0|AES_CR_MODE_1))
...
/** @defgroup CRYP_AES_Interrupts AES Interrupts
  * @{
  */ 
#define CRYP_IT_CC                          AES_CR_CCFIE  /*!< Computation Complete interrupt */
...
/**
  * @brief  Set key size : CRYP_KEYSIZE_128B, CRYP_KEYSIZE_192B, CRYP_KEYSIZE_256B
  * @param  __HANDLE__ specifies the CRYP handle.
  * @param  __SIZE__ key size
  * @retval None
  */
#define __HAL_CRYP_SET_KEY_SIZE(__HANDLE__,__SIZE__)    SET_BIT((__HANDLE__)->Instance->CR2, (__SIZE__))
