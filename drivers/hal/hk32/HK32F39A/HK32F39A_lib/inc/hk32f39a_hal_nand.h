...
#ifndef __HK32F39A_HAL_NAND_H
#define __HK32F39A_HAL_NAND_H
...
#define FSMC_IT_IF                         ((uint32_t)FSMC_SRx_IFEN)
#define FSMC_IT_IL                         ((uint32_t)FSMC_SRx_ILEN)
#define FSMC_IT_IR                         ((uint32_t)FSMC_SRx_IREN)
