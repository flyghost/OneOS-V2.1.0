/**
  ...
  * @author  Thomas.W
  * @version V1.0  
  * @brief   Head file of SAI module
  * @changelist  
  ******************************************************************************
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __HK32F39A_SAI_H
#define __HK32F39A_SAI_H
...
#define SAI_PDMFILTER_DEC64				((uint32_t)0x00000000U)
#define SAI_PDMFILTER_DEC128			((uint32_t)SAI_xCR1_PDMFILTER_DEC0)
#define SAI_PDMFILTER_DEC256			((uint32_t)SAI_xCR1_PDMFILTER_DEC1)

#define SAI_CODE_CHANGE						((uint32_t)0x00000000U)
...
#define SAI_PDM_PROTOCOL                 	((uint32_t)SAI_xCR1_PRTCFG_1)|((uint32_t)SAI_xCR1_PRTCFG_0)
