...
#ifndef __HK32F39A_TIM_H
#define __HK32F39A_TIM_H
...
/** @defgroup TIM_PWMClear selection 
  * @{
  */
#define TIM_PWMClear_VC4				((uint16_t)0x8000)
#define TIM_PWMBrake_VC					((uint16_t)0x4000)
