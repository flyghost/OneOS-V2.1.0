/**
  ******************************************************************************
  * @file    hk32f39a_dcmi.c
  * @author  Thomas.W
  * @version V1.0  
  * @brief   API file of DCMI module
  * @changelist  
  ******************************************************************************
  */ 
...
/**
  ...
  ==============================================================================
                        ##### DCMI driver macros list #####
  ==============================================================================
     [..]
       Below the list of most used macros in DCMI driver.
     ...
     [..] 
       (@) You can refer to the DCMI driver header file for more useful macros      
  */ 
...
{  
  ...
  else
  {
	  ...
	  hdcmi->XferCount = 1;//1;
	  hdcmi->XferSize = Length/2;//Length-0xffff;
	  hdcmi->pBuffPtr = pData;
	  HAL_DMA_Start_IT(hdcmi->DMA_Handle, (uint32_t)&hdcmi->Instance->DR, (uint32_t)pData, hdcmi->XferSize);
  }  
