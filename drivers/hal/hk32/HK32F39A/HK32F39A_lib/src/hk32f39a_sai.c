 ...
 ==============================================================================
  ...
  [..]
   (@) Make sure that either:
       (+@) SAI Internal Clock source is configured or
...
*/
  if(hsai->Init.AudioFrequency != SAI_AUDIO_FREQUENCY_MCKDIV)
  {
    ...
    if((hsai->Instance == SAI1_Block_A ) || (hsai->Instance == SAI1_Block_B ))
    {
    	//Need Add SAI clock configuration and read function into RCC.c, Noted by Thomas.W
      //Delete by Thomas.W
      freq = RCC_GetSaiCLKFreq(hsai->Instance);
    }
...
//     (freq x 10) to keep Significant digits 
  ...
  hsai->Instance->CR1&=~(SAI_xCR1_MODE | SAI_xCR1_PRTCFG |  SAI_xCR1_DS |      \
	...
	//Need update by Thomas.w
	//                     |SAI_xCR1_PDMFILTER_DEC);																																									//add by Thomas.w
  ...
  hsai->Instance->CR1|=(hsai->Init.AudioMode | hsai->Init.Protocol |           \
                        ...
                        hsai->Init.NoDivider | (hsai->Init.Mckdiv << 20) |
												hsai->Init.PdmFilterDec );																																								//add by Thomas.w
  
  /* SAI CR2 Configuration */
  //Need update by Thomas.W
	//hsai->Instance->CR2&= ~(SAI_xCR2_FTH | SAI_xCR2_FFLUSH | SAI_xCR2_COMP | SAI_xCR2_CPL | SAI_xCR1_CODE_CHANGE);									//add by Thomas.w
  hsai->Instance->CR2|=  (hsai->Init.FIFOThreshold | hsai->Init.CompandingMode | hsai->Init.TriState | hsai->Init.CodeChange);		//add by Thomas.w
