...
void USART_DeInit(USART_TypeDef* USARTx)
{
  ...
  else
  {
    if (USARTx == USART6)
    { 
      RCC_APB2PeriphResetCmd(RCC_APB2Periph2_USART6, ENABLE);
      RCC_APB2PeriphResetCmd(RCC_APB2Periph2_USART6, DISABLE);
    }
  }
}
...
/*---------------------------- USART BRR Configuration -----------------------*/
  ...
  if (usartxbase == USART1_BASE || usartxbase == USART6_BASE)
  {
...
/**
  ...
  * @param  USARTx: where x can be 1, 2, 3, 4, 5 or 6 to select the USART peripheral.
