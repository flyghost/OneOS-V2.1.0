...
#define GPIO_PXPE(n)	(GPIO_BASE + (PXPE + (n)*GPIO_PORT_OFF)) /* Port Pull Disable Register */
#define GPIO_PXPES(n)	(GPIO_BASE + (PXPES + (n)*GPIO_PORT_OFF)) /* Port Pull Disable Set Register */
#define GPIO_PXPEC(n)	(GPIO_BASE + (PXPEC + (n)*GPIO_PORT_OFF)) /* Port Pull Disable Clear Register */
