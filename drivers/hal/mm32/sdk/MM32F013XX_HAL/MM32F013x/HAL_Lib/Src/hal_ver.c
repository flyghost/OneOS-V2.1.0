...
// MM32 Library release date is 2020-10-16(YYYY-MM-DD)
...
#define __MM32_LIB_RELESE_DAY           (0x16U)                                 //!< [7:0]   release day
