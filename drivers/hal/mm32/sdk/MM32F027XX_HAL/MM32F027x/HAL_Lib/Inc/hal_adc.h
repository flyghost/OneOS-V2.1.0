...
////////////////////////////////////////////////////////////////////////////////
typedef enum {
    ADC_Samctl_2_5   = ADC_SMPR_SAMCTL_2_5,   ///< ADC sample time select 2.5t
    ADC_Samctl_8_5   = ADC_SMPR_SAMCTL_8_5,   ///< ADC sample time select 8.5t
    ADC_Samctl_14_5   = ADC_SMPR_SAMCTL_14_5,   ///< ADC sample time select 14.5t
    ADC_Samctl_29_5   = ADC_SMPR_SAMCTL_29_5,   ///< ADC sample time select 29.5t
    ADC_Samctl_42_5   = ADC_SMPR_SAMCTL_42_5,   ///< ADC sample time select 42.5t
    ADC_Samctl_56_5   = ADC_SMPR_SAMCTL_56_5,   ///< ADC sample time select 56.5t
    ADC_Samctl_72_5   = ADC_SMPR_SAMCTL_72_5,   ///< ADC sample time select 72.5t
    ADC_Samctl_240_5   = ADC_SMPR_SAMCTL_240_5,   ///< ADC sample time select 240.5t
    ADC_Samctl_3_5  = ADC_SMPR_SAMCTL_3_5,  ///< ADC sample time select 3.5t
    ADC_Samctl_4_5  = ADC_SMPR_SAMCTL_4_5,  ///< ADC sample time select 4.5t
    ADC_Samctl_5_5  = ADC_SMPR_SAMCTL_5_5,  ///< ADC sample time select 5.5t
    ADC_Samctl_6_5  = ADC_SMPR_SAMCTL_6_5,  ///< ADC sample time select 5.5t
    ADC_Samctl_7_5  = ADC_SMPR_SAMCTL_7_5,  ///< ADC sample time select 5.5t
} ADCSAM_TypeDef;
////////////////////////////////////////////////////////////////////////////////
