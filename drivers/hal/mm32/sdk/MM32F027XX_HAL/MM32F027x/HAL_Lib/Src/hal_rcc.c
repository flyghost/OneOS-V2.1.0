...
{
    MODIFY_REG(RCC->CFGR, RCC_CFGR_USBPRE_PLL_DIV4, (usb_clk_src << RCC_CFGR_USBPRE_Pos));
}
////////////////////////////////////////////////////////////////////////////////
...
//    u32 j;
    ...
    MODIFY_REG(RCC->CSR, RCC_CSR_LSI_LV_Pos, (state << RCC_CSR_LSI_LV_Pos));
}
...
/// @retval None.
////////////////////////////////////////////////////////////////////////////////
void RCC_DIV_ClockCmd(DIV_TypeDef* peripheral, FunctionalState state)
{
    if(DIV == peripheral) {
