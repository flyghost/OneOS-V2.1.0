...
/*xhm 手册中不开放
#define ADC_CFGR_Vref_SEL_Pos           (17)
#define ADC_CFGR_Vref_SEL_VBG           (0x00U << ADC_CFGR_Vref_SEL_Pos)              ///< Internal 1.2v reference voltage detection selection VBG
#define ADC_CFGR_Vref_SEL_VBG           (0x01U << ADC_CFGR_Vref_SEL_Pos)              ///< Internal 1.2v reference voltage detection selection VREF
#define ADC_CFGR_Vref_SEL_VBG           (0x02U << ADC_CFGR_Vref_SEL_Pos)              ///< Internal 1.2v reference voltage detection selection VREFLP
#define ADC_CFGR_Vref_SEL_VBG           (0x03U << ADC_CFGR_Vref_SEL_Pos)              ///< Internal 1.2v reference voltage detection selection VBT_DIV3
*/
...
#define ADC_CR_T1_TRIG                  ((0x02U << ADC_CR_TRGSEL_H_Pos) + (0x00U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T1_TRIG
#define ADC_CR_T1_CC4                   ((0x02U << ADC_CR_TRGSEL_H_Pos) + (0x01U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T8_CC4
#define ADC_CR_T1_CC5                   ((0x02U << ADC_CR_TRGSEL_H_Pos) + (0x02U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T8_CC4_CC5
#define ADC_CR_T1_CC4_CC5               ((0x03U << ADC_CR_TRGSEL_H_Pos) + (0x00U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T3_CC4
#define ADC_CR_T2_TRIG                  ((0x03U << ADC_CR_TRGSEL_H_Pos) + (0x01U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T2_TRIG
#define ADC_CR_T16_TRIG                 ((0x03U << ADC_CR_TRGSEL_H_Pos) + (0x02U << ADC_CR_TRGSEL_L_Pos))   ///< The external trigger source of the ADC is T8_CC5
...
#define ADC_ANY_CR_JTRGSEL_TIM1_CC4     (0x09U << ADC_ANY_CR_JTRGSEL_Pos)       ///< TIM1  CC4    
#define ADC_ANY_CR_JTRGSEL_TIM1_CC5     (0x0AU << ADC_ANY_CR_JTRGSEL_Pos)       ///< TIM1  CC5    
#define ADC_ANY_CR_JTRGSEL_TIM1_CC4_CC5 (0x0CU << ADC_ANY_CR_JTRGSEL_Pos)       ///< TIM1  CC4 CC5
#define ADC_ANY_CR_JTRGSEL_TIM2_TRGO    (0x0DU << ADC_ANY_CR_JTRGSEL_Pos)       ///< TIM2 TRGO   
#define ADC_ANY_CR_JTRGSEL_TIM16_TRGO   (0x0EU << ADC_ANY_CR_JTRGSEL_Pos)       ///< TIM16 TRGO  
