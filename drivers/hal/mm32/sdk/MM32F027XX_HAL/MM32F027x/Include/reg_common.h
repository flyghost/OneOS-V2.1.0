...
typedef enum IRQn {
    ...
    RTC_BKP_IRQn                        = 2,                                    ///< RTC and BKP through EXTI Line Interrupt
    ...
    LPTIMER1_IRQn                       = 18,                                   ///< LPTIMER1 Interrupt
    ...
    UART3_4_IRQn                        = 29,                                   ///< UART3/4 Interrupt
    CAN_IRQn                            = 30,                                   ///< CAN Interrupt
    USB_IRQn                            = 31,                                   ///< USB Interrupt or EXTI18
} IRQn_Type;
