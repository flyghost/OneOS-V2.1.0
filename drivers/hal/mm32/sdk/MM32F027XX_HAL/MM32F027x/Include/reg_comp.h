...
#define COMP_CSR_OUT_TIM8_LPTIM    (0x0FU << COMP_CSR_OUT_Pos)              ///<  LPTIM  
...
#define COMP_CSR_OSEL_Pos            (29)
#define COMP_CSR_OSEL1               (0x01U << COMP_CSR_OSEL_Pos)             ///< Comparator x output source select Analog output 
