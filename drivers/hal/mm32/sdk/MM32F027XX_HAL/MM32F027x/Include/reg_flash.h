...
typedef struct {
    ...
    __IO u32 RESERVED1[13];                                                     ///<                                                offset: 0x24~0x54
    __IO u32 CPU_RSTN_MATCH;                                                    ///<Data match status register                      offset: 0x58
    __IO u32 SEC4_KEYR;                                                         ///<NVR4 key register                               offset: 0x5C
    __IO u32 CFG;                                                               ///<Configuration register                          offset: 0x60
    __IO u32 CFG1;                                                              ///<Configuration register 1                        offset: 0x64
...
#define FLASH_CR_SYS_ER                 (0x01U << FLASH_CR_EOPIE_Pos)           ///< Used for sys space erasure
...
#define FLASH_OBR_RDP                   (0x01U << FLASH_OBR_RDP_Pos)            ///< Read protect enable
...
////////////////////////////////////////////////////////////////////////////////
/// @brief FLASH_CPU_RSTN_MATCH Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define FLASH_CPU_RSTN_MATCH_Pos         (0)
#define FLASH_CPU_RSTN_VLU_MATCH         (0x01U << FLASH_CPU_RSTN_MATCH_Pos)     ///< Indicates that the read NVR4 spatial data matches

////////////////////////////////////////////////////////////////////////////////
/// @brief FLASH_SEC4_KEYR Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define FLASH_SEC4_KEYR_Pos              (0)
#define FLASH_SEC4_KEYR_CPU              (0x01U << FLASH_SEC4_KEYR_Pos)         ///< Operable NVR4 space
////////////////////////////////////////////////////////////////////////////////
/// @brief FLASH_CFG Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define FLASH_CFG_Pos                    (0)
#define FLASH_CFG_0                      (0x01U << FLASH_CFG_Pos)               ///< Indicates that the read NVR4 spatial data matches

////////////////////////////////////////////////////////////////////////////////
/// @brief FLASH_CFG1 Register Bit Definition
////////////////////////////////////////////////////////////////////////////////
#define FLASH_CFG1_EN_Pos                 (12)
#define FLASH_CFG1_EN                     (0xFFFFFU << FLASH_CFG1_EN_Pos)     ///< CFG ENABLE
#define FLASH_CFG1_SYS_WREN_Pos           (11)
#define FLASH_CFG1_SYS_WREN               (0x01U << FLASH_CFG1_SYS_WREN_Pos)     ///< system space erase and write enable
#define FLASH_CFG1_SRAM_SIZE_Pos          (10)
#define FLASH_CFG1_SRAM_SIZE              (0x01U << FLASH_CFG1_SRAM_SIZE_Pos)   ///< SRAM 16KB
#define FLASH_CFG1_FLASH_SIZE_Pos         (8)
#define FLASH_CFG1_FLASH_SIZE_32          (0x00U << FLASH_CFG1_SRAM_SIZE_Pos)   ///< FLASH 32 KB
#define FLASH_CFG1_FLASH_SIZE_64          (0x01U << FLASH_CFG1_SRAM_SIZE_Pos)   ///< FLASH 64 KB
#define FLASH_CFG1_FLASH_SIZE_96          (0x02U << FLASH_CFG1_SRAM_SIZE_Pos)   ///< FLASH 96 KB
#define FLASH_CFG1_FLASH_SIZE_128         (0x03U << FLASH_CFG1_SRAM_SIZE_Pos)   ///< FLASH 128 KB
