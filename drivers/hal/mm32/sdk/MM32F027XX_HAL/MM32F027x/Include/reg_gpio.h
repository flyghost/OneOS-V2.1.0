...
#define GPIOA_BASE                  (AHBPERIPH_BASE + 0x7FE0000)                ///< Base Address: 0x48000000
#define GPIOB_BASE                  (AHBPERIPH_BASE + 0x7FE0400)                ///< Base Address: 0x48000400
#define GPIOC_BASE                  (AHBPERIPH_BASE + 0x7FE0800)                ///< Base Address: 0x48000800
#define GPIOD_BASE                  (AHBPERIPH_BASE + 0x7FE0C00)                ///< Base Address: 0x48000C00
#define GPIOE_BASE                  (AHBPERIPH_BASE + 0x7FE1000)                ///< Base Address: 0x48001000
#define GPIOF_BASE                  (AHBPERIPH_BASE + 0x7FE1400)                ///< Base Address: 0x48001400
