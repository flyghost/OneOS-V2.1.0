...
#define I2C_CR_SLV_TX_DIS_Pos           (11)
#define I2C_CR_SLV_TX_DIS               (0x01U << I2C_CR_SLV_TX_DIS_Pos)           ///< Prohibit clearing TXFIFO after receiving RD_REQ signal
#define I2C_CR_PAD_SEL_Pos              (12)
#define I2C_CR_PAD_SEL                  (0x01U << I2C_CR_PAD_SEL_Pos)               ///< pad0 selectsda;pad1 select scl
