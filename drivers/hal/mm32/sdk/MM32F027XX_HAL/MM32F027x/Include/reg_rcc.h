...
typedef struct {
    ...
    __IO u32 RESERVEDOFFSET0X30[4];                                             ///< Reserved                                       offset: 0x30
...
#define RCC_CFGR_USBPRE_PLL             (0x00U << RCC_CFGR_USBPRE_Pos)          ///< USB prescaler PLL 
#define RCC_CFGR_USBPRE_PLL_DIV2        (0x01U << RCC_CFGR_USBPRE_Pos)          ///< USB prescaler PLL 2
#define RCC_CFGR_USBPRE_PLL_DIV3        (0x02U << RCC_CFGR_USBPRE_Pos)          ///< USB prescaler PLL 3
#define RCC_CFGR_USBPRE_PLL_DIV4        (0x03U << RCC_CFGR_USBPRE_Pos)          ///< USB prescaler PLL 4
...
#define RCC_APB2RSTR_LPTIM1RST_Pos      (30)
#define RCC_APB2RSTR_LPTIM1RST          (0x01U << RCC_APB2RSTR_LPTIM1RST_Pos)   ///<  reset LPUART1 
#define RCC_APB2RSTR_LPUART1RST_Pos     (31)
#define RCC_APB2RSTR_LPUART1RST         (0x01U << RCC_APB2RSTR_LPUART1RST_Pos)  ///< reset LPUART1
...
#define RCC_APB1RSTR_TIM15_Pos          (9)
#define RCC_APB1RSTR_TIM15              (0x01U << RCC_APB1RSTR_TIM15_Pos)       ///< Timer 15 reset
...
#define RCC_AHBENR_GPIOF_Pos            (22)
...
#define RCC_APB2ENR_LPTIM1_Pos          (0)
#define RCC_APB2ENR_LPTIM1              (0x01U << RCC_APB2ENR_LPTIM1_Pos)       ///< LPTIM Block enable
#define RCC_APB2ENR_LPUART1_Pos         (0)
#define RCC_APB2ENR_LPUART1             (0x01U << RCC_APB2ENR_LPUART1_Pos)      ///< LPUART Block enable
...
#define RCC_APB1ENR_TIM15_Pos           (9)
#define RCC_APB1ENR_TIM15               (0x01U << RCC_APB1ENR_TIM15_Pos)        ///< Timer 15 clock enabled
...
#define RCC_APB1ENR_RTC                 (0x01U << RCC_APB1ENR_RTC_Pos)          ///< RTC interface clock enable
...
#define RCC_CSR_LSI_LV_Pos              (5)
#define RCC_CSR_LSI_LV                  (0x01U << RCC_CSR_LSI_LV_Pos)           ///< The internal 40KHz oscillator is turned on
...
#define RCC_AHBRSTR_GPIOF_Pos           (22)
...
#define RCC_CFGR2_AHB1_HV_Pos           (16)
#define RCC_CFGR2_AHB1_HV               (0x01U << RCC_CFGR2_AHB1_HV_Pos)        ///< APB1_HV output clock 2 frequency division
#define RCC_CFGR2_MCO_PRE_Pos           (20)
#define RCC_CFGR2_MCO_PRE_1             (0x00U << RCC_CFGR2_MCO_PRE_Pos)        ///< MCO 1 frequency division
#define RCC_CFGR2_MCO_PRE_2             (0x08U << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 2 frequency division
#define RCC_CFGR2_MCO_PRE_4             (0x09U << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 4   frequency division
#define RCC_CFGR2_MCO_PRE_8             (0x0AU << RCC_CFGR2_MCO_PRE_Pos)        ///< MCO 8   frequency division
#define RCC_CFGR2_MCO_PRE_16            (0x0BU << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 16  frequency division
#define RCC_CFGR2_MCO_PRE_64            (0x0CU << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 64  frequency division
#define RCC_CFGR2_MCO_PRE_128           (0x0DU << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 128 frequency division
#define RCC_CFGR2_MCO_PRE_256           (0x0EU << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 256 frequency division
#define RCC_CFGR2_MCO_PRE_512           (0x0FU << RCC_CFGR2_LPTIMSEL_Pos)       ///< MCO 512 frequency division

#define RCC_CFGR2_LPTIMSEL_Pos          (29)
#define RCC_CFGR2_LPTIMSEL_LSE          (0x00U << RCC_CFGR2_LPTIMSEL_Pos)       ///< LPTIM clock source select LSE
#define RCC_CFGR2_LPTIMSEL_LSI          (0x01U << RCC_CFGR2_LPTIMSEL_Pos)       ///< LPTIM clock source select LSI
#define RCC_CFGR2_LPTIMSEL_LP           (0x02U << RCC_CFGR2_LPTIMSEL_Pos)       ///< LPTIM clock source select LPTIMER
#define RCC_CFGR2_LPUARTSEL_Pos         (31)
#define RCC_CFGR2_LPUARTSEL             (0x01U << RCC_CFGR2_LPUARTSEL_Pos)      ///< LPUART clock source select LSI
...
#define RCC_CONFIG_OSC_RTRIM            (0x03U << RCC_CONFIG_OSC_RTRIM_Pos)     ///< Oscillator feedback resistance trimming
...
////////////////////////////////////////////////////////////////////////////////
#define RCC_ICSCR_TRIM_CRS_Pos          (1)
#define RCC_ICSCR_TRIM_CRS              (0x01U << RCC_ICSCR_TRIM_CRS_Pos)       ///< HSI TRIM value from CRS module 
...
#define RCC_ICSCR_HSICALSFT_Pos         (11)
...
#define RCC_PLLCFGR_PLL_LDS             (0x01U << RCC_PLLCFGR_PLL_LDS_Pos)      ///< PLL LOCK DETECTOR ACCURACY SELECT
