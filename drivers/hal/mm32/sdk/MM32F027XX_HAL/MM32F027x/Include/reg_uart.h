...
#define UART_ABRCR_BITCNT           (0x03U<<UART_ABRCR_BITCNT_Pos)          ///< Automatic baud rate length detection 8
#define UART_ABRCR_BITCNT_MODE0     (0x00U<<UART_ABRCR_BITCNT_Pos)          ///< Automatic baud rate length detection 1
#define UART_ABRCR_BITCNT_MODE1     (0x01U<<UART_ABRCR_BITCNT_Pos)          ///< Automatic baud rate length detection 2
#define UART_ABRCR_BITCNT_MODE2     (0x02U<<UART_ABRCR_BITCNT_Pos)          ///< Automatic baud rate length detection 4
#define UART_ABRCR_BITCNT_MODE3     (0x03U<<UART_ABRCR_BITCNT_Pos)          ///< Automatic baud rate length detection 8
#define UART_ABRCR_FORMER_Pos       (3)
#define UART_ABRCR_FORMER           (0x01U<<UART_ABRCR_FORMER_Pos)          ///< Automatically select the rising edge of the previous edge of the baud rate
#define UART_ABRCR_LATTER_Pos       (4)
#define UART_ABRCR_LATTER           (0x01U<<UART_ABRCR_LATTER_Pos)          ///< Automatic baud rate after one edge selection rising edge
