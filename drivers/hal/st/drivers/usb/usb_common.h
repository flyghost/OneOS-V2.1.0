 ...
 * @file        usb_common.h
 *
 * @brief       This file provides usb common struct/macro definition.
 *
 * @revision
 * Date         Author          Notes
...
#define USB_TIMEOUT_BASIC (OS_TICK_PER_SECOND) /* 1s */
#endif
#ifndef USB_TIMEOUT_LONG
#define USB_TIMEOUT_LONG (OS_TICK_PER_SECOND * 5) /* 5s */
#endif
#ifndef USB_DEBOUNCE_TIME
#define USB_DEBOUNCE_TIME (OS_TICK_PER_SECOND / 5) /* 0.2s */
#endif
...
#define  uswap_8(x) \
    (((os_uint16_t)(*((os_uint8_t *)(x)))) + \
    (((os_uint16_t)(*(((os_uint8_t *)(x)) + 1))) << 8))
...
struct udevice_descriptor
{
    ...
    os_uint8_t  type;
    os_uint16_t bcdUSB;
    os_uint8_t  bDeviceClass;
    os_uint8_t  bDeviceSubClass;
    os_uint8_t  bDeviceProtocol;
    os_uint8_t  bMaxPacketSize0;
    os_uint16_t idVendor;
    os_uint16_t idProduct;
    os_uint16_t bcdDevice;
    os_uint8_t  iManufacturer;
    os_uint8_t  iProduct;
    os_uint8_t  iSerialNumber;
    os_uint8_t  bNumConfigurations;
};
...
struct uconfig_descriptor
{
    os_uint8_t  bLength;
    os_uint8_t  type;
    os_uint16_t wTotalLength;
    os_uint8_t  bNumInterfaces;
    os_uint8_t  bConfigurationValue;
    os_uint8_t  iConfiguration;
    os_uint8_t  bmAttributes;
    os_uint8_t  MaxPower;
    os_uint8_t  data[256];
};
...
struct uinterface_descriptor
{
    os_uint8_t bLength;
    os_uint8_t type;
    os_uint8_t bInterfaceNumber;
    os_uint8_t bAlternateSetting;
    os_uint8_t bNumEndpoints;
    os_uint8_t bInterfaceClass;
    os_uint8_t bInterfaceSubClass;
    os_uint8_t bInterfaceProtocol;
    os_uint8_t iInterface;
};
...
{
    os_uint8_t bLength;
    os_uint8_t bDescriptorType;
    os_uint8_t bFirstInterface;
    os_uint8_t bInterfaceCount;
    os_uint8_t bFunctionClass;
    os_uint8_t bFunctionSubClass;
    os_uint8_t bFunctionProtocol;
    os_uint8_t iFunction;
};
...
struct uendpoint_descriptor
{
    os_uint8_t  bLength;
    os_uint8_t  type;
    os_uint8_t  bEndpointAddress;
    os_uint8_t  bmAttributes;
    os_uint16_t wMaxPacketSize;
    os_uint8_t  bInterval;
};
...
struct uhub_descriptor
{
    os_uint8_t  length;
    os_uint8_t  type;
    os_uint8_t  num_ports;
    os_uint16_t characteristics;
    os_uint8_t  pwron_to_good; /* Power on to power good */
    os_uint8_t  current;
    os_uint8_t  removable[8];
    os_uint8_t  pwr_ctl[8];
};
...
struct usb_qualifier_descriptor
{
    ...
    os_uint16_t bcdUSB; /* TODO: big-endian. */
    os_uint8_t  bDeviceClass;
    os_uint8_t  bDeviceSubClass;
    os_uint8_t  bDeviceProtocol;
    os_uint8_t  bMaxPacketSize0;
    os_uint8_t  bNumConfigurations;
    os_uint8_t  bRESERVED;
} __attribute__((packed));

struct usb_os_header_comp_id_descriptor
{
    os_uint32_t dwLength;
    os_uint16_t bcdVersion;
    os_uint16_t wIndex;
    os_uint8_t  bCount;
...
{
    os_list_node_t list;
    os_uint8_t     bFirstInterfaceNumber;
    os_uint8_t     reserved1;
    os_uint8_t     compatibleID[8];
    os_uint8_t     subCompatibleID[8];
    os_uint8_t     reserved2[6];
};
...
{
    os_uint32_t dwSize;
    os_uint32_t dwPropertyDataType;
    os_uint16_t wPropertyNameLength;
    const char *bPropertyName;
    os_uint32_t dwPropertyDataLength;
...
struct uhid_descriptor
{
    ...
    os_uint8_t  type;
    os_uint16_t bcdHID;
    os_uint8_t  bCountryCode;
    os_uint8_t  bNumDescriptors;
...
struct hid_report
{
    os_uint8_t report_id;
    os_uint8_t report[63];
    os_uint8_t size;
};
...
struct ustorage_cbw
{
    os_uint32_t signature;
    os_uint32_t tag;
    os_uint32_t xfer_len;
    os_uint8_t  dflags;
    os_uint8_t  lun;
    os_uint8_t  cb_len;
    os_uint8_t  cb[16];
