 ...
 * @file        enc28j60.h
 *
 * @brief       This file provides struct/macro definition and enc28j60 functions declaration.
 *
 * @revision
 * Date         Author          Notes
...
struct net_device
{
    ...
    os_uint8_t dev_addr[MAX_ADDR_LEN]; /* Hw address */
...
extern os_err_t enc28j60_attach(const char *spi_device_name);
