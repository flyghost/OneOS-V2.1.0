...
#define USBD_VID_HS     1155
#define USBD_LANGID_STRING_HS     1033
#define USBD_MANUFACTURER_STRING_HS     "STMicroelectronics"
...
__ALIGN_BEGIN uint8_t USBD_HS_DeviceDesc[USB_LEN_DEV_DESC] __ALIGN_END =
{
  ...
  LOBYTE(USBD_VID_HS),           /*idVendor*/
  HIBYTE(USBD_VID_HS),           /*idVendor*/
...
__ALIGN_BEGIN uint8_t USBD_LangIDDesc[USB_LEN_LANGID_STR_DESC] __ALIGN_END =
{
     ...
     LOBYTE(USBD_LANGID_STRING_HS),
     HIBYTE(USBD_LANGID_STRING_HS)
};
...
{
  UNUSED(speed);
  USBD_GetString((uint8_t *)USBD_MANUFACTURER_STRING_HS, USBD_StrDesc, length);
  return USBD_StrDesc;
}
