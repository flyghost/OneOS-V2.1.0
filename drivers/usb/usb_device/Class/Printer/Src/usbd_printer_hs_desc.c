...
#define USBD_PID_HS     0x028DU
#define USBD_PRODUCT_STRING_HS     "Printer ComPort"
#define USBD_CONFIGURATION_STRING_HS     "Printer Config"
#define USBD_INTERFACE_STRING_HS     "Printer Interface"
...
uint8_t * USBD_HS_DeviceDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
  ...
  *length = sizeof(USBD_HS_DeviceDesc);
  return USBD_HS_DeviceDesc;
    #else
    *length = sizeof(printer_dev_desc);
  return (uint8_t*)&printer_dev_desc;
...
uint8_t * USBD_HS_LangIDStrDescriptor(USBD_SpeedTypeDef speed, uint16_t *length)
{
  ...
  *length = sizeof(USBD_LangIDDesc);
  return USBD_LangIDDesc;
    #else
    *length = sizeof(usbd_language_id_desc);
    return (uint8_t*)&usbd_language_id_desc;
