...
typedef struct
{
    USBH_StatusTypeDef(*LL_Init)(struct _USBH_HandleTypeDef *phost);
    USBH_StatusTypeDef(*LL_DeInit)(struct _USBH_HandleTypeDef *phost);
    USBH_StatusTypeDef(*LL_Start)(struct _USBH_HandleTypeDef *phost);
    USBH_StatusTypeDef(*LL_Stop)(struct _USBH_HandleTypeDef *phost);
    USBH_SpeedTypeDef(*LL_GetSpeed)(struct _USBH_HandleTypeDef *phost);
    USBH_StatusTypeDef(*LL_ResetPort)(struct _USBH_HandleTypeDef *phost);
    uint32_t (*LL_GetLastXferSize)(struct _USBH_HandleTypeDef *phost, uint8_t pipe);
    USBH_StatusTypeDef(*LL_OpenPipe)(struct _USBH_HandleTypeDef *phost, uint8_t pipe_num, uint8_t epnum,
                                    uint8_t dev_address, uint8_t speed, uint8_t ep_type, uint16_t mps);
    USBH_StatusTypeDef(*LL_ClosePipe)(struct _USBH_HandleTypeDef *phost, uint8_t pipe);
    uint8_t (*LL_AllocPipe)(struct _USBH_HandleTypeDef *phost, uint8_t ep_addr);
    USBH_StatusTypeDef (*LL_FreePipe)(struct _USBH_HandleTypeDef *phost, uint8_t idx);
    uint16_t (*LL_GetFreePipe)(struct _USBH_HandleTypeDef *phost);
    USBH_StatusTypeDef(*LL_SubmitURB)(struct _USBH_HandleTypeDef *phost, uint8_t pipe, uint8_t direction,
                                     uint8_t ep_type, uint8_t token, uint8_t *pbuff, uint16_t length,
                                     uint8_t do_ping);
    USBH_URBStateTypeDef(*LL_GetURBState)(struct _USBH_HandleTypeDef *phost, uint8_t pipe);
    USBH_StatusTypeDef(*LL_DriverVBUS)(struct _USBH_HandleTypeDef *phost, uint8_t state);
    USBH_StatusTypeDef(*LL_SetToggle)(struct _USBH_HandleTypeDef *phost, uint8_t pipe, uint8_t toggle);
    uint8_t (*LL_GetToggle)(struct _USBH_HandleTypeDef *phost, uint8_t pipe);
    void(*Delay)(uint32_t Delay);
    USBH_StatusTypeDef (*LL_CtlSendSetup)(struct _USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_CtlSendData)(struct _USBH_HandleTypeDef *phost,
                                    uint8_t *buff,
                                    uint16_t length,
                                    uint8_t pipe_num,
                                    uint8_t do_ping);
    USBH_StatusTypeDef (*LL_CtlReceiveData)(struct _USBH_HandleTypeDef *phost,
                                       uint8_t *buff,
                                       uint16_t length,
                                       uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_BulkSendData)(struct _USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint16_t length,
                                     uint8_t pipe_num,
                                     uint8_t do_ping);
    USBH_StatusTypeDef (*LL_BulkReceiveData)(struct _USBH_HandleTypeDef *phost,
                                        uint8_t *buff,
                                        uint16_t length,
                                        uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_InterruptSendData)(struct _USBH_HandleTypeDef *phost,
                                          uint8_t *buff,
                                          uint8_t length,
                                          uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_InterruptReceiveData)(struct _USBH_HandleTypeDef *phost,
                                             uint8_t *buff,
                                             uint8_t length,
                                             uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_IsocSendData)(struct _USBH_HandleTypeDef *phost,
                                     uint8_t *buff,
                                     uint32_t length,
                                     uint8_t pipe_num);
    USBH_StatusTypeDef (*LL_IsocReceiveData)(struct _USBH_HandleTypeDef *phost,
                                        uint8_t *buff,
                                        uint32_t length,
                                        uint8_t pipe_num);
} USBH_LL_Ops;
...
//USB_ID_TO_CLASS 
typedef struct _USBH_ID_To_Class 
{
    uint16_t PID;
    uint16_t PID_Mask;
    uint16_t VID;
...
typedef struct
{
    USBH_ID_To_Class     *pSpecificID[USBH_MAX_NUM_SUPPORTED_SPACIFIC_ID];
    uint32_t              SpecificIDNumber;
}USBH_SpecificID_TypeDef;
