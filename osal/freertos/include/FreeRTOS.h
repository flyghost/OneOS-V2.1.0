 ...
 */
//typedef tskTaskControlBlock_t StaticTask_t;
...
typedef enum os_adapt_queue_type
{
	OS_ADAPT_QUEUE_TYPE_MESSAGEQUEUE = 0,
	OS_ADAPT_QUEUE_TYPE_RECURSIVE_MUTEX,
	OS_ADAPT_QUEUE_TYPE_MUTEX,
	OS_ADAPT_QUEUE_TYPE_BINARY_SEMAPHORE,
	OS_ADAPT_QUEUE_TYPE_COUNTING_SEMAPHORE
} os_adapt_queue_type_t;

//typedef QueueDefinition_t StaticQueue_t;
...
//typedef EventGroup_t StaticEventGroup_t;
...
//typedef tmrTimerControl_t StaticTimer_t;
