...
/*because wdg is enabled by hardware at startup, to test wdg function,
this var is used to stop feed dog in user task by set it to false*/
os_bool_t feed_dog_in_task = OS_TRUE;
