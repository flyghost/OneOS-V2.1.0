 ...
 *           from CMSIS SVD File 'FM33G0XX.SVD' Version 1.0,
 *
...
/* ---------------------  FM33G0XX Specific Interrupt Numbers  -------------------- */
  WWDT_IRQn                   	=  0,               /*!<  0   WWDT             */
...
#include "system_FM33G0XX.h"                        /*!< FM33G0XX System                                                     */
...
typedef struct
{
  ...
  __IO uint32_t RCLFCON;                 /*!<  RCLF CONFIG   */
  __IO uint32_t RCLFTRIM;                /*!<  RCLF TRIM  */
}RCC_Type;
...
typedef struct
{
  ...
  __IO uint32_t PF4AFSEL;                 /*!<  pf4 	function selection					Address offset: 0x2c */
}GPIO_COMMON_Type;  
...
typedef struct
{
	...
	__I uint32_t 	OPTBR;  	//¾ÍÊÇUSRCFG/*!< NVMIF port protect stat register,    Address offset: 0x08 */
	__IO uint32_t ACLOCK1;		/*!< NVMIF flash block0-31 protect register,wr 1 only    Address offset: 0x0C */
	__IO uint32_t RSV1;		/*    Address offset: 0x10 */
...
typedef struct
{
  __IO uint32_t ET1CNT;					/*!< ETIMER COUNTER,                  Address offset: 0x00 */ 
  __IO uint32_t ET2CNT;					/*!< ETIMER COUNTER,                  Address offset: 0x04 */ 
  __IO uint32_t ET3CNT;					/*!< ETIMER COUNTER,                  Address offset: 0x08 */ 
  __IO uint32_t ET4CNT;					/*!< ETIMER COUNTER,                  Address offset: 0x0C */ 
}ETCNT_Type;
/* ================================================================================ */
/* ================                      LPTIM                     ================ */
/* ================================================================================ */
...
typedef struct
{
	...
	__IO uint32_t RSV2;	
	__IO uint32_t RSV3;	
	__IO uint32_t SVDVOL;         /*!< ANAC SVD VOLTAGE REGISTER,			 			Address offset: 0x60 */
} ANAC_Type;
...
typedef struct
{
  ...
  __IO uint32_t AUTOCAL;				/*!< RTC Automatic temperature control register ,	Address offset: 0x64 */	
  __IO uint32_t ADOFFSET;				/*!< RTC Automatic temperature compensation zero correction value  register ,	Address offset: 0x68 */	
  __IO uint32_t CALSTEP;				/*!< RTC adjustment step selection register ,	Address offset: 0x6c */
  __IO uint32_t CALBUSY;				/*!< RTC Automatic warm-up status register ,	Address offset: 0x70 */
  __IO uint32_t ADJCNT;				/*!< RTC compensation period counter register,	Address offset: 0x74 */
  __IO uint32_t ACALADJ;				/*!< RTC compensation period counter register,	Address offset: 0x78 */
  __IO uint32_t RSV[97];
  __IO uint32_t RTCBKREG[128];	/*!< RTC backup register ,	Address offset: 0x200 */
} RTC_Type;
...
typedef struct
{
	...
	__IO uint32_t RSV2;				/*!< TRNG INTERRUPT ENABLE REGISTER,    Address offset: 0x0C */
...
typedef struct 
{
	__IO  uint32_t LPURXD;				//0x40010400
	__IO  uint32_t LPUTXD;  			//0x40010404                     
	__IO  uint32_t LPUSTA; 				//0x40010408                     
	__IO  uint32_t LPUCON;  			//0x4001040C                     
	__IO  uint32_t LPUIF;				//0x40010410                         
	__IO  uint32_t LPUBAUD;    			//0x40010414                   
	__IO  uint32_t LPUEN;				//0x40010418
	__IO  uint32_t COMPARE;				//0x4001041C
	__IO  uint32_t MCTL;			  	//0x40010420
...
#define LPUART_BASE				(PERIPH_BASE				+0x00010400)
