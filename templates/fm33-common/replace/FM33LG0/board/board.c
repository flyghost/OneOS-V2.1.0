...
{
    {GET_PIN(B, 15), PIN_LOW},
    {GET_PIN(D, 12), PIN_LOW},
    {GET_PIN(C, 0), PIN_LOW},
    {GET_PIN(C, 1), PIN_LOW},
};
...
const struct push_button key_table[] = 
{
    ...
    {GET_PIN(E,6), PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
    {GET_PIN(E,7), PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
    {GET_PIN(C,6), PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_FALLING},
};
