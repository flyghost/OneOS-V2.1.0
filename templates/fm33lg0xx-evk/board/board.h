 ...
 * \@revision
 * Date         Author          Notes
 * 2021-07-14   OneOS Team      First Version
 ***********************************************************************************************************************
 */
...
#define SOC_MODEL         "FM33LG048"

#define FM_FLASH_START_ADRESS      ((os_uint32_t)0x0)
#define FM_FLASH_SIZE              (256 * 1024)
#ifdef FOTA_USING_CMIOT
#define FM_FLASH_BLOCK_SIZE        (1024)
#else
