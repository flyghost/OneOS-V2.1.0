 ...
 * @file        n200_func.h
 *
 * @brief       This file provides macro definition and function declaration for n200_func.
 *
 * @revision
 * Date         Author          Notes
 ...
 *
 * @details         Wait For Interrupt is a hint instruction that suspends execution until one of a number of events
 *                  occurs.
 ***********************************************************************************************************************
 */
 ...
 *
 * @details         Wait For Event is a hint instruction that permits the processor to enter a low-power state until one
