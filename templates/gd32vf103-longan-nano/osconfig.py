...
if COMPILER == 'gcc':
    ...
    LFLAGS = DEVICE + ' -nostartfiles -Xlinker  --gc-sections -Wl,-Map,"gd32vf103cbt6-longan-nano.map" --specs=nosys.specs -T RISCV\env_Eclipse\GD32VF103xB.lds -nostartfiles'
