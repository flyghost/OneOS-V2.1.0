...
#define MCU_ROM_BEGIN ((uint32_t)0x26000)
#define MCU_ROM_SIZE  ((512 - BLE_SOFTDEVICE_KB) * 1024)
#define MCU_ROM_END   (MCU_ROM_BEGIN + MCU_ROM_SIZE)

#define OS_SPI_FLASH_NAME "at45dbxx"
#define OS_SPI_FLASH_PART_ADDR     (0)
#define OS_SPI_FLASH_PART_SIZE     (512)
