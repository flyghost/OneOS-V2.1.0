...
{
    {GET_PIN(C, 0), PIN_MODE_INPUT_PULLUP,      PIN_IRQ_MODE_FALLING},
    {GET_PIN(C, 1), PIN_MODE_INPUT_PULLUP,      PIN_IRQ_MODE_FALLING},
    {GET_PIN(C, 2), PIN_MODE_INPUT_PULLUP,      PIN_IRQ_MODE_FALLING},
    {GET_PIN(C, 3), PIN_MODE_INPUT_PULLDOWN,    PIN_IRQ_MODE_RISING},
};
