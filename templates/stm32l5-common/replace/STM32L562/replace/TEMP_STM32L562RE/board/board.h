...
#define SOC_MODEL         "STM32L562RE"


#define STM32_FLASH_START_ADRESS ((uint32_t)0x08000000)
#define STM32_FLASH_SIZE         (512 * 1024)
#define STM32_FLASH_END_ADDRESS  ((os_uint32_t)(STM32_FLASH_START_ADRESS + STM32_FLASH_SIZE))
#define SECURE_ZONE 0*1024   //no securty zone
