...
const led_t led_table[] = {
    {GET_PIN(I, 0), PIN_HIGH},
    {GET_PIN(F, 3), PIN_HIGH},
};

const int led_table_size = ARRAY_SIZE(led_table);

const struct push_button key_table[] = {
    {GET_PIN(G, 3), PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_RISING_FALLING},
    {GET_PIN(H, 7), PIN_MODE_INPUT_PULLUP, PIN_IRQ_MODE_RISING_FALLING},
