...
PY_EXTMOD_O_BASENAME = $(addprefix $(TOP_USER)/components/module/,\
	moductypes.o \
	modujson.o \
	modure.o \
	moduzlib.o \
	...
	utime_mphal.o \
	uos_dupterm.o )\
	$(addprefix $(TOP_USER)/machine/,\
	virtpin.o \
	middle/machine_mem.o \
	middle/machine_pinbase.o \
	middle/machine_signal.o \
	middle/machine_pulse.o \
	middle/machine_i2c.o \
	middle/machine_spi.o) \
	$(addprefix $(TOP_KERNEL)/,\
	lib/embed/abort_.o \
	lib/utils/printf.o) \
...
$(HEADER_BUILD)/moduledefs.h: $(SRC_QSTR) $(QSTR_GLOBAL_DEPENDENCIES) | $(HEADER_BUILD)/mpversion.h
	@$(ECHO) "GEN $@"
	$(Q)$(PYTHON) $(PY_SRC)/makemoduledefs.py --vpath="., $(TOP_KERNEL), $(USER_C_MODULES)" $(SRC_QSTR) > $@
...
include $(TOP_USER)/components/module/extmod.mk
