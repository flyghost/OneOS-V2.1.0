...
#define RTOS_DEFAULT_THREAD_PRIORITY     (8)

#define WWD_THREAD_STACK_SIZE            (4096)//(544 + 1400)
...
typedef os_sem_t  host_semaphore_type_t;  /** NoOS definition of a semaphore */
typedef os_task_t   host_thread_type_t;     /** NoOS definition of a thread handle - Would be declared void but that is not allowed. */
