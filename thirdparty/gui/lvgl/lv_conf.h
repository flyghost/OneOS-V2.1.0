...
#  define LV_MEM_CUSTOM_ALLOC   os_malloc       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    os_free         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_TICK_CUSTOM_SYS_TIME_EXPR (os_tick_get() * 1000 / OS_TICK_PER_SECOND)     /*Expression evaluating to current systime in ms*/
