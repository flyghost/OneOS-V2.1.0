...
#ifdef OC_DYNAMIC_ALLOCATION
  core_resources = (oc_resource_t *)oc_calloc(1, sizeof(oc_resource_t));
  if (!core_resources) {
                       ...
                       oc_core_add_device_cb_t add_device_cb, void *data)
{
  ...
  core_resources =
    (oc_resource_t *)oc_realloc(core_resources, new_num * sizeof(oc_resource_t));
  ...
  oc_device_info = (oc_device_info_t *)oc_realloc(
