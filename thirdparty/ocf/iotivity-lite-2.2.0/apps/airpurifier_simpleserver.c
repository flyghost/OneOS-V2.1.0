...
input_file            : ../airpurifier/out_codegeneration_merged.swagger.json
version of input_file :  
title of input_file   : server_airpurifier
*/
...
app_init(void)
{
    ...
    ret |= oc_add_device("/oic/d", "oic.d.airpurifier", "server_airpurifier", 
        "ocf.2.2.0", /* icv value */
...
main(void)
{
    ...
    PRINT("Used input file : \"../airpurifier/out_codegeneration_merged.swagger.json\"\n");
    PRINT("OCF Server name : \"server_airpurifier\"\n");
    ...
    PRINT("OCF server \"server_airpurifier\" running, waiting on incoming connections.\n");
