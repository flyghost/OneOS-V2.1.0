...
/*
 ...
 title of input_file   : server_lite_19645
*/
...
app_init(void)
{
  ...
  ret |= oc_add_device("/oic/d", "oic.d.light", "server_light", 
                       "ocf.2.2.0", /* icv value */
  ...
  if (fp) {
    ...
    buffer = (uint8_t *)oc_malloc(buffer_size * sizeof(uint8_t));
...
int init;
  ...
  PRINT("OCF Server name : \"server_lite_19645\"\n");
